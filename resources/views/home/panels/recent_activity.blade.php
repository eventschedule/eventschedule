<div class="ap-card rounded-xl h-full flex flex-col overflow-hidden">
    <div class="dashboard-panel-header px-5 py-4">
        <h2 class="text-base font-semibold text-gray-900 dark:text-white">{{ __('messages.recent_activity') }}</h2>
    </div>
    <div class="divide-y divide-gray-100 dark:divide-white/[0.06] flex-1">
        ...
        <div class="flex items-start gap-3 px-5 py-3">
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ $activity['date']->diffForHumans() }}</p>
            </div>
