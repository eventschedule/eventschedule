    ...
    <section class="relative bg-[#0a0a0f] min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-24">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                ...
                <a href="{{ app_url('/login') }}" class="inline-flex items-center px-6 py-3 text-base font-semibold text-white glass border border-white/10 rounded-xl hover:bg-white/10 transition-all">
                    Sign in
                    <svg class="ml-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
