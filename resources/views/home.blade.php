<x-app-admin-layout>
    <div>
        ...
        <div class="mb-8">
            <!-- Header Panel -->
            <div class="relative bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-md p-10 mb-8 overflow-hidden shadow-xl">
                <div class="absolute inset-0 bg-gradient-radial from-transparent via-slate-100/30 to-blue-100/40 dark:via-slate-900/30 dark:to-blue-900/40 rounded-md"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Talent Card -->
                <div class="group relative bg-gradient-to-br from-slate-50/50 to-blue-50/50 dark:from-slate-950/30 dark:to-blue-950/30 rounded-md p-8 border-2 border-slate-200 dark:border-slate-800/50 hover:border-slate-400 dark:hover:border-slate-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <div class="relative">
                        <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-slate-600 to-blue-600 dark:from-slate-700 dark:to-blue-700 rounded-md mb-6 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-md">
                        ...
                        <div class="text-center">
                            <a href="{{ route('new', ['type' => 'talent']) }}" class="inline-flex items-center justify-center px-8 py-3.5 bg-gradient-to-r from-slate-600 to-blue-600 dark:from-slate-700 dark:to-blue-700 text-white font-semibold rounded-md hover:from-slate-700 hover:to-blue-700 dark:hover:from-slate-600 dark:hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                ...
                <div class="group relative bg-gradient-to-br from-slate-50/50 to-blue-50/50 dark:from-slate-950/30 dark:to-blue-950/30 rounded-md p-8 border-2 border-slate-200 dark:border-slate-800/50 hover:border-slate-400 dark:hover:border-slate-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <div class="relative">
                        ...
                        <div class="text-center">
                            <a href="{{ route('new', ['type' => 'venue']) }}" class="inline-flex items-center justify-center px-8 py-3.5 bg-gradient-to-r from-slate-600 to-blue-600 dark:from-slate-700 dark:to-blue-700 text-white font-semibold rounded-md hover:from-slate-700 hover:to-blue-700 dark:hover:from-slate-600 dark:hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                                <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z"/>
                                </svg>
                                {{ __('messages.create_schedule') }}
                ...
                <div class="group relative bg-gradient-to-br from-slate-50/50 to-blue-50/50 dark:from-slate-950/30 dark:to-blue-950/30 rounded-md p-8 border-2 border-slate-200 dark:border-slate-800/50 hover:border-slate-400 dark:hover:border-slate-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <div class="relative">
                        ...
                        <div class="text-center">
                            <a href="{{ route('new', ['type' => 'curator']) }}" class="inline-flex items-center justify-center px-8 py-3.5 bg-gradient-to-r from-slate-600 to-blue-600 dark:from-slate-700 dark:to-blue-700 text-white font-semibold rounded-md hover:from-slate-700 hover:to-blue-700 dark:hover:from-slate-600 dark:hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                                <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z"/>
                                </svg>
                                {{ __('messages.create_schedule') }}
