...
<div class="bg-white dark:bg-white/5 rounded-2xl p-6 border border-gray-200 dark:border-white/10 shadow-sm hover:shadow-lg {{ $classes['border_hover'] }} transition-all flex flex-col">
    ...
    @if($blogPost)
        <a href="{{ blog_url('/' . $blogPost->slug) }}" class="inline-flex items-center {{ $classes['link_text'] }} {{ $classes['link_hover'] }} text-sm font-medium mt-auto pt-3 group">
            Learn more
