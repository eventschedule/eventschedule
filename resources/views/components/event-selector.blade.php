<div class="relative" id="event-selector-dropdown">
    <button @click="toggleDropdown" type="button" tabindex="0"
        class="w-full flex items-center gap-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 shadow-sm focus:border-[var(--brand-blue)] focus:ring-2 focus:ring-[var(--brand-blue)] focus:outline-none text-start">
    ...
    <div v-if="dropdownOpen" class="absolute z-50 mt-1 w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-lg max-h-72 overflow-y-auto">
