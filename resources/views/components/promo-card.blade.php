...
<div class="w-full max-w-3xl mx-auto px-4 sm:px-0 mt-8">
    <div class="overflow-hidden rounded-2xl bg-white/95 dark:bg-[#1e1e1e]/95 shadow-sm ring-1 ring-black/5 dark:ring-white/10 backdrop-blur-sm transition-all duration-200 hover:shadow-md">
