                        ...
                        <div class="mt-4">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex">
                                    ...
                                    <button type="button" id="embed-url-btn" class="js-copy-embed-url inline-flex items-center rounded-e-md border border-s-0 border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 focus:border-[#4E81FA] focus:outline-none focus:ring-1 focus:ring-[#4E81FA]">
