@php
    ...
    $navLinkBase = 'group sidebar-item flex gap-x-3 rounded-md p-2 text-sm leading-6 transition-colors duration-150';
    ...
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <ul role="list" class="-mx-2 space-y-1">
                ...
                <li>
                    <a href="{{ route('home') }}"
                        ...
                        <span class="sidebar-item-label">{{ __('messages.events') }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('role.pages') }}"
                        ...
                        <span class="sidebar-item-label">{{ __('messages.schedules') }}</span>
                    </a>
                </li>
                ...
                <li data-collapse-container class="space-y-1" data-collapse-state="{{ $venuesSectionOpen ? 'open' : 'closed' }}">
                    <div class="flex items-center gap-x-2">
                        <a href="{{ route('role.venues') }}"
                            ...
                            <svg class="sidebar-item-icon h-5 w-5 shrink-0 text-gray-400 transition-colors duration-150 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-200" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M3 21h18M4.5 21V9l7.5-4.5L19.5 9V21M9 21v-6h6v6" />
                            </svg>
                            <span class="sidebar-item-label flex-1 text-left">{{ __('messages.venues') }}</span>
                        </a>
                    ...
                    @if ($venues->isNotEmpty())
                        <ul role="list" id="collapse-venues" data-collapse-content
                            ...
                            <li class="{{ $navSectionLabel }} sidebar-section-label">{{ __('messages.venue_schedules') }}</li>
                            ...
                            @foreach ($venues as $venue)
                                ...
                                <li>
                                    <a href="{{ route('role.view_admin', ['subdomain' => $venue->subdomain, 'tab' => $venue->subdomain == request()->subdomain ? 'schedule' : (request()->tab ? request()->tab : 'schedule')]) }}"
                                        ...
                                        <span class="sidebar-item-label truncate">{{ $venueName }}</span>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                ...
                <li data-collapse-container class="space-y-1" data-collapse-state="{{ $curatorsSectionOpen ? 'open' : 'closed' }}">
                    <div class="flex items-center gap-x-2">
                        <a href="{{ route('role.curators') }}"
                            ...
                            <svg class="sidebar-item-icon h-5 w-5 shrink-0 text-gray-400 transition-colors duration-150 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-200" viewBox="0 0 24 24"
                                fill="currentColor" aria-hidden="true">
                                <path d="M12 4l2.47 5.02 5.53.8-4 3.91.94 5.5L12 16.9l-4.94 2.33.94-5.5-4-3.91 5.53-.8L12 4z" />
                            </svg>
                            <span class="sidebar-item-label flex-1 text-left">{{ __('messages.curators') }}</span>
                        </a>
                    ...
                    @if ($curators->isNotEmpty())
                        <ul role="list" id="collapse-curators" data-collapse-content
                            ...
                            <li class="{{ $navSectionLabel }} sidebar-section-label">{{ __('messages.curator_schedules') }}</li>
                            ...
                            @foreach ($curators as $curator)
                                ...
                                <li>
                                    <a href="{{ route('role.view_admin', ['subdomain' => $curator->subdomain, 'tab' => $curator->subdomain == request()->subdomain ? 'schedule' : (request()->tab ? request()->tab : 'schedule')]) }}"
                                        ...
                                        <span class="sidebar-item-label truncate">{{ $curatorName }}</span>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                ...
                <li data-collapse-container class="space-y-1" data-collapse-state="{{ $talentSectionOpen ? 'open' : 'closed' }}">
                    <div class="flex items-center gap-x-2">
                        <a href="{{ route('role.talent') }}"
                            ...
                            <span class="sidebar-item-label flex-1 text-left">{{ \Illuminate\Support\Str::plural(__('messages.talent')) }}</span>
                        </a>
                    ...
                    @if ($schedules->isNotEmpty())
                        <ul role="list" id="collapse-talent" data-collapse-content
                            ...
                            <li class="{{ $navSectionLabel }} sidebar-section-label">{{ __('messages.talent_schedules') }}</li>
                            ...
                            @foreach ($schedules as $each)
                                ...
                                <li>
                                    <a href="{{ route('role.view_admin', ['subdomain' => $each->subdomain, 'tab' => $each->subdomain == request()->subdomain ? 'schedule' : (request()->tab ? request()->tab : 'schedule')]) }}"
                                        ...
                                        <span class="sidebar-item-label truncate">{{ $scheduleName }}</span>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                ...
                @if (\Illuminate\Support\Facades\Route::has('role.contacts'))
                    <li>
                        <a href="{{ route('role.contacts') }}"
                            ...
                            <svg class="sidebar-item-icon h-5 w-5 shrink-0 text-gray-400 transition-colors duration-150 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-200" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                            ...
                            <span class="sidebar-item-label">{{ __('messages.contacts') }}</span>
                        </a>
                    </li>
                @endif
                ...
                <li>
                    <a href="{{ route('tickets') }}"
                        ...
                        <span class="sidebar-item-label">{{ __('messages.tickets') }}</span>
                    </a>
                </li>
                @endif
                ...
                <li>
                    <a href="{{ route('sales') }}"
                        ...
                        <span class="sidebar-item-label">{{ __('messages.sales') }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('media.index') }}"
                        ...
                        <svg class="sidebar-item-icon h-6 w-6 shrink-0 text-gray-400 transition-colors duration-150 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-200" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                        ...
                        <span class="sidebar-item-label">{{ __('Media library') }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('blog.admin.index') }}"
                        ...
                        <span class="sidebar-item-label">Blog</span>
                    </a>
                </li>
                @endif
        ...
        <li class="mt-auto">
            <a href="{{ route('settings.index') }}"
                ...
                <svg class="sidebar-item-icon h-6 w-6 shrink-0 text-gray-400 transition-colors duration-150 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <span class="sidebar-item-label">{{ __('messages.settings') }}</span>
            </a>
        </li>
        @endif
    </ul>
