                    ...
                    <ul role="list" class="-mx-2 mt-2 space-y-1">
                        ...
                        <li>
                            <a href="{{ url('/vendor/'. $vendor->subdomain) }}"
                                ...
                                <span
                                    class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-gray-700 bg-gray-800 text-[0.625rem] font-medium group-hover:text-white {{ request()->is('venue/'. $venue->subdomain) ? 'text-white' : 'text-gray-400' }}">{{ strtoupper(substr($vendor->name, 0, 1)) }}</span>
