...
<nav class="flex flex-1 flex-col mt-4">
    <ul role="list" class="flex flex-1 flex-col gap-y-7">
        <li>
            ...
            <li>
                    <a href="{{ route('home') }}"
                        class="dark-nav-hover group flex gap-x-4 items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white {{ request()->is('dashboard') ? 'dark-nav-active text-white' : '' }}">
        ...
        <li>
            ...
            <ul role="list" class="-mx-2 mt-2 space-y-2">
                ...
                <li>
                    <div class="dark-nav-hover group flex items-center rounded-lg p-2 text-lg font-semibold leading-6 hover:text-white {{ request()->is($each->subdomain) || request()->is($each->subdomain . '/*') ? 'dark-nav-active text-white' : 'text-gray-400' }}">
        ...
        <li>
            ...
            <ul role="list" class="-mx-2 mt-2 space-y-2">
                ...
                <li>
                    <div class="dark-nav-hover group flex items-center rounded-lg p-2 text-lg font-semibold leading-6 hover:text-white {{ request()->is($venue->subdomain) || request()->is($venue->subdomain . '/*') ? 'dark-nav-active text-white' : 'text-gray-400' }}">
        ...
        <li>
            ...
            <ul role="list" class="-mx-2 mt-2 space-y-2">
                ...
                <li>
                    <div class="dark-nav-hover group flex items-center rounded-lg p-2 text-lg font-semibold leading-6 hover:text-white {{ request()->is($curator->subdomain) || request()->is($curator->subdomain . '/*') ? 'dark-nav-active text-white' : 'text-gray-400' }}">
            ...
            <ul role="list" class="-mx-2 space-y-1">
                ...
                <li>
                    <a href="{{ route('following') }}"
                        class="dark-nav-hover group flex gap-x-4 items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white {{ request()->is('following') ? 'dark-nav-active text-white' : '' }}">
                        <svg class="h-8 w-8 shrink-0" viewBox="0 0 24 24"
                ...
                @if($hasCarpoolActivity)
                <li>
                    <a href="{{ route('my_carpools') }}"
                        class="dark-nav-hover group flex gap-x-4 items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white {{ request()->is('my-carpools') ? 'dark-nav-active text-white' : '' }}">
                        <svg class="h-8 w-8 shrink-0" viewBox="0 0 24 24"
                            fill="{{ request()->is('my-carpools') ? '#ccc' : '#666' }}" aria-hidden="true">
                ...
                <li>
                    <a href="{{ route('sales') }}"
                        class="dark-nav-hover group flex gap-x-4 items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white {{ request()->is('sales') ? 'dark-nav-active text-white' : '' }}">
                        <svg class="h-8 w-8 shrink-0" viewBox="0 0 24 24"
                ...
                <li>
                    <a href="{{ route('analytics') }}"
                        class="dark-nav-hover group flex gap-x-4 items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white {{ request()->is('analytics') ? 'dark-nav-active text-white' : '' }}">
                        <svg class="h-8 w-8 shrink-0" viewBox="0 0 24 24"
                ...
                <li>
                    <a href="{{ route('newsletter.index') }}"
                        class="dark-nav-hover group flex gap-x-4 items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white {{ request()->is('newsletters*') || request()->is('newsletter-segments*') ? 'dark-nav-active text-white' : '' }}">
                        <svg class="h-8 w-8 shrink-0" viewBox="0 0 24 24"
                ...
                @foreach (config('app.custom_links', []) as $customLink)
                <li>
                    <a href="{{ $customLink['url'] }}" target="_blank" rel="noopener noreferrer"
                        class="dark-nav-hover group flex gap-x-4 items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white">
                        <svg class="h-8 w-8 shrink-0" viewBox="0 0 24 24" fill="#666" aria-hidden="true">
                ...
                <li>
                    <a href="{{ route('referrals') }}"
                        class="dark-nav-hover group flex gap-x-4 items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white {{ request()->is('referrals') ? 'dark-nav-active text-white' : '' }}">
                        <svg class="h-8 w-8 shrink-0" viewBox="0 0 24 24"
                ...
                <li>
                    <a href="{{ route('admin.dashboard') }}"
                        class="dark-nav-hover group flex gap-x-4 items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white {{ request()->is('admin/*') ? 'dark-nav-active text-white' : '' }}">
                        <svg class="h-8 w-8 shrink-0" viewBox="0 0 24 24"
            ...
            <ul role="list" class="-mx-2 space-y-1">
                ...
                <li>
                    <div class="dark-nav-hover group flex items-center rounded-lg p-2 text-lg font-semibold leading-6 text-gray-400 hover:text-white">
                        ...
                        @if (config('app.hosted'))
                        <button class="js-support-chat-sidebar-btn relative flex p-2 rounded hover:bg-gray-700 text-gray-400 hover:text-white transition-all opacity-0 group-hover:opacity-100 shrink-0" title="Support chat">
