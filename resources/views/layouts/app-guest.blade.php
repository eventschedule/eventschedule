    ...
    <header class="bg-white dark:bg-[#151B26]">
        ...
        <div class="flex flex-row gap-x-3 md:gap-x-10">
            ...
            <button
                type="button"
                name="login"
                style="color: {{ $otherRole && $otherRole->accent_color ? $otherRole->accent_color : ($role && $role->accent_color ?? '#4E81FA') }}"
            ...
            <button
                type="button"
                name="sign-up"
                style="background-color: {{ $otherRole && $otherRole->accent_color ? $otherRole->accent_color : ($role && $role->accent_color ?? '#4E81FA') }}"
