    ...
    <header id="schedule-header" class="relative z-10 flex flex-col gap-3 py-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div class="flex flex-row flex-wrap items-center gap-2 md:gap-3 {{ $isRtl ? 'lg:justify-start' : 'lg:justify-end' }}">
            ...
            <button id="hero-filters-btn"
                    ...
                    class="hidden w-11 h-11 items-center justify-center rounded-lg border-2 transition-all duration-200 hover:scale-105 hover:shadow-md flex-shrink-0 relative text-gray-900 dark:text-white"
                    style="border-color: {{ $accentColor }}; background-color: transparent; display: none;">
