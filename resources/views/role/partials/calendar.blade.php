        ...
        <div class="flex items-center justify-center">
            ...
            <div style="font-family: sans-serif" class="ml-3 shadow-sm relative inline-block text-left">
                <button type="button" 
                    ...
                    class="inline-flex w-full justify-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-indigo-500" id="menu-button" aria-expanded="true" aria-haspopup="true">
