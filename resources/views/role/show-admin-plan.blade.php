    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 border border-gray-100 dark:border-gray-700 pb-10">
        ...
        <div class="space-y-4">
            <div class="flex items-center">
                <span class="text-gray-600 dark:text-gray-400 w-32">{{ __('messages.curent_plan') }}</span>
            ...
            <div class="flex items-center">
                <span class="text-gray-600 dark:text-gray-400 w-32">{{ __('messages.expires_on') }}</span>
                <span class="font-medium text-gray-700 dark:text-gray-300">
