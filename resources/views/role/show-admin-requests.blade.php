        ...
        <div>
            <div class="-mt-px flex divide-x divide-gray-200">
                ...
                <div class="-ml-px flex w-0 flex-1 cursor-pointer"
                    onclick="var confirmed = confirm('{{ __('Are you sure?') }}'); if (confirmed) { location.href = '{{ route('event.decline', ['subdomain' => $role->subdomain, 'hash' => base64_encode($event->id), 'redirect_to' => 'requests']) }}'; }">
                    <div
