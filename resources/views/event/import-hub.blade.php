<x-app-admin-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        @if ($role->isPro())
            <a href="{{ route('event.show_import_eventbrite', ['subdomain' => $role->subdomain]) }}" class="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-[#4E81FA] dark:hover:border-[#4E81FA] p-6 transition-all duration-200 hover:shadow-md">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100 group-hover:text-[#4E81FA] transition-colors">
                    ...
                    <svg class="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-[#4E81FA] transition-colors {{ is_rtl() ? 'rotate-180' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        @endphp
        @if ($canUseAiImport)
            <a href="{{ route('event.show_import_ai', ['subdomain' => $role->subdomain]) }}" class="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-[#4E81FA] dark:hover:border-[#4E81FA] p-6 transition-all duration-200 hover:shadow-md">
                <div class="flex items-start gap-4">
                    <div class="flex-shrink-0 w-12 h-12 rounded-lg bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center">
                        <svg class="w-6 h-6 text-[#4E81FA]" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
