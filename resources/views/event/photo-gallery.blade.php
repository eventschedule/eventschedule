        ...
        <div class="flex items-center gap-2">
          ...
          <div x-data="{ shareState: 'idle' }" class="hidden sm:block">
            <button type="button"
                    ...
                    "
                    class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
