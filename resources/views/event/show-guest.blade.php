    ...
    >
      <div class="container mx-auto pt-[100px] pb-10 px-5 relative z-10">
        ...
        <div class="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <div
            class="flex flex-row gap-2 items-center relative text-white fill-white sm:pr-4 {{ $event->venue ? "sm:after:content-[''] sm:after:block sm:after:absolute sm:after:right-0 sm:after:top-[50%] sm:after:translate-y-[-50%] sm:after:h-[12px] sm:after:w-[1px] sm:after:bg-white" : "" }}"
          >
            <svg
              width="24"
              height="24"
