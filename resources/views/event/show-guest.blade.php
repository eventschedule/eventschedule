<x-app-guest-layout :role="$role" :event="$event" :date="$date">
  <header class="z-10 relative">
    ...
    >
      <a href="/">
        <svg
          class="w-[140px] sm:w-[205px] fill-white"
          height="40"
          viewBox="0 0 205 40"
      ...
      <div class="flex flex-row gap-x-3 md:gap-x-10">
        <a
          href="https://eventschedule.com/login"
        ...
        <a
          href="https://eventschedule.com/sign_up"
          class="inline-flex items-center justify-center"
        >
          <button
            type="button"
  ...
  <main>
    <div
      class="-mt-[112px] bg-center bg-cover relative before:bg-[#1B212B80] before:absolute before:inset-0 before:z-0"
      style="background-image: url(./images/yoga.jpeg)"
    >
      <div class="container pt-[152px] pb-10 px-5 relative z-10">
        ...
        <div class="flex flex-col sm:flex-row gap-4 items-center">
          ...
          >
            <img
              ...
              alt="location image"
            />
            <p class="text-sm">Pines Retreat Space</p>
          </div>
          <div
            class="flex flex-row gap-2 items-center relative text-white fill-white sm:pr-4 sm:after:content-[''] sm:after:block sm:after:absolute sm:after:right-0 sm:after:top-[50%] sm:after:translate-y-[-50%] sm:after:h-[12px] sm:after:w-[1px] sm:after:bg-white"
          >
          ...
          >
            ...
            <p class="text-sm">123 Serenity Lane, Wellness City</p>
          </div>
        </div>
      </div>
    </div>
    <div
      class="container flex flex-col-reverse sm:grid px-5 py-[80px] gap-[48px] sm:grid-cols-[minmax(0px,_auto)_minmax(0px,_344px)]"
    >
