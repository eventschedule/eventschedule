        ...
        <div class="flex flex-col sm:flex-row justify-between mb-10 py-[7px]">
          ...
          <div style="font-family: sans-serif" class="mt-8 relative inline-block text-left">
              <button type="button" 
                  ...
                  style="background-color: {{ $role->accent_color ?? '#4E81FA' }};"
                  class="inline-flex w-full justify-center gap-x-1.5 rounded-md px-4 py-2 text-lg font-semibold text-white shadow-sm hover:bg-gray-50" id="menu-button" aria-expanded="true" aria-haspopup="true">
