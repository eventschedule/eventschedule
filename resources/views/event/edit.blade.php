                                ...
                                <div class="mb-6">
                                    <div v-for="(promoCode, pcIndex) in promoCodes" :key="pcIndex" class="mt-4 p-4 border border-gray-300 dark:border-gray-700 rounded-lg">
                                        ...
                                        <div class="mt-3 flex items-center justify-between gap-1">
                                            <div v-if="promoCode.code && promoLinkBaseUrl" class="flex items-center gap-1.5 min-w-0 me-1">
                                                <a :href="promoLinkBaseUrl + '?promo=' + promoCode.code.trim().toUpperCase()"
                                                   target="_blank"
                                                   class="text-xs text-gray-500 dark:text-gray-400 hover:text-[#4E81FA] dark:hover:text-[#4E81FA] min-w-0 truncate"
