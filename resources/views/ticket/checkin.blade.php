    ...
    <div id="app" class="max-w-3xl mx-auto px-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('ticket.scan') }}" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-white bg-[#4E81FA] rounded-lg hover:bg-[#3D6FE8] transition-colors">
        ...
        <div class="flex flex-col sm:flex-row gap-3 mb-6">
            ...
            <select v-if="availableDates.length > 0" v-model="selectedDate" @change="fetchStats" class="sm:w-48 rounded-lg border-gray-300 dark:border-[#2d2d30] dark:bg-[#1e1e1e] dark:text-gray-100 shadow-sm focus:border-[#4E81FA] focus:ring-[#4E81FA]">
