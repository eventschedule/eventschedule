    ...
    <x-slot name="head">
        ...
        <style {!! nonce_attr() !!}>
            ...
            #html5-qrcode-button-camera-permission {
                background-color: var(--brand-blue); color: white; padding: 0.5rem 1rem; border-radius: 0.5rem; transition: background-color 0.15s;
            }
        ...
        <div class="bg-white dark:bg-[#1e1e1e] rounded-xl shadow-lg dark:shadow-none dark:border dark:border-[#2d2d30] p-6">
            ...
            <div v-if="scanResult" class="mt-6 text-center">
                <div :class="[
                    ...
                    errorMessage ? 'bg-red-50 border-red-200 dark:bg-red-900/20 dark:border-red-800' :
                    hasUsedSeats ? 'bg-orange-50 border-orange-200 dark:bg-orange-900/20 dark:border-orange-800' : 'bg-green-50 border-green-200 dark:bg-green-900/20 dark:border-green-800'
                ]">
                    <div class="flex flex-col items-center justify-center">
                        <!-- Success Icon -->
                        <svg v-if="!errorMessage && !hasUsedSeats" class="w-12 h-12 text-green-600 dark:text-green-400 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Warning Icon -->
                        <svg v-if="hasUsedSeats && !errorMessage" class="w-12 h-12 text-orange-600 dark:text-orange-400 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                        </svg>
                        <!-- Error Icon -->
                        <svg v-if="errorMessage" class="w-12 h-12 text-red-600 dark:text-red-400 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                        </svg>
                        <p :class="[
                            'font-medium text-center',
                            errorMessage ? 'text-red-800 dark:text-red-300' :
                            hasUsedSeats ? 'text-orange-800 dark:text-orange-300' : 'text-green-800 dark:text-green-300'
                        ]">
                    ...
                    <div v-if="eventDetails && !errorMessage" class="mt-4 text-start">
                        ...
                        <p class="text-gray-600 dark:text-[#9ca3af] mt-1">@{{ eventDetails.date }}</p>
                ...
                <button @click="startNewScan" class="mt-6 bg-[var(--brand-blue)] text-white px-4 py-2 rounded-lg hover:bg-[var(--brand-blue-dark)] transition-colors">
