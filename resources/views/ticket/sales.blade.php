    ...
    <div class="flow-root">
        <div class="flex flex-col sm:flex-row sm:justify-between gap-4">
            ...
            <a href="{{ route('ticket.scan') }}" class="w-full sm:w-auto">
                <button type="button"
                    class="w-full sm:w-auto inline-flex items-center justify-center rounded-md shadow-sm bg-[#4E81FA] px-6 py-3 text-base font-semibold text-white shadow-sm hover:bg-[#3A6BE0] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4E81FA]">
                    <svg class="-ml-0.5 mr-2 h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                        <path
