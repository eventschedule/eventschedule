<x-marketing-layout>
    ...
    <style {!! nonce_attr() !!}>
        /* For white-label "The Blank Slate" styles. The shared es-* motion system lives in
           marketing.css; this holds the blue/cyan glow gradient, the drifting branded
           schedule card, and the brand-badge motif (your mark, front and center). */
        .text-gradient-wl {
        ...
        @keyframes es-wl-float {
            0%, 100% { transform: translateY(0px); }
            50% { transform: translateY(-10px); }
        }
        .es-wl-float { animation: es-wl-float 6s ease-in-out infinite; }

        /* Brand-badge motif: rounded logo marks pulse in a wave, like your brand
           appearing across a fully white-labeled schedule. */
        .es-brands { display: flex; align-items: center; }
        .es-brand {
            ...
            animation: es-brand-pulse var(--br-dur, 2.6s) ease-in-out infinite;
            animation-delay: var(--br-delay, 0s);
        }
        @keyframes es-brand-pulse {
            0%, 100% { opacity: 0.25; transform: scale(0.8); }
            50% { opacity: 1; transform: scale(1); box-shadow: 0 0 10px rgba(37, 99, 235, 0.5); }
        }
        @media (prefers-reduced-motion: reduce) {
            .es-wl-float, .es-brand, .animate-pulse-slow { animation: none !important; }
            .es-brand { opacity: 0.6; transform: scale(0.9); }
        }
    </style>
    ...
    <section class="es-hero relative flex min-h-[calc(80svh-4rem)] items-center overflow-hidden bg-white py-16 dark:bg-[#0a0a0f] noise">
        <div class="absolute inset-0" aria-hidden="true">
            ...
            <!-- Brand-badge motif along the bottom edge -->
            <div class="es-brands absolute bottom-10 left-0 right-0 mx-auto hidden h-16 max-w-4xl items-center justify-center gap-4 px-8 opacity-55 md:flex" style="mask-image: linear-gradient(to right, transparent, black 12%, black 88%, transparent);">
                @for ($i = 0; $i < 26; $i++)
                    @php $dur = 2.4 + ($i % 5) * 0.3; $delay = ($i % 13) * 0.2; @endphp
                    <span class="es-brand" style="--br-dur: {{ $dur }}s; --br-delay: {{ $delay }}s;"></span>
                @endfor
            </div>
        </div>
        ...
        <div class="pointer-events-none relative z-10 mx-auto w-full max-w-5xl px-4 text-center sm:px-6 lg:px-8">
            <div class="es-fade-up es-d-1 mb-8 inline-flex items-center gap-3 rounded-full glass px-5 py-2.5">
                ...
                <span class="text-sm font-medium tracking-wide text-gray-600 dark:text-gray-300">White Label</span>
            </div>

            <h1 class="es-balance mb-6 text-[2.6rem] font-black leading-[1.05] tracking-tight text-gray-900 dark:text-white sm:text-6xl lg:text-7xl">
                <span class="es-mask"><span class="es-mask-line">Your brand,</span></span>
                <span class="es-mask es-mask-2"><span class="es-mask-line"><span class="text-gradient-wl">front and center</span></span></span>
            </h1>
            ...
            <div class="es-fade-up es-d-3 flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <a href="{{ route('marketing.docs.schedule_styling') }}" class="group pointer-events-auto inline-flex items-center justify-center gap-2 rounded-2xl glass px-7 py-4 text-lg font-semibold text-gray-800 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg dark:text-white">
    ...
    <section class="bg-white py-20 dark:bg-[#0a0a0f] lg:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto mb-12 max-w-3xl text-center">
                <h2 class="es-balance text-3xl font-black tracking-tight text-gray-900 dark:text-white md:text-5xl" data-reveal>Your schedule, <span class="text-gradient-wl">entirely your own</span></h2>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3" data-reveal-group="80">
                    ...
                    <div class="es-tilt-inner relative flex h-full flex-col overflow-hidden rounded-3xl border border-gray-200 bg-white p-7 dark:border-white/10 dark:bg-white/[0.04] lg:p-9">
                        <div class="flex flex-col gap-8 lg:flex-row lg:items-center">
                            <div class="flex-1">
                                ...
                                <h3 class="mb-3 text-2xl font-bold text-gray-900 dark:text-white lg:text-3xl">Remove "Powered by"</h3>
                                <p class="mb-6 text-gray-500 dark:text-gray-400 lg:text-lg">The "Powered by Event Schedule" badge is automatically removed on Pro and Enterprise plans. Your schedule appears entirely as your own.</p>
                                <div class="flex flex-wrap gap-3">
                                    <span class="inline-flex items-center rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-700 dark:bg-white/10 dark:text-gray-300">Automatic removal</span>
                                    <span class="inline-flex items-center rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-700 dark:bg-white/10 dark:text-gray-300">No setup needed</span>
                                </div>
                            </div>
                            <div class="flex-shrink-0 lg:w-64" aria-hidden="true">
                                <div class="space-y-3">
                                    <div class="rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-white/10 dark:bg-[#0f0f14]">
                                        <div class="mb-2 text-xs text-gray-400">Before</div>
                                        <div class="mb-2 h-16 rounded-lg bg-gray-200 dark:bg-white/5"></div>
                                        <div class="text-center text-[10px] text-gray-400">Powered by Event Schedule</div>
                                    </div>
                                    <div class="rounded-2xl border border-blue-300 bg-gray-50 p-4 dark:border-blue-500/30 dark:bg-[#0f0f14]">
                                        <div class="mb-2 text-xs text-blue-500">After (Pro)</div>
                                        <div class="mb-2 h-16 rounded-lg bg-gray-200 dark:bg-white/5"></div>
                                        <div class="text-center text-[10px] text-green-500 dark:text-green-400">Clean - no branding</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="es-bento group relative" data-tilt="5" data-reveal="panel">
                    <div class="es-tilt-inner relative flex h-full flex-col overflow-hidden rounded-3xl border border-gray-200 bg-white p-7 dark:border-white/10 dark:bg-white/[0.04]">
                        ...
                        <h3 class="mb-3 text-2xl font-bold text-gray-900 dark:text-white">Professional presence</h3>
                        <p class="mb-6 text-gray-500 dark:text-gray-400">Present your schedule as a polished, professional platform. Ideal for businesses, venues, and organizations that want full brand control.</p>
                        <div class="mt-auto space-y-2" aria-hidden="true">
                            @foreach (['Your logo and colors', 'Your custom domain', 'No third-party badges'] as $pi => $item)
                                <div class="es-ai-field flex items-center gap-3 rounded-lg bg-gray-100 px-3 py-2 dark:bg-white/5" style="--i: {{ $pi }};">
                ...
                <div class="es-bento group relative" data-tilt="5" data-reveal="panel">
                    <div class="es-tilt-inner relative flex h-full flex-col overflow-hidden rounded-3xl border border-gray-200 bg-white p-7 dark:border-white/10 dark:bg-white/[0.04]">
                        ...
                        <h3 class="mb-3 text-2xl font-bold text-gray-900 dark:text-white">Total customization</h3>
                        <p class="mb-6 text-gray-500 dark:text-gray-400">Combine branding removal with <a href="{{ marketing_url('/features/custom-css') }}" class="text-blue-600 hover:underline dark:text-blue-400">Custom CSS</a> for pixel-perfect control over every aspect of your schedule's appearance.</p>
                        <div class="mt-auto rounded-xl border border-gray-200 bg-gray-100 p-4 dark:border-white/10 dark:bg-[#0f0f14]" aria-hidden="true">
                            <div class="mb-2 font-mono text-xs text-gray-400">custom.css</div>
                            <div class="space-y-1 font-mono text-sm text-blue-600 dark:text-blue-400">
                    ...
                    <div class="es-tilt-inner relative flex h-full flex-col overflow-hidden rounded-3xl border border-gray-200 bg-white p-7 dark:border-white/10 dark:bg-white/[0.04] lg:p-9">
                        <div class="grid items-center gap-8 md:grid-cols-2">
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-400 lg:text-lg">White-label branding removal is part of the Pro plan, alongside event graphics, ticketing, Custom CSS, and more. Start free and upgrade when you're ready for a fully branded experience.</p>
                            </div>
    ...
    <!-- ============================================================ -->
    <!-- 3. Perfect for professional brands (dark band)             -->
    <!-- ============================================================ -->
    <section class="bg-white px-2 py-14 dark:bg-[#0a0a0f] sm:px-4 lg:py-20">
        <div class="es-band-dark noise relative overflow-hidden rounded-[2.5rem] border border-white/[0.06] px-4 py-16 sm:px-6 lg:px-8 lg:py-20 2xl:mx-auto 2xl:max-w-[100rem]">
            <div class="pointer-events-none absolute inset-0" aria-hidden="true">
                ...
                <div class="es-brands absolute bottom-6 left-0 right-0 mx-auto flex h-14 items-center justify-center gap-4 px-8 opacity-40" style="mask-image: linear-gradient(to right, transparent, black 12%, black 88%, transparent);">
                    @for ($i = 0; $i < 24; $i++)
                        @php $dur = 2.4 + ($i % 5) * 0.3; $delay = ($i % 13) * 0.2; @endphp
                        <span class="es-brand" style="--br-dur: {{ $dur }}s; --br-delay: {{ $delay }}s;"></span>
                    @endfor
            ...
            <div class="relative z-10 mx-auto max-w-7xl">
                <div class="mx-auto mb-14 max-w-3xl text-center">
                    <h2 class="es-balance mb-4 text-3xl font-black tracking-tight text-white md:text-5xl" data-reveal>Perfect for <span class="text-gradient-wl">professional brands</span></h2>
                    <p class="text-lg text-gray-300 sm:text-xl" data-reveal style="--reveal-delay: 0.1s;">Present a polished, branded experience to your audience.</p>
                </div>

                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4" data-reveal-group="80">
                    @php
                        $wlUseCases = [
                            ['Venues', 'Present your event calendar as a seamless part of your venue\'s brand.', 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
                            ['Artists', 'Share your gig schedule under your own name with no platform branding.', 'M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3'],
                            ['Businesses', 'Embed a branded event calendar on your corporate website.', 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
                            ['Organizations', 'Run community calendars with your organization\'s identity.', 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'],
                        ];
                    @endphp
                    @foreach ($wlUseCases as $uc)
    ...
    <section class="relative overflow-hidden bg-gray-50 py-20 dark:bg-[#0f0f14]">
        ...
        <div class="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3" data-reveal-group="90">
                <!-- Read the guide -->
                <a href="{{ route('marketing.docs.schedule_styling') }}#remove-branding" data-reveal class="group flex flex-col rounded-3xl border border-gray-200 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-white/10 dark:bg-white/5 lg:p-10">
                    ...
                    <p class="mb-4 text-lg text-gray-500 dark:text-gray-400">Learn how to customize your schedule's branding and appearance.</p>
                ...
                <!-- Next feature -->
                <a href="{{ marketing_url('/features/custom-css') }}" data-reveal class="group flex flex-col rounded-3xl border border-blue-200 bg-gradient-to-br from-blue-100 to-cyan-100 p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-white/10 dark:from-blue-900 dark:to-cyan-900 lg:p-10">
                    <h3 class="mb-3 text-2xl font-bold text-gray-900 transition-colors group-hover:text-blue-600 dark:text-white dark:group-hover:text-blue-300">Custom CSS</h3>
                    <p class="mb-4 text-lg text-gray-600 dark:text-white/80">Write your own CSS for pixel-perfect control over your schedule's appearance.</p>
                ...
                <div data-reveal class="flex flex-col rounded-3xl border border-gray-200 bg-white p-8 dark:border-white/10 dark:bg-white/5 lg:p-10">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ marketing_url('/for-restaurants') }}" class="group/link flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 p-3 transition-all hover:border-sky-300 hover:bg-gray-100 dark:border-white/10 dark:bg-white/5 dark:hover:border-sky-500/30 dark:hover:bg-white/10">
                            <span class="font-medium text-gray-900 dark:text-white">Restaurants</span>
                            <svg aria-hidden="true" class="h-4 w-4 text-gray-400 transition-colors group-hover/link:text-sky-500 rtl:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                        </a>
                        <a href="{{ marketing_url('/for-hotels-and-resorts') }}" class="group/link flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 p-3 transition-all hover:border-sky-300 hover:bg-gray-100 dark:border-white/10 dark:bg-white/5 dark:hover:border-sky-500/30 dark:hover:bg-white/10">
    ...
    <section class="bg-gray-100 py-20 dark:bg-black/30 lg:py-28">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto mb-14 max-w-3xl text-center">
                <h2 class="es-balance mb-4 text-3xl font-black tracking-tight text-gray-900 dark:text-white md:text-5xl" data-reveal>Frequently asked <span class="text-gradient-wl">questions</span></h2>
                <p class="text-lg text-gray-500 dark:text-gray-400 sm:text-xl" data-reveal style="--reveal-delay: 0.1s;">Everything you need to know about white labeling.</p>
            </div>

            <div class="space-y-4" data-reveal-group="80">
                @foreach ([
                    ['How do I remove Event Schedule branding?', 'Branding is automatically removed when you upgrade to a Pro or Enterprise plan. No additional configuration is needed - just upgrade and the "Powered by" badge disappears.'],
                    ['What branding is removed?', 'The "Powered by Event Schedule" badge that appears on your public schedule page is removed. Your schedule appears entirely as your own brand with no reference to Event Schedule.'],
                    ['Is white labeling available on selfhosted installations?', 'Yes. Selfhosted installations have branding removed by default, so your schedule is fully white-labeled out of the box.'],
                    ['Can I add my own branding?', 'Yes. You can upload a profile image, header image, and customize colors, fonts, and backgrounds to match your brand. Pro plans also include Custom CSS for advanced styling control.'],
                ] as [$q, $a])
            ...
            <div class="es-finale-panel noise relative overflow-hidden rounded-[2.5rem] border border-white/10 px-6 py-16 text-center shadow-2xl shadow-blue-500/20 sm:px-12 lg:py-24" data-confetti data-reveal="panel">
                ...
                <div class="relative z-10">
                    <h2 class="es-balance mx-auto mb-6 max-w-3xl text-3xl font-black tracking-tight text-white md:text-5xl">
                        Ready to own <span class="text-gradient-wl">your brand?</span>
                    </h2>
