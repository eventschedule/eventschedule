    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-gray-200 dark:border-white/10 mb-8 animate-reveal" style="opacity: 0;">
                ...
                <span class="text-sm text-gray-600 dark:text-gray-300">Embed Tickets</span>
            </div>
            ...
            <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-8 leading-tight animate-reveal delay-100" style="opacity: 0;">
                Sell tickets from<br>
                <span class="text-gradient">any website</span>
            </h1>
            ...
            <p class="mt-6 text-gray-500 dark:text-gray-400 animate-reveal delay-300" style="opacity: 0;">
                <a href="{{ route('marketing.docs.sharing') }}" class="underline hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Read the Sharing guide</a>
            </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-blue-100 dark:from-blue-900 dark:to-blue-900 border border-gray-200 dark:border-white/10 p-8 lg:p-10">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 dark:text-white/80 text-lg mb-6">One iframe tag is all you need. Copy the embed code from your event settings and paste it anywhere on your website.</p>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 border border-gray-200 dark:border-white/10 p-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">All payment methods</h2>
                    <p class="text-gray-600 dark:text-white/80 mb-6">Buyers select tickets and enter details inside the embed. Supports all payment methods.</p>

                    <div class="space-y-2">
                        <div class="flex items-center gap-3 p-2.5 rounded-xl bg-gray-200 dark:bg-white/10 border border-gray-200 dark:border-white/10">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 font-medium">Stripe</span>
                        </div>
                        <div class="flex items-center gap-3 p-2.5 rounded-xl bg-gray-200 dark:bg-white/10 border border-gray-200 dark:border-white/10">
                            <div class="w-7 h-7 rounded-lg bg-blue-500/20 flex items-center justify-center flex-shrink-0">
                                <svg aria-hidden="true" class="w-4 h-4 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 font-medium">Invoice Ninja</span>
                        </div>
                        <div class="flex items-center gap-3 p-2.5 rounded-xl bg-gray-200 dark:bg-white/10 border border-gray-200 dark:border-white/10">
                            <div class="w-7 h-7 rounded-lg bg-blue-500/20 flex items-center justify-center flex-shrink-0">
                                <svg aria-hidden="true" class="w-4 h-4 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 font-medium">Cash or at the door</span>
                        </div>
                        <div class="flex items-center gap-3 p-2.5 rounded-xl bg-gray-200 dark:bg-white/10 border border-gray-200 dark:border-white/10">
                            <div class="w-7 h-7 rounded-lg bg-blue-500/20 flex items-center justify-center flex-shrink-0">
                                <svg aria-hidden="true" class="w-4 h-4 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 font-medium">Custom payment URL</span>
                        </div>
                    </div>
                </div>

                <!-- All Ticket Features Work -->
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 border border-gray-200 dark:border-white/10 p-8">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-300 text-sm font-medium mb-4">
                        <svg aria-hidden="true" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">All features included</h2>
                    <p class="text-gray-600 dark:text-white/80 mb-6">The embed is a full ticket checkout, not a cut-down version.</p>

                    <div class="space-y-2.5">
                        <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                            <svg aria-hidden="true" class="w-4 h-4 text-green-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            Promo codes
                        </div>
                        ...
                        <div class="flex gap-4">
                            <div class="flex-1 rounded-2xl overflow-hidden border border-gray-200 dark:border-white/10">
                                <div class="bg-gray-100 p-3 border-b border-gray-200">
                                    <div class="text-[10px] text-gray-400 mb-2">Light mode</div>
                                    <div class="space-y-1.5">
                                        <div class="h-2.5 bg-gray-200 rounded w-full"></div>
                                        <div class="h-2.5 bg-blue-200 rounded w-3/4"></div>
                                        <div class="h-5 bg-blue-400 rounded w-full mt-2"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex-1 rounded-2xl overflow-hidden border border-white/10">
                                <div class="bg-[#1e1e1e] p-3 border-b border-[#2d2d30]">
                                    <div class="text-[10px] text-gray-500 mb-2">Dark mode</div>
                                    <div class="space-y-1.5">
                                        <div class="h-2.5 bg-[#2d2d30] rounded w-full"></div>
                                        <div class="h-2.5 bg-blue-900 rounded w-3/4"></div>
                                        <div class="h-5 bg-blue-600 rounded w-full mt-2"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 border border-gray-200 dark:border-white/10 p-8 lg:p-10">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Mobile ready</h2>
                    <p class="text-gray-600 dark:text-white/80 mb-6">The ticket form looks great and works flawlessly on phones, tablets, and desktops alike.</p>

                    <div class="flex items-end justify-center gap-3">
                        <div class="w-10 rounded-xl bg-gray-200 dark:bg-white/10 border border-gray-300 dark:border-white/20 overflow-hidden" style="height: 64px;">
                            <div class="h-full p-1.5 space-y-1">
                                <div class="h-1.5 bg-blue-300 dark:bg-blue-500/40 rounded w-full"></div>
                                <div class="h-1.5 bg-gray-300 dark:bg-white/10 rounded w-full"></div>
                                <div class="h-3 bg-blue-400 dark:bg-blue-600 rounded w-full mt-1"></div>
                            </div>
                        </div>
                        <div class="w-16 rounded-xl bg-gray-200 dark:bg-white/10 border border-gray-300 dark:border-white/20 overflow-hidden" style="height: 80px;">
                            <div class="h-full p-2 space-y-1.5">
                                <div class="h-2 bg-blue-300 dark:bg-blue-500/40 rounded w-full"></div>
                                <div class="h-2 bg-gray-300 dark:bg-white/10 rounded w-3/4"></div>
                                <div class="h-4 bg-blue-400 dark:bg-blue-600 rounded w-full mt-1"></div>
                            </div>
                        </div>
                        <div class="w-24 rounded-xl bg-gray-200 dark:bg-white/10 border border-gray-300 dark:border-white/20 overflow-hidden" style="height: 96px;">
                            <div class="h-full p-2.5 space-y-2">
                                <div class="h-2 bg-blue-300 dark:bg-blue-500/40 rounded w-full"></div>
                                <div class="h-2 bg-gray-300 dark:bg-white/10 rounded w-5/6"></div>
                                <div class="h-5 bg-blue-400 dark:bg-blue-600 rounded w-full mt-1"></div>
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Pro Plan Requirement (bottom right to fill the grid) -->
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 border border-gray-200 dark:border-white/10 p-8">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-300 text-sm font-medium mb-4">
                        <svg aria-hidden="true" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Pro plan and above</h2>
                    <p class="text-gray-600 dark:text-white/80 mb-6">Ticket embeds require a paid plan on the hosted platform. Selfhosted users get this feature included at no extra cost.</p>
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="relative text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Enable tickets or RSVP</h3>
                    <p class="text-gray-500 dark:text-gray-400">Add at least one ticket type or enable RSVP on your event from the admin portal.</p>
                </div>
                ...
                <div class="relative text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Drop the iframe tag into your website's HTML. The ticket form appears instantly, ready to take purchases.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <!-- Read the guide -->
                <a href="{{ route('marketing.docs.tickets') }}#embed-widget" class="group block">
                    <div class="h-full bg-white dark:bg-white/5 rounded-3xl border border-gray-200 dark:border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300 flex flex-col">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-lg mb-4">Learn how to set up and customize the ticket embed widget.</p>
                ...
                <a href="{{ marketing_url('/features/ticketing') }}" class="group block">
                    <div class="h-full bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 rounded-3xl border border-blue-200 dark:border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300 flex flex-col">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors">Ticketing</h2>
                        <p class="text-gray-500 dark:text-white/80 text-lg mb-4">Sell tickets, manage attendees, and track sales for all your events.</p>
            ...
            <div class="space-y-4" x-data="{ open: null }">
                ...
                <div class="bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 rounded-2xl border border-blue-200 dark:border-white/10 shadow-sm overflow-hidden">
                    <button @click="open = open === 1 ? null : 1" class="w-full flex items-center justify-between p-6 text-left cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            How do I embed a ticket form on my website?
                        </h3>
                ...
                <div class="bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900 dark:to-cyan-900 rounded-2xl border border-blue-200 dark:border-white/10 shadow-sm overflow-hidden">
                    <button @click="open = open === 2 ? null : 2" class="w-full flex items-center justify-between p-6 text-left cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Does it support all payment methods?
                        </h3>
                ...
                <div class="bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 rounded-2xl border border-blue-200 dark:border-white/10 shadow-sm overflow-hidden">
                    <button @click="open = open === 3 ? null : 3" class="w-full flex items-center justify-between p-6 text-left cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can I use the embed for free events and RSVPs?
                        </h3>
