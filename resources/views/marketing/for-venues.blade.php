<x-marketing-layout>
    ...
    <section class="relative bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 mb-8">
                ...
                <span class="text-sm text-gray-300">For Bars, Clubs & Event Spaces</span>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('sign_up') }}" class="inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-fuchsia-600 to-pink-600 rounded-2xl hover:scale-105 transition-all shadow-lg shadow-fuchsia-500/25">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-fuchsia-900/50 to-pink-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl lg:text-4xl font-bold text-white mb-4">Beautiful event calendar</h3>
                            <p class="text-gray-400 text-lg mb-6">Showcase all your upcoming events on a mobile-friendly calendar. Embed it on your website or share the link directly.</p>
                            ...
                            <div class="relative animate-float">
                                <div class="bg-gradient-to-br from-fuchsia-500/20 to-pink-500/20 rounded-2xl border border-fuchsia-400/30 p-4 max-w-xs">
                                    <div class="text-center mb-3">
                                        <div class="text-white font-semibold">The Blue Note</div>
                                        <div class="text-fuchsia-300 text-sm">March 2024</div>
                                    </div>
                                    <div class="space-y-2">
                                        <div class="flex items-center gap-3 p-2 rounded-lg bg-fuchsia-500/20 border border-fuchsia-400/30">
                                            <div class="text-fuchsia-300 text-xs font-mono w-12">Mar 15</div>
                                            <span class="text-white text-sm">Jazz Night</span>
                                        </div>
                                        <div class="flex items-center gap-3 p-2 rounded-lg bg-white/5">
                                            <div class="text-gray-400 text-xs font-mono w-12">Mar 18</div>
                                            <span class="text-gray-300 text-sm">Open Mic</span>
                                        </div>
                                        <div class="flex items-center gap-3 p-2 rounded-lg bg-white/5">
                                            <div class="text-gray-400 text-xs font-mono w-12">Mar 22</div>
                                            <span class="text-gray-300 text-sm">DJ Night</span>
                                        </div>
                                        <div class="flex items-center gap-3 p-2 rounded-lg bg-white/5">
                                            <div class="text-gray-400 text-xs font-mono w-12">Mar 29</div>
                                            <span class="text-gray-300 text-sm">Live Band</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-900/50 to-violet-900/50 border border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-3">Accept performance requests</h3>
                    <p class="text-gray-400 mb-6">Artists can request to play at your venue. Review, approve, or decline right from your dashboard.</p>

                    <div class="space-y-2">
                        <div class="flex items-center gap-3 p-3 rounded-xl bg-indigo-500/20 border border-indigo-400/30">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center text-white text-xs font-semibold">SJ</div>
                            <div class="flex-1">
                                <div class="text-white text-sm font-medium">Sarah Johnson Trio</div>
                                <div class="text-indigo-300 text-xs">Requesting Mar 22</div>
                            </div>
                        ...
                        <div class="flex items-center gap-3 p-3 rounded-xl bg-white/5">
                            ...
                            <div class="flex-1">
                                <div class="text-gray-300 text-sm font-medium">DJ Nova</div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-900/50 to-purple-900/50 border border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-3">Sell tickets with QR check-in</h3>
                    <p class="text-gray-400 mb-6">Multiple ticket types, Stripe payments, and contactless check-in. Use any smartphone to scan.</p>
                    ...
                    <div class="flex justify-center">
                        <div class="w-24 h-24 bg-white rounded-xl p-2 relative">
                            ...
                            <div class="absolute inset-x-0 top-2 h-0.5 bg-gradient-to-r from-violet-500 to-fuchsia-500 animate-pulse"></div>
                        </div>
                    </div>
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900/50 to-teal-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-white mb-4">Multiple rooms & stages</h3>
                            <p class="text-gray-400 text-lg">Organize events by space. Main stage, rooftop bar, private room. Each gets its own filterable schedule.</p>
                        </div>
                        <div class="bg-black/30 rounded-2xl p-5 border border-white/10">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center gap-2 p-2 rounded-lg bg-emerald-500/20 border border-emerald-500/30">
                                    ...
                                    <span class="ml-auto text-emerald-300 text-xs">12 events</span>
                                </div>
                                <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5">
                                    <div class="w-2 h-2 rounded-full bg-teal-400"></div>
                                    <span class="text-gray-300 text-sm">Rooftop Bar</span>
                                    <span class="ml-auto text-gray-500 text-xs">8 events</span>
                                </div>
                                <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5">
                                    <div class="w-2 h-2 rounded-full bg-cyan-400"></div>
                                    <span class="text-gray-300 text-sm">Acoustic Lounge</span>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-900/50 to-teal-900/50 border border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-3">Staff management</h3>
                    <p class="text-gray-400 mb-6">Give your team access to manage events. Set permissions so everyone has the right level of control.</p>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-white/10">
                            ...
                            <div class="flex-1">
                                <div class="text-white text-sm">Mike</div>
                            </div>
                        ...
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5">
                            ...
                            <div class="flex-1">
                                <div class="text-gray-300 text-sm">Lisa</div>
                            </div>
                            <span class="px-1.5 py-0.5 rounded bg-teal-500/20 text-teal-300 text-[10px]">Manager</span>
                        </div>
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5">
                            ...
                            <div class="flex-1">
                                <div class="text-gray-300 text-sm">Tom</div>
                            </div>
                            <span class="px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-300 text-[10px]">Door Staff</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-900/50 to-indigo-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-6">Two-way sync keeps your venue calendar and Google Calendar in perfect harmony.</p>

                    <div class="flex items-center justify-center gap-3">
                        <div class="bg-blue-500/20 rounded-xl border border-blue-400/30 p-3 w-20">
                            <div class="text-[10px] text-blue-300 mb-1 text-center">Venue</div>
                            <div class="space-y-1">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-900/50 to-orange-900/50 border border-white/10 p-8">
                    ...
                    <div class="flex justify-center">
                        <div class="relative w-32 h-32 bg-gradient-to-br from-amber-500/30 to-orange-500/30 rounded-xl border border-amber-400/30 p-2">
                            <div class="w-full h-full bg-gradient-to-br from-fuchsia-600/40 to-pink-600/40 rounded-lg flex flex-col items-center justify-center">
                                ...
                                <div class="text-gray-400 text-[8px] mt-1">The Blue Note • 9PM</div>
                            </div>
    ...
    <section id="perfect-for" class="bg-gray-50 py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Bars & Pubs -->
                <a href="{{ marketing_url('/for-bars') }}" class="block bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-fuchsia-200 transition-all">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Bars & Pubs</h3>
                    <p class="text-gray-600 text-sm">Promote live music nights, trivia, and special events to regulars.</p>
                ...
                <!-- Nightclubs -->
                <a href="{{ marketing_url('/for-nightclubs') }}" class="block bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-pink-200 transition-all">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Nightclubs</h3>
                    <p class="text-gray-600 text-sm">Manage DJ lineups, themed nights, and VIP table reservations.</p>
                ...
                <!-- Music Venues -->
                <a href="{{ marketing_url('/for-music-venues') }}" class="block bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-violet-200 transition-all">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Music Venues</h3>
                    <p class="text-gray-600 text-sm">Book bands, sell tickets, and manage your concert calendar.</p>
                ...
                <!-- Theaters -->
                <a href="{{ marketing_url('/for-theaters') }}" class="block bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-rose-200 transition-all">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Theaters</h3>
                    <p class="text-gray-600 text-sm">Schedule productions, manage show runs, and sell season tickets.</p>
                ...
                <!-- Comedy Clubs -->
                <a href="{{ marketing_url('/for-comedy-clubs') }}" class="block bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-amber-200 transition-all">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Comedy Clubs</h3>
                    <p class="text-gray-600 text-sm">Book comedians, host open mics, and fill seats for headliners.</p>
                ...
                <!-- Restaurants -->
                <a href="{{ marketing_url('/for-restaurants') }}" class="block bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-orange-200 transition-all">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Restaurants</h3>
                    <p class="text-gray-600 text-sm">Promote wine tastings, chef's tables, and live entertainment.</p>
                ...
                <!-- Breweries & Wineries -->
                <a href="{{ marketing_url('/for-breweries-and-wineries') }}" class="block bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-indigo-200 transition-all">
                    <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-indigo-100 mb-4">
                        <svg class="w-6 h-6 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Breweries & Wineries</h3>
                    <p class="text-gray-600 text-sm">Host tastings, tours, and live music in your taproom.</p>
                ...
                <a href="{{ marketing_url('/for-art-galleries') }}" class="block bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-purple-200 transition-all">
                    <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-purple-100 mb-4">
                        <svg class="w-6 h-6 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Art Galleries & Studios</h3>
                    <p class="text-gray-600 text-sm">Announce openings, exhibitions, and artist meet-and-greets.</p>
                ...
                <!-- Community Centers -->
                <a href="{{ marketing_url('/for-community-centers') }}" class="block bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-emerald-200 transition-all">
                    <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-emerald-100 mb-4">
                        <svg class="w-6 h-6 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Community Centers</h3>
                    <p class="text-gray-600 text-sm">Organize classes, workshops, and community gatherings.</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-fuchsia-500 to-pink-500 text-white text-2xl font-bold rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-fuchsia-500/25">
                        1
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Create Your Calendar</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Add Your Events</h3>
                    <p class="text-gray-600 text-sm">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Share & Sell</h3>
                    <p class="text-gray-600 text-sm">
    ...
    <!-- CTA Section -->
    <section class="relative bg-gradient-to-br from-fuchsia-600 to-pink-700 py-24 overflow-hidden">
