<x-marketing-layout>
    ...
    <x-slot name="keywords">fan videos, event comments, community engagement, YouTube videos events, attendee feedback, event community, fan content, audience engagement</x-slot>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('sign_up') }}" class="inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-rose-600 to-orange-600 rounded-2xl hover:scale-105 transition-all shadow-lg shadow-rose-500/25">
                    Get started free
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <a href="{{ marketing_url('/features/newsletters') }}" class="group block">
                    <div class="h-full bg-gradient-to-br from-sky-100 to-cyan-100 dark:from-sky-900 dark:to-cyan-900 rounded-3xl border border-sky-200 dark:border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300">
                        ...
                        <p class="text-gray-600 dark:text-white/80 text-lg mb-4">Send beautiful newsletters to your followers and ticket buyers with a drag-and-drop editor, templates, and analytics.</p>
    ...
    <section class="relative bg-gradient-to-br from-rose-600 to-orange-600 py-24 overflow-hidden">
        <div class="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:32px_32px]" aria-hidden="true"></div>
