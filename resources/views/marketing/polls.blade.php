<x-marketing-layout>
    ...
    <x-slot name="description">Add interactive polls to your events. Guests vote on multiple choice questions with real-time results. A Pro feature with one vote per user, no credit card.</x-slot>
