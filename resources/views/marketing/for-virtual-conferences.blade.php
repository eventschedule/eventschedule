<x-marketing-layout>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('sign_up') }}" class="group inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-sky-600 to-blue-600 rounded-2xl hover:scale-105 transition-transform duration-150 will-change-transform shadow-lg shadow-sky-500/25">
                        ...
                        <div class="bg-indigo-500/20 rounded-xl border border-indigo-400/30 p-4">
                            <div class="space-y-2 mb-3">
                                <div class="flex items-center justify-between p-2 rounded-lg bg-indigo-400/20">
                                    ...
                                    <span class="text-indigo-400 text-xs font-semibold">$49</span>
                                </div>
                                <div class="flex items-center justify-between p-2 rounded-lg bg-blue-400/20">
                                    ...
                                    <span class="text-blue-400 text-xs font-semibold">$149</span>
                                </div>
                                <div class="flex items-center justify-between p-2 rounded-lg bg-sky-400/20">
                                    ...
                                    <span class="text-sky-400 text-xs font-semibold">$29</span>
                                </div>
                            </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-100 to-sky-100 dark:from-cyan-900 dark:to-sky-900 border border-cyan-200 dark:border-white/10 p-8">
                    ...
                    <div class="bg-gray-100 dark:bg-[#0f0f14] rounded-xl p-4 border border-gray-200 dark:border-white/10">
                        ...
                        <div class="grid grid-cols-3 gap-1 text-center">
                            <div class="p-1.5 rounded bg-gray-100 dark:bg-white/5 text-cyan-300 text-[10px]">Website</div>
                            <div class="p-1.5 rounded bg-gray-100 dark:bg-white/5 text-cyan-300 text-[10px]">LinkedIn</div>
                            <div class="p-1.5 rounded bg-gray-100 dark:bg-white/5 text-cyan-300 text-[10px]">Email</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div class="flex items-center justify-center">
                            <div class="flex items-center gap-4">
                                <div class="bg-teal-500/20 rounded-xl border border-teal-400/30 p-4 w-36">
                                    <div class="text-teal-300 text-xs text-center mb-2 font-semibold">Your Agenda</div>
                                    <div class="space-y-1.5">
                                        <div class="h-2 bg-white/20 rounded"></div>
                                        <div class="h-2 bg-teal-400/40 rounded w-3/4"></div>
                                    </div>
                                    <div class="mt-3 p-2 rounded-lg bg-teal-400/20 border border-teal-400/30">
                                        <div class="text-[10px] text-white text-center font-medium">Opening Keynote</div>
                                        <div class="text-[8px] text-teal-300 text-center mt-0.5">Day 1 - 9:00 AM</div>
                                    </div>
                                </div>
                                <div class="flex flex-col items-center gap-1">
                                    <svg class="w-6 h-6 text-teal-400 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <span class="text-teal-400 text-[10px]">stream link</span>
                                </div>
                                <div class="bg-gray-200 dark:bg-white/10 rounded-xl border border-gray-300 dark:border-white/20 p-4 w-36">
                                    ...
                                    <div class="space-y-2 text-center">
                                        ...
                                        <div class="p-1.5 rounded bg-sky-400/20 text-[10px] text-sky-300">MS Teams</div>
                                        <div class="p-1.5 rounded bg-red-400/20 text-[10px] text-red-300">YouTube Live</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 border border-blue-200 dark:border-white/10 p-8">
                    ...
                    <div class="flex items-center justify-center gap-3">
                        <div class="bg-blue-500/20 rounded-xl border border-blue-400/30 p-3 w-20">
                            ...
                            <div class="space-y-1">
                                <div class="h-1.5 bg-sky-400/40 rounded text-[6px] text-white px-1">Session</div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-100 to-sky-100 dark:from-slate-900 dark:to-sky-900 border border-slate-200 dark:border-white/10 p-8">
                    ...
                    <div class="flex items-center justify-center">
                        <div class="flex -space-x-2">
                            ...
                            <div class="w-8 h-8 rounded-full bg-white/20 border-2 border-gray-200 dark:border-[#0a0a0f] flex items-center justify-center text-white text-xs">+520</div>
                        </div>
                    </div>
                    <div class="text-center mt-3 text-slate-400 dark:text-slate-400 text-xs">523 attendees following your conference</div>
                </div>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-24 overflow-hidden border-t border-sky-200 dark:border-sky-900/20">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('sign_up') }}" class="group inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-sky-600 to-blue-600 rounded-2xl hover:scale-105 transition-transform duration-150 will-change-transform shadow-xl shadow-sky-500/20">
                Get Started Free
                <svg class="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
