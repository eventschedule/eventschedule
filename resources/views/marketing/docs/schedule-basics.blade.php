    ...
    <section class="relative bg-[#0a0a0f] py-16 overflow-hidden border-b border-white/5">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-white">Schedule Basics</h1>
            </div>
                ...
                <div class="flex-1 min-w-0">
                    <div class="prose-dark">
                        ...
                        <section id="introduction" class="doc-section">
                            ...
                            <p class="text-gray-300 mb-6">This page covers the essential setup: schedule type, basic information, location, contact details, and core settings. For visual customization (colors, fonts, backgrounds), see <a href="{{ route('marketing.docs.schedule_styling') }}" class="text-cyan-400 hover:text-cyan-300">Schedule Styling</a>.</p>
                        </section>
                        ...
                        <section id="basic-information" class="doc-section">
                            ...
                            <p class="text-gray-300 mb-6">Configure your schedule's core identity in <strong class="text-white">Admin Panel &rarr; Profile &rarr; Edit</strong>.</p>
                        ...
                        <section id="contact" class="doc-section">
                            ...
                            <p class="text-gray-300 mb-6">Add contact details in <strong class="text-white">Admin Panel &rarr; Profile &rarr; Edit</strong> so visitors can reach you. These appear on your public schedule page.</p>
                        ...
                        <section id="settings" class="doc-section">
                            ...
                            <p class="text-gray-300 mb-6">Configure how your schedule works in <strong class="text-white">Admin Panel &rarr; Profile &rarr; Edit</strong>.</p>
