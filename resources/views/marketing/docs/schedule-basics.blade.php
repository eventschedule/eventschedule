<x-marketing-layout>
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "@type": "TechArticle",
        "headline": "Schedule Basics - Event Schedule",
        "description": "Learn the basics of setting up your schedule in Event Schedule. Configure name, location, contact info, and schedule settings.",
        "author": {
            "@type": "Organization",
            "name": "Event Schedule"
        },
