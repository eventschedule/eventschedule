    ...
    <section id="features" class="doc-section">
        ...
        <div class="doc-fields">
            ...
            <div class="doc-field">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm">Turn on <strong class="text-gray-900 dark:text-white">Offer a second language to visitors</strong> in the schedule's <strong class="text-gray-900 dark:text-white">Details</strong> section and pick a <strong class="text-gray-900 dark:text-white">Translate into</strong> language. An hourly scheduled task then fills the translated copy of the schedule name, short description, description, address, request terms, banner message and sponsor section title, and of every event and event part, so guests get a button to switch between the language you typed and the translation. Sub-schedule names and custom field names and options are translated as you save instead of waiting for the task. It is one target language per schedule, not a set of languages, and it needs the cron entry to be running.</p>
            </div>
