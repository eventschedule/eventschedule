<x-marketing-layout>
    ...
    <x-slot name="keywords">selfhost event schedule, installation guide, saas setup, stripe integration, google calendar sync</x-slot>
    ...
    <section class="relative bg-[#0a0a0f] py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav aria-label="Breadcrumb" class="flex items-center gap-2 text-sm mb-6">
                ...
                <span class="text-white">Selfhost</span>
            </nav>
            ...
            <div class="text-center">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 mb-8">
                    ...
                    <span class="text-sm text-gray-300">Selfhost Documentation</span>
                </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <a href="{{ route('marketing.docs.selfhost.installation') }}" class="doc-card block">
                    <div class="relative overflow-hidden rounded-2xl border border-white/10 p-6 h-full bg-gradient-to-br from-cyan-900/50 to-teal-900/50">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2">Installation Guide</h3>
                        <p class="text-gray-400 text-sm mb-4">Set up Event Schedule on your own server with this step-by-step guide.</p>
                        <div class="inline-flex items-center text-sm font-medium text-cyan-400">
                            Read Guide
                ...
                <a href="{{ route('marketing.docs.selfhost.saas') }}" class="doc-card block">
                    <div class="relative overflow-hidden rounded-2xl border border-white/10 p-6 h-full bg-gradient-to-br from-blue-900/50 to-cyan-900/50">
                        <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl mb-4 bg-blue-500/20">
                            <svg class="w-6 h-6 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
                            </svg>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2">SaaS Setup</h3>
                        <p class="text-gray-400 text-sm mb-4">Configure Event Schedule for SaaS deployment with subdomain-based multi-tenant routing.</p>
                        <div class="inline-flex items-center text-sm font-medium text-blue-400">
                            Read Guide
                            <svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                ...
                <a href="{{ route('marketing.docs.selfhost.stripe') }}" class="doc-card block">
                    <div class="relative overflow-hidden rounded-2xl border border-white/10 p-6 h-full bg-gradient-to-br from-indigo-900/50 to-blue-900/50">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2">Stripe Integration</h3>
                        <p class="text-gray-400 text-sm mb-4">Set up Stripe Connect for ticket sales and Laravel Cashier for subscription billing.</p>
                        <div class="inline-flex items-center text-sm font-medium text-indigo-400">
                            Read Guide
                            <svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                ...
                <a href="{{ route('marketing.docs.selfhost.google_calendar') }}" class="doc-card block">
                    <div class="relative overflow-hidden rounded-2xl border border-white/10 p-6 h-full bg-gradient-to-br from-violet-900/50 to-indigo-900/50">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2">Google Calendar</h3>
                        <p class="text-gray-400 text-sm mb-4">Enable bidirectional sync between Event Schedule and Google Calendar.</p>
                        <div class="inline-flex items-center text-sm font-medium text-violet-400">
                            Read Guide
                            <svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
