<x-docs-page
    ...
    title="Federation on a Selfhost Install - Event Schedule"
    description="Share public events from your selfhosted install with the eventschedule.com listings. Off by default, opted into per schedule, linked back to your site."
