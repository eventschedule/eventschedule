    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-16 overflow-hidden noise border-b border-gray-200 dark:border-white/5">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="es-fade-up es-d-1 flex items-center gap-4 mb-4">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">Installation <span class="text-gradient-docs">Guide</span></h1>
            </div>
            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <aside class="lg:w-64 flex-shrink-0">
                    <nav class="lg:sticky lg:top-8 space-y-1">
                        ...
                        <a href="#push-notifications" class="doc-nav-link block px-3 py-2 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">Push notifications</a>
