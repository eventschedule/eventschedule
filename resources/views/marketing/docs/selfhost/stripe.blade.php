...
<span class="code-variable">STRIPE_PRICE_YEARLY</span>=<span class="code-string">price_yearly_price_id</span></code></pre>
        ...
        <ul class="doc-list mb-6">
            ...
            <li><code class="doc-inline-code">STRIPE_PRICE_MONTHLY_AMOUNT</code>, <code class="doc-inline-code">STRIPE_PRICE_YEARLY_AMOUNT</code>, <code class="doc-inline-code">STRIPE_ENTERPRISE_PRICE_MONTHLY_AMOUNT</code> and <code class="doc-inline-code">STRIPE_ENTERPRISE_PRICE_YEARLY_AMOUNT</code>: the amounts <em>displayed</em> in the app. They are labels only, so set them to match your Stripe prices or your pages will show the defaults of 9, 90, 29 and 290. A super-admin can override all four at <code class="doc-inline-code">/admin/settings</code> without touching <code class="doc-inline-code">.env</code>; keep these set anyway, because revenue reporting and renewal emails read the values here rather than the admin panel.</li>
