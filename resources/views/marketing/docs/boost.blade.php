...
>
    ...
    <section id="tips" class="doc-section">
        ...
        <ul class="doc-list mb-6">
            ...
            <li><strong>Boosting before tickets are on sale</strong> - an event with no tickets set up can still be boosted, and its ad carries a Learn More button. Clicks land on the event page. If you have switched on the <a href="{{ route('marketing.docs.creating_schedules') }}#settings-advanced" class="doc-link">&ldquo;Notify me&rdquo; card</a>, visitors can pick <strong class="text-gray-900 dark:text-white">Tell me when tickets go on sale</strong> from the Add to Calendar menu and leave an email address. They join the event's <a href="{{ route('marketing.docs.tickets') }}#interest-list" class="doc-link">interest list</a> and are emailed when tickets go on sale.</li>
