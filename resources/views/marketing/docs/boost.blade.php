<x-docs-page
    ...
    lede="Promote your events with automated Facebook and Instagram ad campaigns. Set a budget, pick your audience, and launch in minutes."
>
    <x-slot:toc>
    ...
    <section id="overview" class="doc-section">
        ...
        <div class="doc-callout doc-callout-info">
            ...
            <p>Boost requires a <a href="{{ marketing_url('/pricing') }}" class="doc-link">Pro plan</a> or higher. You also need a verified phone number on your account. Add and verify your phone in <a href="{{ route('marketing.docs.account_settings') }}#profile" class="doc-link">Account Settings</a>.</p>
        </div>
        <p class="text-gray-600 dark:text-gray-300 mb-4">
