    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-16 overflow-hidden border-b border-gray-200 dark:border-white/5 noise">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <h1 class="es-fade-up es-balance text-3xl md:text-4xl font-black tracking-tight text-gray-900 dark:text-white"><span class="text-gradient-docs">Selling Tickets</span></h1>
            </div>
