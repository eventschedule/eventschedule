<x-marketing-layout>
    <x-slot name="title">Federation for SaaS - Event Schedule</x-slot>
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "@type": "TechArticle",
        "headline": "Federation for SaaS - Event Schedule",
    ...
    <section class="es-hero relative bg-white dark:bg-[#0a0a0f] py-16 overflow-hidden border-b border-gray-200 dark:border-white/5 noise">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <x-docs-breadcrumb currentTitle="Federation" section="saas" sectionTitle="SaaS" sectionRoute="marketing.docs.saas.setup" />
