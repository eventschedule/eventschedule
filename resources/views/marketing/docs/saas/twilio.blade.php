...
TWILIO_FROM_NUMBER=+1234567890</code></pre>
    ...
    <section id="phone-verification" class="doc-section">
        ...
        <ul class="doc-list mb-6">
            ...
            <li><strong class="text-gray-900 dark:text-white">Publishing and network listings.</strong> A schedule's public pages are not published at all until its email address or its phone number is verified (visitors get a page-not-found, so search engines have nothing to index), and if you run <a href="{{ route('marketing.docs.saas.federation') }}" class="doc-link">federation</a> its events are only shared from then on.</li>
