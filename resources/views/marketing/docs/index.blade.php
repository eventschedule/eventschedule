        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-sm">Learn how to use Event Schedule</p>
                </div>
            </div>

            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                <a href="{{ route('marketing.docs.getting_started') }}" class="doc-card block">
                    <div class="rounded-xl border border-white/10 p-5 h-full bg-gradient-to-br from-cyan-900/30 to-teal-900/30 hover:border-cyan-500/30 transition-colors">
                        ...
                        <p class="text-gray-400 text-sm">Create your account and set up your first schedule.</p>
                    </div>
                </a>
                ...
                <a href="{{ route('marketing.docs.creating_events') }}" class="doc-card block">
                    <div class="rounded-xl border border-white/10 p-5 h-full bg-gradient-to-br from-blue-900/30 to-indigo-900/30 hover:border-blue-500/30 transition-colors">
                        <div class="flex items-center gap-3 mb-3">
                            <svg class="w-5 h-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                            </svg>
                            <h3 class="font-semibold text-white">Creating Events</h3>
                        </div>
                        <p class="text-gray-400 text-sm">Add events manually or import using AI.</p>
                    </div>
                </a>

                <a href="{{ route('marketing.docs.sharing') }}" class="doc-card block">
                    <div class="rounded-xl border border-white/10 p-5 h-full bg-gradient-to-br from-indigo-900/30 to-violet-900/30 hover:border-indigo-500/30 transition-colors">
                        <div class="flex items-center gap-3 mb-3">
                            <svg class="w-5 h-5 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
                            </svg>
                            <h3 class="font-semibold text-white">Sharing</h3>
                        </div>
                        <p class="text-gray-400 text-sm">Embed, share on social, and grow followers.</p>
                    </div>
                </a>

                <a href="{{ route('marketing.docs.tickets') }}" class="doc-card block">
                    <div class="rounded-xl border border-white/10 p-5 h-full bg-gradient-to-br from-violet-900/30 to-purple-900/30 hover:border-violet-500/30 transition-colors">
                        <div class="flex items-center gap-3 mb-3">
                            <svg class="w-5 h-5 text-violet-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                            </svg>
                            <h3 class="font-semibold text-white">Selling Tickets</h3>
                        </div>
                        <p class="text-gray-400 text-sm">Set up ticketing and manage sales.</p>
                    </div>
                </a>

                <a href="{{ route('marketing.docs.event_graphics') }}" class="doc-card block">
                    <div class="rounded-xl border border-white/10 p-5 h-full bg-gradient-to-br from-purple-900/30 to-pink-900/30 hover:border-purple-500/30 transition-colors">
                        <div class="flex items-center gap-3 mb-3">
                            <svg class="w-5 h-5 text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            <h3 class="font-semibold text-white">Event Graphics</h3>
                        </div>
                        <p class="text-gray-400 text-sm">Generate shareable images for social media.</p>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <a href="{{ route('marketing.docs.selfhost') }}" class="section-card block group">
                    <div class="relative overflow-hidden rounded-2xl border border-white/10 p-8 h-full bg-gradient-to-br from-violet-900/50 via-purple-900/50 to-indigo-900/50 group-hover:border-violet-500/30 transition-colors">
                        <!-- Glow effect -->
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-gray-400 mb-6">Deploy Event Schedule on your own server. Complete control, full customization.</p>
                ...
                <a href="{{ route('marketing.docs.developer.api') }}" class="section-card block group">
                    <div class="relative overflow-hidden rounded-2xl border border-white/10 p-8 h-full bg-gradient-to-br from-emerald-900/50 via-teal-900/50 to-cyan-900/50 group-hover:border-emerald-500/30 transition-colors">
                        <!-- Glow effect -->
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-gray-400 mb-6">Complete REST API documentation with authentication, endpoints, request/response examples, and error handling.</p>
