<x-docs-page
    ...
    lede="View and manage your events, assign videos, set availability, handle requests, and manage your team from the admin panel."
>
    <x-slot:toc>
    ...
    <section id="schedule" class="doc-section">
        ...
        <ul class="doc-list mb-6">
            <li><strong class="text-gray-900 dark:text-white">Import Events</strong> - Open the <a href="{{ route('marketing.docs.ai_import') }}" class="doc-link">AI Import</a> page to bulk-import events from text or images</li>
            ...
            <li><strong class="text-gray-900 dark:text-white">Events Graphic</strong> - Generate a <a href="{{ route('marketing.docs.event_graphics') }}" class="doc-link">promotional graphic</a> for your events</li>
    ...
    <section id="templates" class="doc-section">
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-4">
            Save any event as a reusable <strong class="text-gray-900 dark:text-white">template</strong>, then create new events from it in seconds. This is ideal for recurring events that fall on different dates each month. Event templates are a <strong class="text-gray-900 dark:text-white">Pro</strong> feature.
        </p>
        <ul class="doc-list mb-6">
            <li>Open an event and choose <strong>"Save as Template"</strong> from the Actions dropdown to capture its details, tickets, agenda, and participants</li>
            <li>The event date is intentionally left blank so you set it fresh each time; recurring day-of-week patterns are preserved</li>
            <li>Manage templates on the <strong>Templates</strong> tab - rename, delete, or click <strong>"Add Event"</strong> to create a new event from one</li>
            <li>On the Schedule tab, use <strong>"Use a Template"</strong> next to the Add Event button to start a new event from a saved template</li>
        </ul>
        <p class="text-gray-600 dark:text-gray-300 mb-4">
            For details on editing the prefilled event, see <x-link href="{{ route('marketing.docs.creating_events') }}">Creating Events</x-link>.
        </p>
    </section>
    ...
    <section id="team" class="doc-section">
        ...
        <h3 class="doc-subheading">Member Roles</h3>
    ...
    <section id="plan" class="doc-section">
        ...
        <ul class="doc-list mb-6">
            ...
            <li>Track <strong>newsletter email usage</strong> with a progress bar showing how many newsletter emails you've sent this month relative to your plan limit (each recipient counts as one email)</li>
