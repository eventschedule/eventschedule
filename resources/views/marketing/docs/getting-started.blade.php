<x-docs-page
    ...
    lede="Go from zero to a live event calendar in under 5 minutes. No credit card required - it's free forever."
>
    <x-slot:toc>
    ...
    <section id="create-account" class="doc-section">
        ...
        <ol class="doc-list doc-list-numbered mb-6">
            <li>Visit <a href="{{ app_url('/sign_up') }}" class="doc-link">the registration page</a></li>
    ...
    <section id="customize" class="doc-section">
        ...
        <div class="doc-fields">
            ...
            <div class="doc-field">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Choose your timezone, date format, and language preferences. See <a href="{{ route('marketing.docs.creating_schedules') }}#settings" class="doc-link">Creating Schedules</a> for all available settings.</p>
            </div>
            <div class="doc-field">
                <h4 class="font-semibold text-gray-900 dark:text-white mb-2">Sub-schedules</h4>
                <p class="text-sm text-gray-500 dark:text-gray-400">Create <a href="{{ route('marketing.docs.creating_schedules') }}#customize-subschedules" class="doc-link">sub-schedules</a> to organize your events (e.g., "Live Music", "DJ Nights", "Comedy").</p>
            </div>
        </div>
    ...
    <section id="faq" class="doc-section">
        ...
        <div class="doc-fields">
            ...
            <div class="doc-field">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Go to <strong class="text-gray-900 dark:text-white">Admin Panel &rarr; Profile &rarr; Edit</strong> and update the URL/subdomain field. See <a href="{{ route('marketing.docs.creating_schedules') }}#settings" class="doc-link">Schedule Settings</a> for details. Note that changing your URL may break existing links.</p>
            </div>
            <div class="doc-field">
            ...
            <div class="doc-field">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Yes! Event Schedule supports <a href="{{ route('marketing.docs.creating_schedules') }}#integrations" class="doc-link">Google Calendar and CalDAV sync</a>. Connect your calendar in <strong class="text-gray-900 dark:text-white">Admin Panel &rarr; Profile &rarr; Edit</strong> under Calendar Sync. You can also <a href="{{ route('marketing.docs.ai_import') }}" class="doc-link">import events using AI</a> from text or images.</p>
            </div>
            <div class="doc-field">
    ...
    <section id="next-steps" class="doc-section">
        ...
        <ul class="doc-list">
            <li><a href="{{ route('marketing.docs.creating_schedules') }}" class="doc-link">Configure your schedule</a> - Set up details, settings, sub-schedules, and integrations</li>
            <li><a href="{{ route('marketing.docs.schedule_styling') }}" class="doc-link">Style your schedule</a> - Customize colors, fonts, and backgrounds</li>
            <li><a href="{{ route('marketing.docs.creating_events') }}" class="doc-link">Add your first events</a> - Learn how to create and import events</li>
            <li><a href="{{ route('marketing.docs.sharing') }}" class="doc-link">Share your schedule</a> - Embed on your website and share on social media</li>
            <li><a href="{{ route('marketing.docs.tickets') }}" class="doc-link">Set up ticketing</a> - Start selling tickets for your events</li>
            <li><a href="{{ route('marketing.docs.account_settings') }}" class="doc-link">Account settings</a> - Manage your profile, payments, and API access</li>
        </ul>
    </section>
