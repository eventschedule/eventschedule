    ...
    <section class="relative bg-[#0a0a0f] py-16 overflow-hidden border-b border-white/5">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-white">Schedule Styling</h1>
            </div>
            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <aside class="lg:w-64 flex-shrink-0">
                    <nav class="lg:sticky lg:top-8 space-y-1">
                        ...
                        <a href="#event-layout" class="doc-nav-link block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors">Event Layout</a>
                        <a href="#profile-image" class="doc-nav-link block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors">Profile Image</a>
                        <a href="#header-images" class="doc-nav-link block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors">Header Images</a>
                        <a href="#backgrounds" class="doc-nav-link block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors">Background Options</a>
                        <a href="#color-scheme" class="doc-nav-link block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors">Color Scheme</a>
                        <a href="#typography" class="doc-nav-link block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors">Typography</a>
                        <a href="#custom-css" class="doc-nav-link block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors">Custom CSS</a>
                        <a href="#live-preview" class="doc-nav-link block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors">Live Preview</a>
                ...
                <div class="flex-1 min-w-0">
                    <div class="prose-dark">
                        ...
                        <section id="overview" class="doc-section">
                            ...
                            <p class="text-gray-300 mb-6">Make your schedule uniquely yours with extensive styling options. Access styling settings in <strong class="text-white">Admin Panel &rarr; Profile &rarr; Edit</strong>, then scroll to the styling section.</p>

                            <p class="text-gray-300 mb-6">All styling changes update in real-time, so you can experiment freely and see exactly how your schedule will look before saving.</p>
                        ...
                        <section id="event-layout" class="doc-section">
                            ...
                            <p class="text-gray-300 mb-4">Choose how your events are displayed on your schedule page:</p>
                        ...
                        <section id="profile-image" class="doc-section">
                            ...
                            <p class="text-gray-300 mb-4">Upload a profile image (logo, photo, or avatar) that represents your schedule. This appears at the top of your schedule page and in social media previews.</p>
                            <div class="doc-callout doc-callout-tip">
                        ...
                        <section id="header-images" class="doc-section">
                            ...
                            <div class="space-y-3 mb-6">
                                <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                                    ...
                                    <p class="text-sm text-gray-400">Choose from 31 professionally designed headers including: 5am_Club, Arena, Fitness_Morning, Concert, Festival, Jazz_Club, Neon_Lights, Skyline, Stadium, and many more. Perfect for getting started quickly.</p>
                                </div>
                                <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                        ...
                        <section id="backgrounds" class="doc-section">
                            ...
                            <h3 class="text-lg font-medium text-white mb-3 mt-6">Solid Color</h3>
                            ...
                            <h3 class="text-lg font-medium text-white mb-3 mt-6">Gradient Backgrounds</h3>
                            ...
                            <h3 class="text-lg font-medium text-white mb-3 mt-6">Background Images</h3>
