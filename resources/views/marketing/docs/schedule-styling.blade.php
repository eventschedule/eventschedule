...
>
    ...
    <section id="overview" class="doc-section">
        ...
        <div class="doc-callout doc-callout-info">
            ...
            <p>If you haven't created your account and first schedule yet, start with <a href="{{ route('marketing.docs.getting_started') }}" class="doc-link">Getting Started</a>.</p>
        </div>

        <div class="doc-callout doc-callout-tip">
            <div class="doc-callout-title">Getting Started</div>
            <p>If you haven't set up your schedule's basic information yet, see <a href="{{ route('marketing.docs.creating_schedules') }}" class="doc-link">Creating Schedules</a> first.</p>
        </div>
    </section>
    ...
    <section id="custom-css" class="doc-section">
        ...
        <div class="doc-callout doc-callout-info">
            ...
            <p>Custom CSS is available on Pro plans and for <a href="{{ route('marketing.docs.selfhost') }}" class="doc-link">selfhosted</a> installations.</p>
        </div>
