...
>
    ...
    <section id="admissions-per-event" class="doc-section">
        ...
        <ul class="doc-list mb-6">
            ...
            <li>The <a href="{{ route('marketing.docs.tickets') }}#checkin-dashboard" class="doc-link">check-in dashboard</a> shows a headcount that includes guests alongside the pass count.</li>
        </ul>
        <div class="doc-callout doc-callout-tip mb-6">
    ...
    <section id="monitoring" class="doc-section">
        ...
        <p class="text-gray-600 dark:text-gray-300">The real-time <a href="{{ route('marketing.docs.tickets') }}#checkin-dashboard" class="doc-link">Check-in dashboard</a> also counts pass scans alongside regular tickets.</p>
    </section>
