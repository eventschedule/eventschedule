<x-marketing-layout>
    ...
    <section class="es-hero relative bg-white dark:bg-[#0a0a0f] py-16 overflow-hidden border-b border-gray-200 dark:border-white/5 noise">
        <div class="pointer-events-none absolute inset-0" aria-hidden="true">
            <div class="es-aurora es-aurora-1" style="background: radial-gradient(circle at 22% 58%, rgba(37, 99, 235, 0.22), rgba(37, 99, 235, 0) 65%);"></div>
            <div class="es-aurora es-aurora-2" style="background: radial-gradient(circle at 80% 32%, rgba(14, 165, 233, 0.18), rgba(14, 165, 233, 0) 65%);"></div>
        </div>
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="es-fade-up es-d-1 flex items-center gap-4 mb-4">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white"><span class="text-gradient-blue">Account Settings</span></h1>
            </div>
            ...
            <div class="flex flex-col lg:flex-row gap-10">
                ...
                <aside class="lg:w-64 flex-shrink-0">
                    <nav class="lg:sticky lg:top-8 space-y-1">
                        ...
                        <a href="#microsoft" class="doc-nav-link block px-3 py-2 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-colors">Outlook Settings</a>
