<x-marketing-layout>
    ...
    <section class="es-hero relative bg-white dark:bg-[#0a0a0f] py-16 overflow-hidden border-b border-gray-200 dark:border-white/5 noise">
        <div class="pointer-events-none absolute inset-0" aria-hidden="true">
            <div class="es-aurora es-aurora-1" style="background: radial-gradient(circle at 22% 58%, rgba(14, 165, 233, 0.22), rgba(14, 165, 233, 0) 65%);"></div>
            <div class="es-aurora es-aurora-2" style="background: radial-gradient(circle at 80% 32%, rgba(34, 211, 238, 0.16), rgba(34, 211, 238, 0) 65%);"></div>
        </div>
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="es-fade-up es-d-1 flex items-center gap-4 mb-4">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white"><span class="text-gradient-blue">Newsletters</span></h1>
            </div>
