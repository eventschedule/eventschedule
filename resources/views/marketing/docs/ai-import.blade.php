<x-docs-page
    ...
    lede="Save hours of manual data entry. Paste text or upload images and let AI extract event details automatically."
>
    <x-slot:toc>
    ...
    <section id="ai-import" class="doc-section">
        ...
        <div class="doc-callout doc-callout-info mt-4">
            <div class="doc-callout-title">Daily Limits</div>
            <p>AI event parsing is available on all plans with daily limits: <strong>10 per day</strong> on Free, <strong>50 per day</strong> on Pro, and <strong>100 per day</strong> on Enterprise.</p>
        </div>
    </section>
    ...
    <div class="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-500/30 rounded-lg p-4 mb-6">
        <p class="text-gray-600 dark:text-gray-300 text-sm">
            ...
            AI can also generate professional event flyers from your event details. See <a href="{{ route('marketing.docs.creating_events') }}#ai-flyer" class="doc-link">Creating Events</a> for details.
        </p>
    </div>
    ...
    <section id="see-also" class="doc-section">
        ...
        <ul class="doc-list">
            <li><a href="{{ route('marketing.docs.creating_events') }}" class="doc-link">Creating Events</a> - Add events and configure event settings</li>
            <li><a href="{{ route('marketing.docs.scan_agenda') }}" class="doc-link">Scan Agenda</a> - Use AI to scan a printed agenda and create event parts</li>
        </ul>
    </section>
