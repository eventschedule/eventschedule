...
>
    ...
    <section id="web-analytics" class="doc-section">
        ...
        <div class="doc-fields">
            ...
            <div id="web-social-clicks" class="doc-field">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Tracks clicks on the social links configured in your <a href="{{ route('marketing.docs.creating_schedules') }}#videos-links" class="doc-link">schedule settings</a>, broken down by platform (Instagram, Facebook, TikTok, etc.). Helpful for seeing which channels are actually driving engagement.</p>
            </div>
        </div>
    </section>
    ...
    <section id="checkins" class="doc-section">
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-6">
            The Check-ins tab provides attendance analytics for events where you use the <a href="{{ route('marketing.docs.tickets') }}#check-in" class="doc-link">check-in feature</a>. Track how many ticket holders actually attend your events.
        </p>
    ...
    <section id="no-data" class="doc-section">
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-4">
            Try adjusting the date range or <a href="{{ route('marketing.docs.sharing') }}" class="doc-link">sharing your schedule link</a> to start collecting analytics data.
        </p>
    </section>
