<x-marketing-layout>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-16 overflow-hidden border-b border-gray-200 dark:border-white/5 noise">
        <div class="pointer-events-none absolute inset-0" aria-hidden="true">
            <div class="es-aurora es-aurora-1" style="background: radial-gradient(circle at 20% 45%, rgba(37, 99, 235, 0.22), rgba(37, 99, 235, 0) 65%);"></div>
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <h1 class="es-fade-up es-balance text-3xl md:text-4xl font-black tracking-tight text-gray-900 dark:text-white"><span class="text-gradient-docs">Creating Events</span></h1>
            </div>
                    ...
                    <div class="prose-dark">
                        ...
                        <section id="whatsapp" class="doc-section">
                            <h2 class="doc-heading">
                                ...
                                Creating Events via WhatsApp <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400 ml-2">Enterprise</span>
                            </h2>
                        ...
                        <section id="custom-fields" class="doc-section">
                            <h2 class="doc-heading">
                                ...
                                Custom Fields <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400 ml-2">Pro</span></h2>
                        ...
                        <section id="sponsors" class="doc-section">
                            <h2 class="doc-heading">
                                ...
                                Sponsors <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400 ml-2">Pro</span></h2>
                        ...
                        <section id="polls" class="doc-section">
                            <h2 class="doc-heading">
                                ...
                                Polls <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400 ml-2">Pro</span></h2>
                            <p class="text-gray-600 dark:text-gray-300 mb-4">
                        ...
                        <section id="feedback" class="doc-section">
                            <h2 class="doc-heading">
                                ...
                                Feedback <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400 ml-2">Pro</span></h2>
                            <p class="text-gray-600 dark:text-gray-300 mb-4">
