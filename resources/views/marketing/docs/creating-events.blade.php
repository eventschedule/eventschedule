<x-docs-page
    ...
    lede="Add events to your schedule and configure event settings like venue, participants, tickets, and more."
>
    <x-slot:toc>
    ...
    <section id="manual" class="doc-section">
        ...
        <div class="doc-callout doc-callout-info">
            ...
            <p>If you have <a href="{{ route('marketing.docs.creating_schedules') }}#engagement-requests" class="doc-link">Require Approval</a> enabled, submitted events appear in a pending queue. Review them in <strong class="text-gray-900 dark:text-white">Admin Panel &rarr; Schedule &rarr; Pending</strong> and approve or reject each one.</p>
        </div>
    ...
    <section id="details" class="doc-section">
            ...
            <table class="doc-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Organize events by type (e.g., "Live Music", "Comedy"). See <a href="{{ route('marketing.docs.creating_schedules') }}#customize-subschedules" class="doc-link">Sub-schedules</a></td>
                    </tr>
                    <tr>
        ...
        <div class="doc-callout doc-callout-tip">
            ...
            <p>You can set the visibility that all new events start with from <strong>Schedule Settings &rarr; Advanced</strong>. See <a href="{{ route('marketing.docs.creating_schedules') }}#settings-advanced" class="doc-link">Advanced Settings</a>.</p>
        </div>
    </section>
    ...
    <section id="recurring" class="doc-section">
        ...
        <div class="doc-callout doc-callout-tip">
            ...
            <p>If you have <a href="{{ route('marketing.docs.creating_schedules') }}#integrations" class="doc-link">Google Calendar sync</a> enabled, recurring events are synced as individual occurrences so each date appears separately in both calendars.</p>
        </div>
    </section>
    ...
    <section id="agenda" class="doc-section">
        ...
        <h3 class="doc-subheading">AI Import</h3>
        ...
        <div class="doc-callout doc-callout-info">
            ...
            <p>AI agenda import requires a <a href="{{ route('marketing.docs.ai_import') }}" class="doc-link">Gemini API key</a> to be configured.</p>
        </div>
    </section>
    ...
    <section id="google-calendar" class="doc-section">
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-4">To use this tab, you must first set up calendar sync in your schedule settings. See <a href="{{ route('marketing.docs.creating_schedules') }}#integrations" class="doc-link">Calendar Integrations</a> for setup instructions.</p>
    ...
    <section id="whatsapp" class="doc-section">
        ...
        <div class="doc-callout doc-callout-info">
            ...
            <p>WhatsApp event creation requires Twilio to be configured. See the <a href="{{ route('marketing.docs.saas.twilio') }}" class="doc-link">Twilio setup guide</a> for configuration details.</p>
        </div>
    </section>
    ...
    <section id="custom-fields" class="doc-section">
        ...
        <div class="doc-fields">
            <div class="doc-field">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Track performer names, room numbers, age restrictions, dress codes, or any event-specific data. Custom field values are available as variables in <a href="{{ route('marketing.docs.event_graphics') }}#variables" class="doc-link">event graphics text templates</a>.</p>
            </div>
            <div class="doc-field">
    ...
    <section id="privacy" class="doc-section">
        ...
        <h3 class="doc-subheading">Internal</h3>
    ...
    <section id="fan-content" class="doc-section">
        ...
        <h3 class="doc-subheading">Enabling Fan Content</h3>
        <ol class="doc-list doc-list-numbered mb-6">
        ...
        <h3 class="doc-subheading">Content Types</h3>
        <p class="text-gray-600 dark:text-gray-300 mb-4">
        ...
        <h3 class="doc-subheading">Per-Event Overrides</h3>
        <p class="text-gray-600 dark:text-gray-300 mb-4">
    ...
    <section id="feedback" class="doc-section">
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-4">
            For more details on viewing and managing feedback, see <a href="{{ route('marketing.docs.tickets') }}#feedback" class="doc-link">Selling Tickets &rarr; Post-Event Feedback</a>.
        </p>
    </section>
    ...
    <section id="see-also" class="doc-section">
        ...
        <ul class="doc-list">
            ...
            <li><a href="{{ route('marketing.docs.tickets') }}" class="doc-link">Selling Tickets</a> - Add tickets to your events</li>
            <li><a href="{{ route('marketing.docs.event_graphics') }}" class="doc-link">Event Graphics</a> - Create promotional images</li>
            <li><a href="{{ route('marketing.docs.sharing') }}" class="doc-link">Sharing Your Schedule</a> - Share and embed your events</li>
            <li><a href="{{ route('marketing.docs.creating_schedules') }}#integrations" class="doc-link">Calendar Integrations</a> - Set up Google Calendar and CalDAV sync</li>
        </ul>
    </section>
