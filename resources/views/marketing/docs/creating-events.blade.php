...
>
    ...
    <section id="tickets" class="doc-section">
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-6">
            In <strong class="text-gray-900 dark:text-white">External</strong> mode you get a <strong class="text-gray-900 dark:text-white">Registration URL</strong> (the link guests are sent to), a <strong class="text-gray-900 dark:text-white">Price</strong> with a currency selector (used in <a href="{{ route('marketing.docs.event_graphics') }}#text-template" class="doc-link">event graphics text templates</a>), and an optional <strong class="text-gray-900 dark:text-white">Coupon Code</strong>. These fields are hidden once registration or ticketing is switched on.
        </p>
        <p class="text-gray-600 dark:text-gray-300 mb-6">
