        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <a href="{{ marketing_url('/features/custom-fields') }}" class="feature-card group block bg-white dark:bg-white/5 rounded-2xl p-6 border border-gray-200 dark:border-white/10 shadow-sm hover:shadow-lg hover:border-amber-200 dark:hover:border-amber-500/30 transition-all" aria-label="Learn more about custom fields">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm">Collect additional info from ticket buyers with text, dropdown, date, and yes/no fields.</p>
                ...
                <!-- Online Events -->
                <a href="{{ marketing_url('/features/online-events') }}" class="feature-card group block bg-white dark:bg-white/5 rounded-2xl p-6 border border-gray-200 dark:border-white/10 shadow-sm hover:shadow-lg hover:border-blue-200 dark:hover:border-blue-500/30 transition-all" aria-label="Learn more about online events">
                    <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-500/20 mb-4">
                        <svg class="w-6 h-6 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm">Host virtual events with any streaming platform. Easy toggle between in-person and online, with the link on every ticket.</p>
                    <span class="inline-flex items-center mt-3 text-sm font-medium text-blue-600 group-hover:gap-2 gap-1 transition-all">
                        Learn more
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
                    </span>
                ...
                <a href="{{ marketing_url('/features/sub-schedules') }}" class="feature-card group block bg-white dark:bg-white/5 rounded-2xl p-6 border border-gray-200 dark:border-white/10 shadow-sm hover:shadow-lg hover:border-rose-200 dark:hover:border-rose-500/30 transition-all" aria-label="Learn more about sub-schedules">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm">Organize events into categories. Perfect for venues with multiple rooms or event series.</p>
                ...
                <!-- API & Open Source -->
                <a href="{{ marketing_url('/open-source') }}" class="feature-card group block bg-white dark:bg-white/5 rounded-2xl p-6 border border-gray-200 dark:border-white/10 shadow-sm hover:shadow-lg hover:border-gray-300 dark:hover:border-gray-500/30 transition-all" aria-label="Learn more about open source and API">
