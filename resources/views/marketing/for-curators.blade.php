        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center gap-3 p-2 rounded-lg bg-rose-500/20 border border-rose-500/30">
                                    <div class="w-8 h-8 rounded-lg bg-rose-500/30 flex items-center justify-center">
                                        <svg class="w-4 h-4 text-rose-600 dark:text-rose-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5" /></svg>
                                    </div>
                                    <div class="flex-1">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-100 to-violet-100 dark:from-purple-900 dark:to-violet-900 border border-purple-200 dark:border-white/10 p-8">
                    ...
                    <div class="bg-gradient-to-br from-purple-100 to-violet-100 dark:from-purple-950 dark:to-violet-950 rounded-xl border border-purple-300 dark:border-purple-400/30 p-3">
                        <div class="text-center text-xs text-purple-600 dark:text-purple-300 mb-2">This Week in Austin</div>
                        <div class="space-y-1">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-br from-emerald-900/30 to-amber-900/30 dark:from-emerald-900 dark:to-amber-900 rounded-3xl border border-white/10 p-8 lg:p-10">
                    ...
                    <div class="flex-1">
                        <div class="flex flex-wrap justify-center lg:justify-start gap-4 mb-6">
                            ...
                            <div class="w-14 h-14 rounded-2xl bg-[#0088cc]/20 border border-[#0088cc]/30 flex items-center justify-center">
                                <svg class="w-7 h-7 text-[#0088cc]" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="w-14 h-14 rounded-2xl bg-[#E4405F]/20 border border-[#E4405F]/30 flex items-center justify-center">
                                <svg class="w-7 h-7 text-[#E4405F]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-8 text-center">
                    <a href="{{ route('sign_up') }}" class="inline-flex items-center justify-center px-6 py-3 text-base font-semibold text-white bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl hover:scale-105 transition-all shadow-lg shadow-amber-500/25">
                        Get Started Free
