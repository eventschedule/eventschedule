    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "offers": [
            ...
            },
            {
                ...
                "priceCurrency": "{{ platform_currency() }}",
                "description": "Unlimited ticket sales, live check-in dashboard, passes, gift cards, installment payments, API and webhooks. Also available at {{ plan_price($proYearly) }}/year.",
                "priceSpecification": {
