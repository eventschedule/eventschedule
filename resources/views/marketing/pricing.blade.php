<x-marketing-layout>
    ...
    @php
        ...
        $faqs = [
            ['q' => 'Is there really a free plan?', 'a' => 'Yes! The free plan includes unlimited events, all core features, appointment booking with one appointment type, and unlimited free registration with QR check-in at the door. You only need to upgrade if you want to charge for a ticket, remove branding, or access advanced features.'],
            ...
            ['q' => 'What is the difference between Pro and Enterprise?', 'a' => 'The free plan already takes unlimited free registrations, scans tickets at the door and carries one appointment type. Pro is what puts a price on a ticket, and brings the rest of the ticketing suite with it: the live check-in dashboard, passes and subscriptions, individual tickets, promo/discount codes, add-ons, gift cards, installment payments through Stripe, the ticket waitlist and sales CSV export. It also lifts the appointment type limit and adds white-label branding, event boosting with ads, custom fields, custom CSS styling, REST API & webhooks, and 100 newsletter emails per month, each recipient counting as one. Enterprise adds allocated (reserved) seating for venue schedules, custom domains, private and password-protected events, up to five team members, WhatsApp event creation, email scheduling, agenda scanning, availability management, 1,000 newsletter emails per month, and priority support.'],
