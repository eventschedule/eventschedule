    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "offers": [
            ...
            },
            {
                ...
                "priceCurrency": "USD",
                "billingIncrement": "MON",
                "description": "Everything in Pro plus custom domains, private events, AI event parsing, WhatsApp event creation, email scheduling, agenda scanning, AI flyer generation, AI style generation, AI details generation, availability management, multiple team members, 1,000 newsletter emails per month, and priority support.",
                "availability": "https://schema.org/InStock",
                "priceSpecification": [
                    {
                        "@type": "UnitPriceSpecification",
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "mainEntity": [
            ...
            },
            {
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Pro includes a full ticketing suite with check-in dashboard, Stripe payments, white-label branding, event graphics, event boosting with ads, custom fields, custom CSS styling, REST API and webhooks, and 100 newsletter emails per month. Enterprise adds custom domains, private and password-protected events, multiple team members, AI event parsing, WhatsApp event creation, email scheduling, agenda scanning, availability management, 1,000 newsletter emails per month, and priority support."
                }
            },
            {
                "@type": "Question",
                ...
                <div class="pricing-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-50 to-yellow-100 dark:from-amber-900 dark:to-yellow-900 border-2 border-amber-300 dark:border-amber-500/50 p-8 lg:p-10 flex flex-col md:grid md:grid-rows-[subgrid] md:row-span-3">
                    ...
                    <ul class="space-y-4 mb-10">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-gray-600 dark:text-gray-300">AI style generation</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <div class="w-5 h-5 rounded-full bg-amber-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                                <svg aria-hidden="true" class="w-3 h-3 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span class="text-gray-600 dark:text-gray-300">AI details generation</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <div class="w-5 h-5 rounded-full bg-amber-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                                <svg aria-hidden="true" class="w-3 h-3 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="space-y-4" x-data="{ open: null }">
                ...
                <div class="bg-white dark:bg-white/5 rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm overflow-hidden">
                    ...
                    <div x-show="open === 3" x-collapse>
                        <p class="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Pro includes a full ticketing suite with check-in dashboard, Stripe payments, promo/discount codes, sales CSV export, white-label branding, event graphics, event boosting with ads, custom fields, custom CSS styling, REST API & webhooks, and 100 newsletter emails per month. Enterprise adds custom domains, private and password-protected events, multiple team members, AI event parsing, WhatsApp event creation, email scheduling, agenda scanning, availability management, 1,000 newsletter emails per month, and priority support.
                        </p>
                    </div>
                </div>
