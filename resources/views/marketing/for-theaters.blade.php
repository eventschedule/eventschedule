                                ...
                                <div class="animate-float">
                                    <div class="playbill gilded-frame max-w-xs rounded-2xl border border-rose-300 bg-gradient-to-br from-rose-50 to-red-50 p-4 dark:border-rose-400/30 dark:from-rose-950 dark:to-red-950">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="es-ai-field flex items-center gap-3 rounded-lg border border-amber-400/40 bg-amber-500/20 p-2" style="--i: 4;"><div class="w-12 font-mono text-[10px] uppercase tracking-wide text-amber-600 dark:text-amber-300">Run</div><span class="playbill-caps text-sm font-semibold text-gray-900 dark:text-white">Season Pass</span><span class="ml-auto text-xs font-semibold text-amber-600 dark:text-amber-300">$120</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
