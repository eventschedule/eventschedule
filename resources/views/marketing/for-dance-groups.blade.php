    ...
    @php
        ...
        $faqs = [
            [
                ...
                'a' => 'The parts you use every week are free forever: weekly classes as recurring events, date exceptions for the weeks you are closed, free registration with a capacity per class, sub-schedules, two-way calendar sync, an embeddable calendar and up to 10 newsletter emails a month, counted per recipient rather than per send. Selling show tickets is free too, up to 25 paid ones a month per schedule. What Pro buys at '.plan_price($proMonthly).' a month is the ceiling coming off and the pass, which is the part a studio actually needs: a 10-visit card, a membership or a season pass. Event Schedule charges zero platform fees on any of it.',
            ],
            [
