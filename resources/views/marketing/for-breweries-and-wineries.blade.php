            ...
            <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
                <div>
                    <h1 class="es-balance mb-7 text-[2.6rem] font-black leading-[1.05] tracking-tight sm:text-6xl">
                        <x-marketing.hero-eyebrow class="block es-pour-tag es-fade-up es-d-1 mb-5">Brewery and winery event calendar, for tasting rooms too</x-marketing.hero-eyebrow>
