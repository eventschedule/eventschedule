            ...
            <div class="es-show-band noise relative overflow-hidden rounded-[2.5rem] border border-white/10 px-6 py-16 text-center shadow-2xl sm:px-12 lg:py-24" data-confetti data-reveal="panel">
                ...
                <div class="relative z-10">
                    ...
                    <p class="es-show-muted mx-auto mb-10 max-w-2xl text-lg sm:text-xl">
                        Publishing a schedule and its dates is free forever, and so are the first 25 paid tickets you sell each month and scanning them in at the door. {{ plan_price($proMonthly) }} a month lifts that ceiling and adds the live check-in dashboard, and nothing is taken from the door on any plan.
                    </p>
