            ...
            <div class="es-show-band noise relative overflow-hidden rounded-[2.5rem] border border-white/10 px-6 py-16 text-center shadow-2xl sm:px-12 lg:py-24" data-confetti data-reveal="panel">
                ...
                <div class="relative z-10">
                    ...
                    <p class="es-show-muted mx-auto mb-10 max-w-2xl text-lg sm:text-xl">
                        Publishing a schedule and its dates is free forever, and so is keeping places on them and scanning people in at the door. {{ plan_price($proMonthly) }} a month is what puts a price on a ticket, and adds the live check-in dashboard. Nothing is taken from the door on any plan.
                    </p>
