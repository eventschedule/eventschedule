<x-marketing-layout>
    ...
    <section class="relative bg-[#0a0a0f] py-24 lg:py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative max-w-4xl mx-auto">
                <div class="bg-[#12121a] rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
                    <!-- Dashboard header -->
                    <div class="bg-[#0d0d12] px-6 py-4 border-b border-white/5 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="text-white font-semibold text-sm">The Echo</div>
                                <div class="text-gray-500 text-xs">Los Angeles, CA</div>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 text-xs">
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 rounded-full bg-emerald-400"></div>
                                <span class="text-gray-400">Calendar live</span>
                            </div>
                    ...
                    <div class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 space-y-4">
                            <div class="flex items-center justify-between mb-2">
                                <h3 class="text-white font-semibold">This Week</h3>
                                <span class="text-gray-500 text-xs">Jan 27 - Feb 2</span>
                            </div>
                            ...
                            <div class="bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 rounded-xl border border-violet-500/30 p-4">
                                <div class="flex items-start justify-between mb-3">
                                    <div>
                                        ...
                                        <div class="text-white font-semibold">Luna & The Wolves</div>
                                        <div class="text-gray-400 text-sm">Indie Folk / Sold Out</div>
                                    </div>
                                ...
                                <div class="flex items-center gap-4 text-xs">
                                    <span class="text-gray-400">Load-in: 4pm</span>
                                    <span class="text-gray-400">Sound check: 5:30pm</span>
                                    <span class="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300">Sold Out</span>
                                </div>
                            </div>

                            <!-- Other shows -->
                            <div class="bg-[#16161e] rounded-xl border border-white/5 p-4">
                                <div class="flex items-start justify-between">
                                    <div>
                                        <div class="text-gray-500 text-xs mb-1">Wed, Jan 29</div>
                                        <div class="text-white font-medium">Jazz Wednesday: Marcus Cole Trio</div>
                                        <div class="text-gray-400 text-sm">Jazz / Recurring weekly</div>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-white text-sm">89 / 150</div>
                                        <div class="text-gray-500 text-xs">tickets sold</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-[#16161e] rounded-xl border border-white/5 p-4">
                                <div class="flex items-start justify-between">
                                    <div>
                                        <div class="text-gray-500 text-xs mb-1">Fri, Jan 31</div>
                                        <div class="text-white font-medium">Midnight Sons + The Bridges</div>
                                        <div class="text-gray-400 text-sm">Indie Rock / Double bill</div>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-white text-sm">156 / 247</div>
                                        <div class="text-gray-500 text-xs">tickets sold</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-[#16161e] rounded-xl border border-white/5 p-4">
                                <div class="flex items-center justify-between mb-3">
                                    <h4 class="text-white font-medium text-sm">Booking Requests</h4>
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="text-white text-xs truncate">River West</div>
                                            <div class="text-gray-500 text-[10px]">Alt Country</div>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="text-white text-xs truncate">Neon Kids</div>
                                            <div class="text-gray-500 text-[10px]">Synth Pop</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bg-[#16161e] rounded-xl border border-white/5 p-4">
                                <h4 class="text-gray-400 text-xs mb-1">January Revenue</h4>
                                <div class="text-2xl font-bold text-white">$18,420</div>
                                <div class="text-emerald-400 text-xs">+12% vs December</div>
                                <div class="mt-3 pt-3 border-t border-white/5">
                                    <div class="text-gray-500 text-xs">Platform fees paid</div>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <div class="text-white font-medium">Ticketing platforms taking 15-25% of your door</div>
                                <div class="text-gray-500 text-sm">Service fees, facility fees, processing fees...</div>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="w-6 h-6 rounded-full bg-red-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                            ...
                            <div>
                                <div class="text-white font-medium">Endless email chains with booking agents</div>
                                <div class="text-gray-500 text-sm">Back and forth for every show, every detail</div>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="w-6 h-6 rounded-full bg-red-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                            ...
                            <div>
                                <div class="text-white font-medium">Paying to reach your own fans on social</div>
                                <div class="text-gray-500 text-sm">Algorithm changes, boosted posts, declining reach</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <div class="text-white font-medium">Sell tickets with $0 platform fees</div>
                                <div class="text-gray-500 text-sm">Just Stripe's 2.9% + 30c. That's it.</div>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                            ...
                            <div>
                                <div class="text-white font-medium">Artists apply with press kits built-in</div>
                                <div class="text-gray-500 text-sm">Music samples, social links, everything in one place</div>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                            ...
                            <div>
                                <div class="text-white font-medium">Email your fans directly for free</div>
                                <div class="text-gray-500 text-sm">New show? One click reaches everyone who follows you</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="bg-[#0a0a0f] py-24">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center mb-32">
                ...
                <div class="relative">
                    <div class="bg-[#12121a] rounded-2xl border border-white/10 p-6">
                        ...
                        <div class="flex items-start gap-4 mb-4">
                            ...
                            <div class="flex-1">
                                <div class="text-white font-semibold text-lg">Midnight Sons</div>
                        ...
                        <div class="bg-black/30 rounded-xl p-3 mb-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1">
                                    <div class="text-white text-sm">Neon Heartbreak</div>
                                    <div class="text-gray-500 text-xs">3:42 / 45K streams</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <button class="flex-1 py-2.5 rounded-xl bg-white/5 text-gray-400 font-medium hover:bg-white/10 transition">
                                Pass
                            </button>
                        </div>
                    </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center mb-32">
                <div class="order-2 lg:order-1">
                    <div class="bg-[#12121a] rounded-2xl border border-white/10 overflow-hidden">
                        <div class="bg-[#0d0d12] px-4 py-3 border-b border-white/5">
                            <div class="text-white font-medium text-sm">Tonight at The Echo</div>
                        </div>
                            ...
                            <div class="bg-gradient-to-r from-violet-500/10 to-transparent rounded-xl border border-violet-500/20 p-4">
                                <div class="flex items-center justify-between mb-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-white font-medium">Main Stage</span>
                                    </div>
                                    <span class="text-gray-400 text-xs">Cap: 350</span>
                                </div>
                                <div class="ml-5 space-y-2 text-sm">
                                    <div class="flex items-center justify-between">
                                        <span class="text-gray-300">8:00pm - The Openers</span>
                                        <span class="text-gray-500">45 min</span>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-white font-medium">9:30pm - Midnight Sons</span>
                            ...
                            <div class="bg-gradient-to-r from-indigo-500/10 to-transparent rounded-xl border border-indigo-500/20 p-4">
                                <div class="flex items-center justify-between mb-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-white font-medium">Back Room</span>
                                    </div>
                                    <span class="text-gray-400 text-xs">Cap: 75</span>
                                </div>
                                <div class="ml-5 space-y-2 text-sm">
                                    <div class="flex items-center justify-between">
                                        <span class="text-gray-300">8:30pm - Jazz Trio</span>
                                        <span class="text-gray-500">2 sets</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gradient-to-r from-amber-500/10 to-transparent rounded-xl border border-amber-500/20 p-4 opacity-60">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-white font-medium">Outdoor Patio</span>
                                    </div>
                ...
                <div>
                    ...
                    <div class="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-4">
                        ...
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                <div class="text-gray-400">Ticketmaster</div>
                                <div class="text-white font-semibold">You keep: ~$25,000</div>
                            </div>
                            <div>
                                <div class="text-emerald-300">Event Schedule</div>
                                <div class="text-white font-semibold">You keep: ~$33,950</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-red-500/5 rounded-2xl border border-red-500/20 p-5">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="text-gray-400 text-sm">$35 ticket</span>
                            </div>
                            ...
                            <div class="border-t border-red-500/20 pt-3 flex justify-between">
                                <span class="text-gray-400">Fan pays</span>
                        ...
                        <div class="bg-emerald-500/5 rounded-2xl border border-emerald-500/30 p-5">
                            ...
                            <div class="space-y-2 text-sm mb-4">
                                ...
                                <div class="flex justify-between">
                                    <span class="text-gray-500">Stripe processing</span>
                                    <span class="text-gray-400">~$1.32</span>
                                </div>
                            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1">
                    <div class="bg-[#12121a] rounded-2xl border border-white/10 overflow-hidden max-w-md mx-auto">
                        <div class="bg-gradient-to-r from-fuchsia-500/20 to-violet-500/20 px-5 py-4 border-b border-white/5">
                            <div class="flex items-center gap-2">
                                <svg class="w-5 h-5 text-fuchsia-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span class="text-white font-medium">New Show Announcement</span>
                            </div>
                        </div>
                        <div class="p-5">
                            <div class="text-gray-400 text-xs mb-3">To: 2,847 venue followers</div>
                            <div class="bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20 rounded-xl p-4 mb-4">
                                ...
                                <div class="text-white text-xl font-bold mb-1">Phoebe Bridgers</div>
                                <div class="text-gray-300 text-sm">Saturday, March 15 / Doors 7pm</div>
                                <div class="mt-3 flex items-center gap-2">
                                    <span class="px-3 py-1 rounded-full bg-white/10 text-white text-xs">$45</span>
    ...
    <section class="bg-[#0d0d12] py-20">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-2xl md:text-3xl font-bold text-white mb-4">Also included</h2>
                <p class="text-gray-400">Everything else you need to run your room</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="bg-[#12121a] rounded-xl border border-white/5 p-5 hover:border-violet-500/30 transition">
                    ...
                    <h3 class="text-white font-medium mb-1">QR Door Scanning</h3>
                    <p class="text-gray-500 text-sm">Use any smartphone. No hardware needed.</p>
                </div>

                <div class="bg-[#12121a] rounded-xl border border-white/5 p-5 hover:border-indigo-500/30 transition">
                    ...
                    <h3 class="text-white font-medium mb-1">Recurring Shows</h3>
                    <p class="text-gray-500 text-sm">Jazz Wednesdays auto-repeat every week.</p>
                </div>

                <div class="bg-[#12121a] rounded-xl border border-white/5 p-5 hover:border-amber-500/30 transition">
                    ...
                    <h3 class="text-white font-medium mb-1">Promo Graphics</h3>
                    <p class="text-gray-500 text-sm">Auto-generate flyers for socials.</p>
                </div>

                <div class="bg-[#12121a] rounded-xl border border-white/5 p-5 hover:border-cyan-500/30 transition">
                    ...
                    <h3 class="text-white font-medium mb-1">Venue Analytics</h3>
                    <p class="text-gray-500 text-sm">See which genres fill your room.</p>
                </div>

                <div class="bg-[#12121a] rounded-xl border border-white/5 p-5 hover:border-rose-500/30 transition">
                    ...
                    <h3 class="text-white font-medium mb-1">Google Cal Sync</h3>
                    <p class="text-gray-500 text-sm">Two-way sync with your existing calendar.</p>
                </div>

                <div class="bg-[#12121a] rounded-xl border border-white/5 p-5 hover:border-emerald-500/30 transition">
                    ...
                    <h3 class="text-white font-medium mb-1">Load-in Info</h3>
                    <p class="text-gray-500 text-sm">Share parking, backline, PA details.</p>
                </div>

                <div class="bg-[#12121a] rounded-xl border border-white/5 p-5 hover:border-fuchsia-500/30 transition">
                    ...
                    <h3 class="text-white font-medium mb-1">Live Streaming</h3>
                    <p class="text-gray-500 text-sm">Sell tickets to virtual attendees.</p>
                </div>

                <div class="bg-[#12121a] rounded-xl border border-white/5 p-5 hover:border-blue-500/30 transition">
                    ...
                    <h3 class="text-white font-medium mb-1">Embed Anywhere</h3>
                    <p class="text-gray-500 text-sm">Add your calendar to your website.</p>
                </div>
            </div>
        </div>
    </section>
