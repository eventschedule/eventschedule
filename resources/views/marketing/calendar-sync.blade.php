<x-marketing-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <a href="{{ marketing_url('/google-calendar') }}" class="group block">
                    <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-900/50 to-indigo-900/50 border border-gray-200 dark:border-white/10 p-8 lg:p-10 h-full">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 mb-6">Connect with OAuth for instant, real-time synchronization. Changes in Google Calendar appear immediately via webhook notifications.</p>

                        <div class="flex flex-wrap gap-2 mb-6">
                            <span class="px-3 py-1 rounded-full bg-blue-500/20 text-blue-700 dark:text-blue-300 text-sm">OAuth 2.0</span>
                            <span class="px-3 py-1 rounded-full bg-blue-500/20 text-blue-700 dark:text-blue-300 text-sm">Webhooks</span>
                            <span class="px-3 py-1 rounded-full bg-blue-500/20 text-blue-700 dark:text-blue-300 text-sm">Instant sync</span>
                        </div>
                ...
                <a href="{{ marketing_url('/caldav') }}" class="group block">
                    <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-900/50 to-cyan-900/50 border border-gray-200 dark:border-white/10 p-8 lg:p-10 h-full">
                        <div class="flex items-center gap-3 mb-6">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 mb-6">Sync with any CalDAV-compatible server—Nextcloud, Radicale, Fastmail, iCloud, and more. Perfect for selfhosted setups.</p>

                        <div class="flex flex-wrap gap-2 mb-6">
                            <span class="px-3 py-1 rounded-full bg-teal-500/20 text-teal-700 dark:text-teal-300 text-sm">Open standard</span>
                            <span class="px-3 py-1 rounded-full bg-teal-500/20 text-teal-700 dark:text-teal-300 text-sm">Selfhosted</span>
                            <span class="px-3 py-1 rounded-full bg-teal-500/20 text-teal-700 dark:text-teal-300 text-sm">Any server</span>
                        </div>
    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-24 border-t border-gray-200 dark:border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bento-card md:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-900/50 to-indigo-900/50 border border-gray-200 dark:border-white/10 p-8 lg:p-10">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 text-lg mb-6">Push events to your calendar, pull events from your calendar, or sync both ways. Choose the direction that works for your workflow.</p>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-900/50 to-pink-900/50 border border-gray-200 dark:border-white/10 p-8">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mb-6">Visitors can add any event to their personal calendar with a single click. No account required.</p>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-900/50 to-blue-900/50 border border-gray-200 dark:border-white/10 p-8">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mb-4">Select which calendar to sync with for each schedule. Different schedules can use different calendars.</p>
                ...
                <div class="bento-card md:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900/50 to-teal-900/50 border border-gray-200 dark:border-white/10 p-8 lg:p-10">
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <a href="{{ marketing_url('/analytics') }}" class="group block">
                <div class="bg-gradient-to-br from-emerald-900/50 to-teal-900/50 rounded-3xl border border-gray-200 dark:border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <!-- Text content -->
                        <div class="flex-1 text-center lg:text-left">
                            ...
                            <p class="text-gray-500 dark:text-gray-400 text-lg mb-4">Track page views, device breakdown, and traffic sources. Privacy-first with no external services.</p>
