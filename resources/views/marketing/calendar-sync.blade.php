    ...
    <section class="relative bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 mb-8">
                ...
                <span class="text-sm text-gray-300">Calendar Integration</span>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-900/50 to-pink-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-6">Visitors can add any event to their personal calendar with a single click. No account required.</p>

                    <div class="flex flex-wrap gap-2 justify-center">
                        <span class="px-4 py-2 rounded-xl bg-white/10 text-white text-sm font-medium flex items-center gap-2">
    ...
    <section class="relative bg-[#0a0a0f] py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <a href="{{ marketing_url('/analytics') }}" class="group block">
                <div class="bg-gradient-to-br from-emerald-900/50 to-teal-900/50 rounded-3xl border border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <!-- Text content -->
                        <div class="flex-1 text-center lg:text-left">
                            ...
                            <p class="text-gray-400 text-lg mb-4">Track page views, device breakdown, and traffic sources. Privacy-first with no external services.</p>
