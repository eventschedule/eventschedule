            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                ...
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-100 to-purple-100 dark:from-violet-900 dark:to-purple-900 border border-gray-200 dark:border-white/10 p-8 hover:scale-[1.02] transition-all duration-300">
                    ...
                    <div class="relative">
                        ...
                        <a href="https://github.com/eventschedule/eventschedule/discussions" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-5 py-2.5 bg-violet-200 hover:bg-violet-300 dark:bg-white/10 dark:hover:bg-white/20 border border-violet-300 dark:border-white/20 rounded-xl text-violet-900 dark:text-white font-medium transition-all">
                            GitHub Discussions
