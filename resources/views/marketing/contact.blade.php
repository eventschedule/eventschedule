<x-marketing-layout>
    ...
    <section class="bg-gray-100 dark:bg-[#0f0f14] py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-[52rem] mx-auto relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-900 to-indigo-900 border border-gray-200 dark:border-white/10 p-8 md:p-12 mb-10 hover:scale-[1.02] transition-all duration-300">
                ...
                <div class="relative flex items-center justify-between">
                    <div>
                        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-blue-200 text-sm font-medium mb-6">
                        ...
                        <p class="text-lg text-blue-100/70 mb-8">
                    ...
                    <div class="hidden md:block flex-shrink-0 ml-8">
                        <svg class="w-32 h-32 text-white/10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="0.75">
            ...
            <div class="text-center mb-10">
                <svg class="w-16 h-16 text-gray-900 dark:text-white mx-auto mb-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                <!-- Discussions Card -->
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-900 to-purple-900 border border-gray-200 dark:border-white/10 p-8 hover:scale-[1.02] transition-all duration-300">
                    <div class="absolute top-0 right-0 w-48 h-48 bg-violet-500/10 rounded-full blur-[80px]"></div>
                    <div class="relative">
                        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-violet-200 text-sm font-medium mb-6">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                            </svg>
                            Discussions
                        </div>
                        <h4 class="text-2xl font-bold text-white mb-3">Community Discussions</h4>
                        <p class="text-violet-100/70 mb-6">
                        ...
                        <a href="https://github.com/eventschedule/eventschedule/discussions" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-medium transition-all">
                            GitHub Discussions
                ...
                <!-- Issues Card -->
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 to-slate-900 border border-gray-200 dark:border-white/10 p-8 hover:scale-[1.02] transition-all duration-300">
                    <div class="absolute top-0 right-0 w-48 h-48 bg-gray-500/10 rounded-full blur-[80px]"></div>
                    <div class="relative">
                        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-gray-300 text-sm font-medium mb-6">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                            </svg>
                            Issues
                        </div>
                        <h4 class="text-2xl font-bold text-white mb-3">Report a Bug</h4>
                        <p class="text-gray-300/70 mb-6">
                            Found a bug or have a technical issue? Open an issue on GitHub and we'll look into it.
                        </p>
                        <a href="https://github.com/eventschedule/eventschedule/issues" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-medium transition-all">
                            GitHub Issues
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        </a>
                    </div>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-slate-50 dark:from-white/5 dark:to-white/[0.02] rounded-3xl p-8 border border-gray-200 dark:border-white/10 shadow-sm">
                ...
                <div class="flex flex-wrap justify-center gap-6">
                    <a href="https://www.facebook.com/appeventschedule" target="_blank" rel="noopener" class="flex items-center gap-3 px-6 py-3 bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 rounded-xl transition-colors">
                    ...
                    <a href="https://www.instagram.com/eventschedule/" target="_blank" rel="noopener" class="flex items-center gap-3 px-6 py-3 bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 rounded-xl transition-colors">
                        <svg class="h-5 w-5 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://youtube.com/@EventSchedule" target="_blank" rel="noopener" class="flex items-center gap-3 px-6 py-3 bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 rounded-xl transition-colors">
                        <svg class="h-5 w-5 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://x.com/ScheduleEvent" target="_blank" rel="noopener" class="flex items-center gap-3 px-6 py-3 bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 rounded-xl transition-colors">
                        <svg class="h-5 w-5 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                        </svg>
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">X (Twitter)</span>
                    </a>
                    <a href="https://www.linkedin.com/company/eventschedule/" target="_blank" rel="noopener" class="flex items-center gap-3 px-6 py-3 bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 rounded-xl transition-colors">
                        <svg class="h-5 w-5 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
