<x-marketing-layout>
    ...
    <section class="bg-gray-100 dark:bg-[#0f0f14] py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-[52rem] mx-auto relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 border border-gray-200 dark:border-white/10 p-8 md:p-12 mb-10 hover:scale-[1.02] transition-all duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                <!-- Discussions Card -->
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-100 to-purple-100 dark:from-violet-900 dark:to-purple-900 border border-gray-200 dark:border-white/10 p-8 hover:scale-[1.02] transition-all duration-300">
                    <div class="absolute top-0 right-0 w-48 h-48 bg-violet-500/10 rounded-full blur-[80px]"></div>
                    <div class="relative">
                        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-200 dark:bg-white/10 text-violet-700 dark:text-violet-200 text-sm font-medium mb-6">
                        ...
                        <p class="text-gray-500 dark:text-violet-100/70 mb-6">
                        ...
                        <a href="https://github.com/eventschedule/eventschedule/discussions" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-5 py-2.5 bg-violet-200 hover:bg-violet-300 dark:bg-white/10 dark:hover:bg-white/20 border border-violet-300 dark:border-white/20 rounded-xl text-violet-900 dark:text-white font-medium transition-all">
                            GitHub Discussions
                ...
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-100 to-slate-100 dark:from-gray-900 dark:to-slate-900 border border-gray-200 dark:border-white/10 p-8 hover:scale-[1.02] transition-all duration-300">
                    ...
                    <div class="relative">
                        ...
                        <a href="https://github.com/eventschedule/eventschedule/issues" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-200 hover:bg-gray-300 dark:bg-white/10 dark:hover:bg-white/20 border border-gray-300 dark:border-white/20 rounded-xl text-gray-900 dark:text-white font-medium transition-all">
                            GitHub Issues
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        </a>
                    </div>
