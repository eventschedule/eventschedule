    ...
    @php
        ...
        $faqs = [
            ...
            [
                ...
                'a' => 'Custom domains are available on the Enterprise plan, which is $15 a month. Free and Pro plans use the default eventschedule.com subdomain. You can upgrade at any time from your account settings. Removing the Event Schedule badge is a separate thing and starts on Pro.',
            ],
            [
            ...
            <div class="es-plate-band noise relative overflow-hidden rounded-[2.5rem] px-6 py-16 sm:px-12 lg:py-20" data-reveal="panel">
                ...
                <div class="relative z-10">
                    <div class="mx-auto mb-12 max-w-3xl text-center">
                        ...
                        <p class="mx-auto max-w-2xl text-lg text-gray-300" data-reveal style="--reveal-delay: 0.15s;">
                            Custom domains sit on the Enterprise plan at $15 a month, next to the AI features, internal and unlisted events, and a team of up to five people. Free and Pro schedules use their eventschedule.com subdomain, which is a perfectly good address to publish from while you decide.
                        </p>
                    </div>
                    ...
                    <p class="mt-10 text-center text-sm text-gray-400" data-reveal>
                        Removing the Powered by badge starts on Pro at $5 a month.
