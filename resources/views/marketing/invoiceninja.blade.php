<x-marketing-layout>
    ...
    <section class="relative bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 mb-8">
                ...
                <span class="text-sm text-gray-300">Professional Invoicing</span>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('sign_up') }}" class="inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl hover:scale-105 transition-all shadow-lg shadow-emerald-500/25">
                    Get started free
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900/50 to-teal-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-6">Every ticket purchase automatically generates a professional invoice in Invoice Ninja with all the details.</p>
                    ...
                    <div class="bg-black/30 rounded-xl p-4 border border-white/10">
                        ...
                        <div class="text-white font-semibold mb-1">Jazz Night VIP</div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-400 text-sm">2 tickets</span>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-900/50 to-cyan-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-4">Automatically creates new clients or links to existing ones. Build your customer database with every sale.</p>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5 border border-white/10">
                            ...
                            <span class="text-gray-300 text-sm">john@company.com</span>
                        </div>
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900/50 to-cyan-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <p class="text-gray-400 text-lg">Customers access their invoices through Invoice Ninja's client portal. View history, download PDFs, and pay online.</p>
                        </div>
                        <div class="bg-black/30 rounded-2xl p-6 border border-white/10">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <div class="text-white font-medium">Client Portal</div>
                                    <div class="text-gray-400 text-sm">john@company.com</div>
                                </div>
                            </div>
                            <div class="space-y-2">
                                <div class="flex justify-between p-2 rounded-lg bg-white/5">
                                    <span class="text-gray-400 text-sm">Invoice #1042</span>
                                    <span class="text-emerald-400 text-sm">Paid</span>
                                </div>
                                <div class="flex justify-between p-2 rounded-lg bg-white/5">
                                    <span class="text-gray-400 text-sm">Invoice #1038</span>
                                    <span class="text-emerald-400 text-sm">Paid</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-900/50 to-purple-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-4">Payment notifications flow back automatically. When customers pay, tickets are marked as confirmed instantly.</p>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-900/50 to-orange-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-4">Invoice in any currency supported by Invoice Ninja. Perfect for international events and clients.</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white/5 rounded-2xl p-8 border border-white/10">
                    ...
                    <h3 class="text-xl font-semibold text-white mb-3">B2B Ready</h3>
                ...
                <div class="bg-white/5 rounded-2xl p-8 border border-white/10">
                    ...
                    <h3 class="text-xl font-semibold text-white mb-3">Tax Tracking</h3>
                    <p class="text-gray-400">
                ...
                <div class="bg-white/5 rounded-2xl p-8 border border-white/10">
                    ...
                    <h3 class="text-xl font-semibold text-white mb-3">Flexible Payments</h3>
                    <p class="text-gray-400">
    ...
    <section class="bg-[#0a0a0f] py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <a href="https://invoiceninja.com" target="_blank" rel="noopener" class="group block">
                <div class="bg-gradient-to-br from-emerald-900/30 to-teal-900/30 rounded-3xl border border-white/10 p-8 hover:border-white/20 transition-all">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 text-sm font-medium mb-4">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-gray-200 transition-colors">Learn more about Invoice Ninja</h3>
                    <p class="text-gray-400 mb-4">Explore Invoice Ninja's open-source invoicing platform, features, and selfhosted options.</p>
    ...
    <section class="relative bg-gradient-to-br from-emerald-600 to-teal-700 py-24 overflow-hidden">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('sign_up') }}" class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-emerald-600 bg-white rounded-2xl hover:scale-105 transition-all shadow-xl">
                Get Started Free
                <svg class="ml-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
