<x-marketing-layout>
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "description": "Share your exhibitions, open studios, and art fairs. Sell tickets directly, build your collector base with newsletters. Zero platform fees.",
        "provider": {
            "@type": "Organization",
            "name": "Event Schedule",
            "url": "{{ config('app.url') }}"
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "url": "{{ url()->current() }}",
        "keywords": "art exhibition schedule, gallery show calendar, artist event management, art show booking, free artist scheduling",
        "provider": {
            "@type": "Organization",
            "name": "Event Schedule"
        }
    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-20">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="{{ marketing_url('/for-art-galleries') }}" class="group flex items-center justify-between p-5 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 hover:border-blue-300 dark:hover:border-blue-500/30 hover:bg-blue-50 dark:hover:bg-blue-500/5 transition-all">
                    <div>
                        <div class="text-sm text-gray-500 dark:text-gray-400">Event Schedule for</div>
                        <div class="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Art Galleries</div>
                    </div>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                <details name="faq" class="bg-gradient-to-br from-cyan-100 to-teal-100 dark:from-cyan-900 dark:to-teal-900 rounded-2xl border border-cyan-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Is Event Schedule free for visual artists?
                        </h3>
                    ...
                    <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                        Yes. Event Schedule is free forever for sharing your exhibition and event schedule, building a collector following, and syncing with Google Calendar. Newsletters and advanced features are available on the Pro plan.
                    </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-teal-100 to-emerald-100 dark:from-teal-900 dark:to-emerald-900 rounded-2xl border border-teal-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can I list exhibitions, open studios, and art fairs together?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                        Yes. Use sub-schedules to organize by event type - solo exhibitions, group shows, open studios, art fairs, and workshops. Each event can include descriptions, images, venue details, and ticketing options.
                    </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-emerald-100 to-cyan-100 dark:from-emerald-900 dark:to-cyan-900 rounded-2xl border border-emerald-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            How do collectors and art lovers discover my events?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                        Followers can receive email notifications when you add new exhibitions or events. Share your schedule link in your artist bio, on social media, or embed it on your portfolio website.
                    </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 rounded-2xl border border-sky-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can I sell tickets to openings and workshops?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                        Yes. Connect your Stripe account and sell tickets directly from your schedule. Perfect for ticketed opening receptions, art workshops, or studio tours. Zero platform fees - you only pay Stripe's processing fees.
                    </p>
                </details>
            </div>
        </div>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-24 overflow-hidden border-t border-sky-200 dark:border-sky-900/20">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ app_url('/sign_up') }}" class="group inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-sky-600 to-cyan-600 rounded-2xl hover:scale-105 transition-transform duration-150 will-change-transform shadow-xl shadow-sky-500/20">
                Get Started Free
                <svg aria-hidden="true" class="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
