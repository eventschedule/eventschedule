<x-marketing-layout>
    ...
    <style>
        ...
        .animate-sync { animation: sync-pulse 2s ease-in-out infinite; }
        .glass {
    ...
    <section class="relative bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 mb-8">
                ...
                <span class="text-sm text-gray-300">CalDAV Protocol</span>
            </div>
    ...
    <section class="bg-[#0a0a0f] py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <!-- Nextcloud -->
                <div class="bento-card bg-white/5 rounded-2xl p-6 border border-white/10 text-center hover:border-teal-400/30">
                    <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>
                        </svg>
                    </div>
                    <h3 class="text-white font-semibold mb-1">Nextcloud</h3>
                ...
                <div class="bento-card bg-white/5 rounded-2xl p-6 border border-white/10 text-center hover:border-teal-400/30">
                    ...
                    <h3 class="text-white font-semibold mb-1">Radicale</h3>
                ...
                <div class="bento-card bg-white/5 rounded-2xl p-6 border border-white/10 text-center hover:border-teal-400/30">
                    ...
                    <h3 class="text-white font-semibold mb-1">Fastmail</h3>
                ...
                <div class="bento-card bg-white/5 rounded-2xl p-6 border border-white/10 text-center hover:border-teal-400/30">
                    ...
                    <h3 class="text-white font-semibold mb-1">iCloud</h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-900/50 to-cyan-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-4">CalDAV is an open internet standard. No vendor lock-in. Works with any compliant server.</p>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900/50 to-teal-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-4">All connections require HTTPS. Your credentials and calendar data are encrypted in transit.</p>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-900/50 to-blue-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-4">Push events to CalDAV, pull events from CalDAV, or sync both ways.</p>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5 border border-white/10">
                            ...
                            <span class="text-gray-300 text-sm">Push only</span>
                        </div>
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5 border border-white/10">
                            <svg class="w-4 h-4 text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                            </svg>
                            <span class="text-gray-300 text-sm">Pull only</span>
                        </div>
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-cyan-500/20 border border-cyan-400/30">
                            <svg class="w-4 h-4 text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                            </svg>
                            <span class="text-cyan-300 text-sm">Both directions</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-900/50 to-purple-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <p class="text-gray-400 text-lg">Enter your server URL and we'll find all your calendars automatically. No manual configuration needed.</p>
                        </div>
                        <div class="bg-black/30 rounded-xl p-4 border border-white/10">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center gap-2 p-2 rounded-lg bg-violet-500/20 border border-violet-400/30">
                                    ...
                                    <span class="text-violet-200 text-sm">Personal Calendar</span>
                                    <svg class="w-4 h-4 text-violet-400 ml-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                </div>
                                <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5 border border-white/10">
                                    <div class="w-3 h-3 rounded-full bg-cyan-400"></div>
                                    <span class="text-gray-300 text-sm">Work Calendar</span>
                                </div>
                                <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5 border border-white/10">
                                    <div class="w-3 h-3 rounded-full bg-emerald-400"></div>
                                    <span class="text-gray-300 text-sm">Shared Events</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-900/50 to-orange-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-4">Automatic scheduled sync keeps your calendars in harmony. Uses sync tokens for efficient change detection.</p>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-amber-300 text-sm">Next sync in 12 min</span>
                    </div>
                </div>
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-900/50 to-pink-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1">
                            ...
                            <p class="text-gray-400 text-lg mb-6">Perfect for selfhosted setups. Connect Event Schedule to your own CalDAV server and keep full control of your data.</p>
                            <div class="flex flex-wrap gap-3">
                                <span class="px-3 py-1 rounded-full bg-white/10 text-gray-300 text-sm">No cloud dependency</span>
                                <span class="px-3 py-1 rounded-full bg-white/10 text-gray-300 text-sm">Full data ownership</span>
                        ...
                        <div class="flex-shrink-0 animate-float">
                            <div class="bg-black/30 rounded-xl border border-white/10 p-4 w-48">
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    <span class="text-white text-sm font-medium">Your Server</span>
                                </div>
                                <div class="space-y-2">
                ...
                <!-- Encrypted Storage -->
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-800/50 to-zinc-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400">Your CalDAV username and password are stored encrypted. Even if the database is compromised, credentials remain secure.</p>
                </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    <svg class="w-8 h-8 text-teal-400 mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                    </svg>
                    <h3 class="text-white font-semibold mb-1">SUMMARY</h3>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    ...
                    <h3 class="text-white font-semibold mb-1">DESCRIPTION</h3>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    ...
                    <h3 class="text-white font-semibold mb-1">DTSTART / DTEND</h3>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    ...
                    <h3 class="text-white font-semibold mb-1">URL</h3>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    ...
                    <h3 class="text-white font-semibold mb-1">UID</h3>
    ...
    <section class="relative bg-gradient-to-br from-teal-600 to-cyan-700 py-24 overflow-hidden">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('sign_up') }}" class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-teal-600 bg-white rounded-2xl hover:scale-105 transition-all shadow-xl">
                Get Started Free
                <svg class="ml-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
