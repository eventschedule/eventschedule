                ...
                <div data-reveal>
                    ...
                    <ul class="space-y-3">
                        <li class="flex gap-3">
                            ...
                            <span class="es-colo-muted text-sm">A free plan with unlimited free registration, no expiry and no credit card <span class="es-colo-pill">Free</span></span>
                        </li>
                        <li class="flex gap-3">
                            <svg aria-hidden="true" class="es-colo-second mt-1 h-4 w-4 flex-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
                            <span class="es-colo-muted text-sm">Tickets with a price on them and the check-in dashboard for {{ plan_price($proMonthly) }} a month <span class="es-colo-pill es-colo-pill-paid">Pro</span></span>
                        </li>
                        <li class="flex gap-3">
                            <svg aria-hidden="true" class="es-colo-second mt-1 h-4 w-4 flex-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
