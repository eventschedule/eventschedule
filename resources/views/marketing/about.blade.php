<x-marketing-layout>
    ...
    @php
        ...
        $imprint = [
            ...
            [
                'Free plan',
                '$0, with no credit card and no expiry. One team member. Pro is $5 a month and Enterprise is $15.',
            ...
            <div class="es-colo-duplex grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-14" data-reveal-group="120">
                <div data-reveal>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex gap-3">
                            <svg aria-hidden="true" class="es-colo-second mt-1 h-4 w-4 flex-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
                            <span class="es-colo-muted text-sm">Your own domain and up to five team members for $15 <span class="es-colo-pill es-colo-pill-paid">Enterprise</span></span>
                        </li>
                        <li class="flex gap-3">
                            <svg aria-hidden="true" class="es-colo-second mt-1 h-4 w-4 flex-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
