<x-marketing-layout>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('sign_up') }}" class="group inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-violet-600 to-purple-600 rounded-2xl hover:scale-105 transition-transform duration-150 will-change-transform shadow-lg shadow-violet-500/25">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-100 to-violet-100 dark:from-purple-900 dark:to-violet-900 border border-purple-200 dark:border-white/10 p-8">
                    ...
                    <div class="bg-gray-100 dark:bg-[#0f0f14] rounded-xl p-4 border border-gray-200 dark:border-white/10">
                        ...
                        <div class="grid grid-cols-3 gap-1 text-center">
                            <div class="p-1.5 rounded bg-gray-100 dark:bg-white/5 text-purple-300 text-[10px]">Website</div>
                            <div class="p-1.5 rounded bg-gray-100 dark:bg-white/5 text-purple-300 text-[10px]">Email</div>
                            <div class="p-1.5 rounded bg-gray-100 dark:bg-white/5 text-purple-300 text-[10px]">Social</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div class="flex items-center justify-center">
                            <div class="flex items-center gap-4">
                                <div class="bg-violet-500/20 rounded-xl border border-violet-400/30 p-4 w-36">
                                    <div class="text-violet-300 text-xs text-center mb-2 font-semibold">Your Schedule</div>
                                    ...
                                    <div class="mt-3 p-2 rounded-lg bg-violet-400/20 border border-violet-400/30">
                                        <div class="text-[10px] text-white text-center font-medium">Live AMA</div>
                                        <div class="text-[8px] text-violet-300 text-center mt-0.5">Fri 3:00 PM</div>
                                    </div>
                                </div>
                                <div class="flex flex-col items-center gap-1">
                                    ...
                                    <span class="text-violet-400 text-[10px]">join link</span>
                                </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-100 to-fuchsia-100 dark:from-violet-900 dark:to-fuchsia-900 border border-violet-200 dark:border-white/10 p-8">
                    ...
                    <div class="flex items-center justify-center">
                        <div class="flex -space-x-2">
                            ...
                            <div class="w-8 h-8 rounded-full bg-white/20 border-2 border-gray-200 dark:border-[#0a0a0f] flex items-center justify-center text-white text-xs">+156</div>
                        </div>
                    </div>
                    <div class="text-center mt-3 text-violet-400 text-xs">159 following your Q&A sessions</div>
                </div>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-24 overflow-hidden border-t border-violet-200 dark:border-violet-900/20">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('sign_up') }}" class="group inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-violet-600 to-purple-600 rounded-2xl hover:scale-105 transition-transform duration-150 will-change-transform shadow-xl shadow-violet-500/20">
                Get Started Free
                <svg class="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
