<x-marketing-layout>
    <x-slot name="title">Built-in Analytics - Event Schedule</x-slot>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm text-center">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-emerald-100 mb-6">
                        <svg class="w-8 h-8 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Top Events</h3>
                    <p class="text-gray-600 text-sm">See which events get the most views and drive the most ticket sales.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Multi-Schedule</h3>
                    <p class="text-gray-600 text-sm">Filter analytics by schedule or view combined data across all your schedules.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm text-center">
                    ...
                    <p class="text-gray-600 text-sm">No external tracking services. All data stored locally. No cookies required.</p>
                </div>
            </div>
        </div>
    </section>
