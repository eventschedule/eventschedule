<x-marketing-layout>
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "description": "Fill every seat from pottery to photography, cooking to coding. One link for all your workshops. Free forever.",
        "provider": {
            "@type": "Organization",
            "name": "Event Schedule",
            "url": "{{ config('app.url') }}"
        ...
        "audience": {
            "@type": "Audience",
            "audienceType": "Workshop Instructors"
        }
    }
    </script>
    <script type="application/ld+json" {!! nonce_attr() !!}>
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "url": "{{ url()->current() }}",
        "keywords": "workshop schedule, class booking calendar, workshop registration, course scheduling software, free workshop scheduling",
        "provider": {
            "@type": "Organization",
            "name": "Event Schedule"
        }
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 border border-blue-200 dark:border-white/10 p-8">
                    ...
                    <div class="bg-blue-500/20 rounded-xl border border-blue-400/30 p-4">
                        <div class="flex items-center gap-2 bg-gray-200 dark:bg-[#0f0f14] rounded-lg px-3 py-2 border border-gray-300 dark:border-white/10">
                            <svg aria-hidden="true" class="w-4 h-4 text-blue-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="bg-gradient-to-br from-blue-100 to-blue-100 dark:from-blue-950 dark:to-blue-950 rounded-2xl border border-blue-300 dark:border-blue-400/30 p-4 max-w-xs">
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex items-center gap-3 p-2 rounded-lg bg-blue-200 dark:bg-blue-500/20 border border-blue-300 dark:border-blue-400/30">
                                            ...
                                            <svg aria-hidden="true" class="w-4 h-4 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
                                        </div>
                                        <div class="flex items-center gap-3 p-2 rounded-lg bg-blue-200 dark:bg-blue-500/20 border border-blue-300 dark:border-blue-400/30">
            ...
            <div class="relative bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900/60 dark:to-blue-900/60 rounded-3xl border border-sky-200 dark:border-sky-500/30 p-8 lg:p-10">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full bg-green-500/20 text-green-600 dark:text-green-300 text-sm font-medium border border-green-500/30">
                        <svg aria-hidden="true" class="w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" /></svg>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="hidden md:flex absolute top-1/2 left-[24%] transform -translate-y-1/2 z-10">
                        <svg aria-hidden="true" class="w-6 h-6 text-sky-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
                    </div>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                <details name="faq" class="bg-gradient-to-br from-cyan-100 to-teal-100 dark:from-cyan-900 dark:to-teal-900 rounded-2xl border border-cyan-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Is Event Schedule free for workshop instructors?
                        </h3>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Event Schedule is free forever for sharing your workshop schedule, building a following, and syncing with Google Calendar. Paid registration and newsletters are available on the Pro plan, with zero platform fees.
                        </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-teal-100 to-emerald-100 dark:from-teal-900 dark:to-emerald-900 rounded-2xl border border-teal-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can I manage different types of workshops in one schedule?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Use sub-schedules to organize by workshop type - cooking classes, pottery, photography, or craft sessions. Each workshop can have its own description, images, pricing, capacity limits, and registration options.
                        </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-emerald-100 to-cyan-100 dark:from-emerald-900 dark:to-cyan-900 rounded-2xl border border-emerald-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            How do students discover my workshops?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Students can follow your schedule and receive email notifications when you add new workshops. Share your schedule link on social media, embed it on your studio or school website, or send newsletters to followers with upcoming sessions.
                        </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 rounded-2xl border border-sky-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can I sell spots and manage registrations?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Connect your Stripe account and sell workshop spots directly from your schedule. Set per-workshop pricing, limit capacity, and check in attendees with QR codes. Event Schedule charges zero platform fees.
                        </p>
                </details>
            </div>
        </div>
