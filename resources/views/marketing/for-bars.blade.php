    ...
    @php
        ...
        $faqs = [
            [
                ...
                'a' => 'Yes. Sharing your calendar, running recurring weekly nights, splitting them into sub-schedules, taking free registrations, and syncing with Google, Outlook or CalDAV are all free forever. Newsletters are free too, at 10 emails a month, counted per recipient rather than per send. Ticketing, event graphics and the higher 100-a-month newsletter limit are on the Pro plan at '.plan_price($proMonthly).' a month.',
            ],
            [
