    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "mainEntity": [
            ...
            },
            {
                ...
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "No. Event Schedule is free forever for creating and sharing your bar's event calendar. You can upgrade to Pro for ticketing and newsletters, but there are never any platform fees on ticket sales - you only pay Stripe's standard processing fees."
                }
            },
            {
                "@type": "Question",
                    ...
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <span class="inline-flex items-center px-3 py-1 rounded-full bg-gray-300 dark:bg-white/10 text-gray-700 dark:text-gray-300 text-sm">Your crowd, your reach</span>
                            </div>
                        </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <span class="inline-flex items-center px-3 py-1 rounded-full bg-gray-300 dark:bg-white/10 text-gray-700 dark:text-gray-300 text-sm">Watch parties</span>
                                <span class="inline-flex items-center px-3 py-1 rounded-full bg-gray-300 dark:bg-white/10 text-gray-700 dark:text-gray-300 text-sm">Big screen events</span>
                            </div>
                        </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 rounded-3xl border border-amber-200 dark:border-white/10 p-6 md:p-8">
                <div class="grid grid-cols-7 gap-2 md:gap-4">
                    <!-- Monday -->
                    <div class="text-center">
                        <div class="text-gray-600 dark:text-gray-400 text-xs md:text-sm font-medium mb-2 md:mb-3">Mon</div>
                        <div class="bg-gray-100 dark:bg-white/5 rounded-xl p-2 md:p-3 min-h-[80px] md:min-h-[100px]">
                            ...
                            <div class="text-gray-600 dark:text-gray-400 text-[9px] md:text-[10px] mt-1">50% off for service workers</div>
                        </div>
                    </div>
                    <!-- Tuesday -->
                    <div class="text-center">
                        <div class="text-gray-600 dark:text-gray-400 text-xs md:text-sm font-medium mb-2 md:mb-3">Tue</div>
                        <div class="bg-gray-100 dark:bg-white/5 rounded-xl p-2 md:p-3 min-h-[80px] md:min-h-[100px]">
                            <div class="text-orange-400 text-[10px] md:text-xs font-medium">Taco Tuesday</div>
                            <div class="text-gray-600 dark:text-gray-400 text-[9px] md:text-[10px] mt-1">$2 tacos all night</div>
                        </div>
                    </div>
                    ...
                    <!-- Sunday -->
                    <div class="text-center">
                        <div class="text-gray-600 dark:text-gray-400 text-xs md:text-sm font-medium mb-2 md:mb-3">Sun</div>
                        <div class="bg-gray-100 dark:bg-white/5 rounded-xl p-2 md:p-3 min-h-[80px] md:min-h-[100px]">
                            <div class="text-yellow-400 text-[10px] md:text-xs font-medium">Brunch</div>
                            <div class="text-gray-600 dark:text-gray-400 text-[9px] md:text-[10px] mt-1">Bloody Mary bar</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4" x-data="{ open: null }">
                ...
                <div class="bg-gradient-to-br from-yellow-100 to-amber-100 dark:from-yellow-900 dark:to-amber-900 rounded-2xl border border-yellow-200 dark:border-white/10 shadow-sm overflow-hidden">
                    ...
                    <div x-show="open === 3" x-collapse>
                        <p class="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            No. Event Schedule is free forever for creating and sharing your bar's event calendar. You can upgrade to Pro for ticketing and newsletters, but there are never any platform fees on ticket sales - you only pay Stripe's standard processing fees.
                        </p>
                    </div>
                </div>
