        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <a href="{{ marketing_url('/features/sub-schedules') }}" class="group block">
                    <div class="h-full bg-gradient-to-br from-rose-100 to-cyan-100 dark:from-rose-900 dark:to-cyan-900 rounded-3xl border border-rose-200 dark:border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300 flex flex-col">
                        <div class="flex flex-col lg:flex-row gap-8 items-center flex-1">
                            ...
                            <div class="flex-1 flex flex-col text-center lg:text-left">
                                ...
                                <span class="inline-flex items-center text-rose-400 font-medium group-hover:gap-3 gap-2 transition-all mt-auto">
                                    Learn more
