<x-marketing-layout>
    <x-slot name="title">Online Events - Event Schedule</x-slot>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-900/50 to-violet-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1">
                            ...
                            <p class="text-gray-400 text-lg mb-6">Toggle any event between in-person and online with a single checkbox. Add your streaming URL and you're ready to go live.</p>
                            <div class="flex flex-wrap gap-3">
                                <span class="px-3 py-1 rounded-full bg-white/10 text-gray-300 text-sm">In-Person</span>
                        ...
                        <div class="flex-shrink-0 w-full lg:w-auto">
                            <div class="relative animate-float">
                                <!-- Toggle mockup -->
                                <div class="bg-black/30 rounded-2xl border border-white/10 p-6 w-64">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="bg-white/5 rounded-lg px-3 py-2 text-indigo-400 text-sm truncate">
                                            zoom.us/j/123456789
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-900/50 to-purple-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-6">Works with any streaming service. Just paste your URL and attendees will see it on the event page and their ticket.</p>

                    <div class="space-y-2">
                        <div class="flex items-center gap-3 px-3 py-2 bg-white/5 rounded-lg">
                            <div class="w-2 h-2 rounded-full bg-blue-400"></div>
                            <span class="text-gray-300 text-sm">Zoom</span>
                        </div>
                        <div class="flex items-center gap-3 px-3 py-2 bg-white/5 rounded-lg">
                            <div class="w-2 h-2 rounded-full bg-red-400"></div>
                            <span class="text-gray-300 text-sm">YouTube Live</span>
                        </div>
                        <div class="flex items-center gap-3 px-3 py-2 bg-white/5 rounded-lg">
                            <div class="w-2 h-2 rounded-full bg-purple-400"></div>
                            <span class="text-gray-300 text-sm">Twitch</span>
                        </div>
                        <div class="flex items-center gap-3 px-3 py-2 bg-white/5 rounded-lg">
                            <div class="w-2 h-2 rounded-full bg-green-400"></div>
                            <span class="text-gray-300 text-sm">Google Meet</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-fuchsia-900/50 to-pink-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-6">Ticket holders see the streaming URL when they view their ticket. No searching through emails for the link.</p>
                    ...
                    <div class="bg-black/30 rounded-xl p-4 border border-white/10">
                        <div class="flex items-center gap-2 mb-3">
                            ...
                            <span class="text-white text-sm font-medium">Your Ticket</span>
                        </div>
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-900/50 to-indigo-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <p class="text-gray-400 text-lg">All ticketing features work for online events. Multiple ticket types, QR codes, attendee management, and secure payments with Stripe.</p>
                        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Webinars</h3>
                    <p class="text-gray-600 text-sm">Host educational sessions, product demos, or training workshops for attendees worldwide.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Live Concerts</h3>
                    <p class="text-gray-600 text-sm">Stream live performances to fans who can't make it in person. Sell virtual tickets alongside venue tickets.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Online Classes</h3>
                    <p class="text-gray-600 text-sm">Yoga, cooking, art, or fitness classes. Schedule recurring sessions and manage enrollments.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Virtual Conferences</h3>
                    <p class="text-gray-600 text-sm">Host multi-day conferences with different ticket types for keynotes, workshops, and networking sessions.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Live Q&A Sessions</h3>
                    <p class="text-gray-600 text-sm">Interactive sessions where speakers answer audience questions in real-time.</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Watch Parties</h3>
                    <p class="text-gray-600 text-sm">Premiere screenings, movie nights, or sports viewing events with your community.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="relative bg-[#0a0a0f] py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <a href="{{ marketing_url('/open-source') }}" class="group block">
                <div class="bg-gradient-to-br from-gray-900/50 to-slate-900/50 rounded-3xl border border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <!-- Text content -->
                        <div class="flex-1 text-center lg:text-left">
                            ...
                            <p class="text-gray-400 text-lg mb-4">100% open source. Self-host on your own server or integrate with our REST API.</p>
                        ...
                        <div class="flex-shrink-0">
                            <div class="bg-black/50 rounded-xl border border-white/20 overflow-hidden w-52">
                                <!-- Terminal header -->
