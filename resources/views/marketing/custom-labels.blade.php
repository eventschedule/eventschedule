<x-marketing-layout>
    ...
    <x-slot name="description">Rename the words on your public schedule. "Events" can be Classes, Services, Openings or Sessions, across 34 labels, with a second form for the language you translate into.</x-slot>
