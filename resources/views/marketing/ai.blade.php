    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-900 to-indigo-900 border border-gray-200 dark:border-white/10 p-8 lg:p-10">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1">
                            ...
                            <p class="text-white/80 text-lg mb-6">Flyers, emails, social posts, screenshots. Paste the text or drop an image and AI extracts event name, date, time, venue, and description.</p>
                            <div class="flex flex-wrap gap-3">
                                <span class="px-3 py-1 rounded-full bg-gray-300 dark:bg-white/10 text-gray-700 dark:text-gray-300 text-sm">Text parsing</span>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-fuchsia-900 to-pink-900 border border-gray-200 dark:border-white/10 p-8">
                    ...
                    <p class="text-white/80 mb-6">Translate your entire schedule to English automatically. Perfect for international audiences.</p>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900 to-teal-900 border border-gray-200 dark:border-white/10 p-8">
                    ...
                    <p class="text-white/80 mb-6">AI matches parsed events to existing venues and performers in your schedule using fuzzy matching.</p>
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-900 to-blue-900 border border-gray-200 dark:border-white/10 p-8 lg:p-10">
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <p class="text-white/80 text-lg">Text, images, screenshots, flyers, social media posts. Drop it in and AI figures out the rest.</p>
                        </div>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <a href="{{ marketing_url('/calendar-sync') }}" class="group block">
                <div class="bg-gradient-to-br from-blue-900 to-indigo-900 rounded-3xl border border-gray-200 dark:border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <!-- Text content -->
                        <div class="flex-1 text-center lg:text-left">
                            ...
                            <p class="text-white/80 text-lg mb-4">Two-way sync with Google Calendar. Changes flow in both directions automatically.</p>
