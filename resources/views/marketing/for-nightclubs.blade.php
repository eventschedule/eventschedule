<x-marketing-layout>
    <x-slot name="title">Event Schedule for Nightclubs | DJ Lineup Calendar</x-slot>
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p class="text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-xl mx-auto lg:mx-0 mb-12 animate-reveal delay-200" style="opacity: 0;">
                    ...
                    <div class="flex flex-wrap justify-center lg:justify-start gap-4">
                        <a href="{{ app_url('/sign_up') }}" class="inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-cyan-600 to-sky-600 rounded-2xl hover:scale-105 transition-all shadow-lg shadow-cyan-500/25">
                    ...
                    <div class="mt-12 flex flex-wrap justify-center lg:justify-start gap-2">
                        <span class="inline-flex items-center px-3 py-1 rounded-full bg-cyan-100 text-cyan-700 dark:bg-cyan-500/20 dark:text-cyan-300 text-xs font-medium border border-cyan-200 dark:border-cyan-500/30">EDM</span>
                        <span class="inline-flex items-center px-3 py-1 rounded-full bg-sky-100 text-sky-700 dark:bg-sky-500/20 dark:text-sky-300 text-xs font-medium border border-sky-200 dark:border-sky-500/30">Hip-Hop</span>
                        <span class="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-300 text-xs font-medium border border-blue-200 dark:border-blue-500/30">Latin</span>
                        <span class="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-300 text-xs font-medium border border-blue-200 dark:border-blue-500/30">Rooftop</span>
                        <span class="inline-flex items-center px-3 py-1 rounded-full bg-sky-100 text-sky-700 dark:bg-sky-500/20 dark:text-sky-300 text-xs font-medium border border-sky-200 dark:border-sky-500/30">Underground</span>
                ...
                <div class="hidden lg:block">
                    <div class="relative animate-float">
                        <div class="bg-gradient-to-br from-cyan-100 to-sky-100 dark:from-cyan-950 dark:to-sky-950 rounded-2xl border border-cyan-300 dark:border-cyan-400/30 p-6 max-w-sm mx-auto backdrop-blur-sm">
                            <!-- Header with "Tonight" badge -->
                            <div class="flex items-center justify-between mb-5">
                                <div>
                                    <div class="flex items-center gap-2 mb-1">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded bg-cyan-500 text-white text-[10px] font-bold uppercase tracking-wide">Tonight</span>
                                    </div>
                            ...
                            <!-- Headliner -->
                            <div class="bg-gradient-to-r from-cyan-500/30 to-sky-500/30 rounded-xl p-4 mb-3 border border-cyan-400/20">
                                <div class="flex items-center gap-3">
                                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500 to-sky-500 flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-cyan-500/30">DN</div>
                                    <div class="flex-1">
                                        <div class="text-[10px] text-cyan-600 dark:text-cyan-300 uppercase tracking-wide font-semibold">Headliner</div>
                            ...
                            <div class="space-y-2 mb-4">
                                <div class="flex items-center gap-3 p-2 rounded-lg bg-gray-100 dark:bg-white/5">
                                    <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-sky-500 flex items-center justify-center text-white text-[10px] font-semibold">MX</div>
                                    <div class="flex-1">
                                ...
                                <div class="flex items-center gap-3 p-2 rounded-lg bg-gray-100 dark:bg-white/5">
                                    <div class="w-8 h-8 rounded-full bg-gradient-to-br from-sky-500 to-blue-500 flex items-center justify-center text-white text-[10px] font-semibold">KR</div>
                                    <div class="flex-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-100 to-sky-100 dark:from-cyan-900 dark:to-sky-900 border border-cyan-200 dark:border-white/10 p-8 lg:p-10">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        ...
                        <div class="flex-shrink-0 w-full lg:w-auto">
                            <div class="relative animate-float">
                                <div class="bg-gradient-to-br from-cyan-100 to-sky-100 dark:from-cyan-950 dark:to-sky-950 rounded-2xl border border-cyan-300 dark:border-cyan-400/30 p-4 max-w-xs">
                                    <div class="flex items-center gap-3 mb-4">
                                        <div class="w-10 h-10 bg-gradient-to-br from-cyan-500 to-sky-500 rounded-xl flex items-center justify-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-cyan-600 dark:text-cyan-300 text-xs">Sending to 2,341 followers...</div>
                                        </div>
                                    </div>
                                    <div class="space-y-2">
                                        <div class="flex items-center gap-2 p-2 rounded-lg bg-cyan-200 dark:bg-white/10">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 border border-sky-200 dark:border-white/10 p-8">
                    ...
                    <div class="grid grid-cols-7 gap-1">
                        ...
                        <div class="text-center">
                            <div class="text-sky-600 dark:text-sky-300 text-[10px] mb-1 font-medium">T</div>
                            <div class="w-6 h-6 rounded-full bg-sky-500 mx-auto" title="Industry Night"></div>
                        </div>
                        <div class="text-center">
                        ...
                        <div class="text-center">
                            <div class="text-cyan-600 dark:text-cyan-300 text-[10px] mb-1 font-medium">S</div>
                            <div class="w-6 h-6 rounded-full bg-cyan-500 mx-auto" title="80s Saturdays"></div>
                        </div>
                        <div class="text-center">
                            <div class="text-blue-600 dark:text-blue-300 text-[10px] mb-1 font-medium">S</div>
                            <div class="w-6 h-6 rounded-full bg-blue-500 mx-auto" title="Techno Sundays"></div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white dark:bg-gray-900 rounded-2xl p-5 border border-gray-200 dark:border-white/10">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-3 p-3 rounded-lg bg-gray-100 dark:bg-white/5">
                                    ...
                                    <span class="inline-flex items-center px-2 py-0.5 rounded bg-cyan-500/30 text-cyan-600 dark:text-cyan-300 text-[10px] font-medium">BDAY</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 border border-sky-200 dark:border-white/10 p-8">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-3 p-3 rounded-xl bg-sky-200 dark:bg-sky-500/20 border border-sky-400/30">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-sky-500 to-blue-500 flex items-center justify-center text-white text-xs font-semibold">KR</div>
                            <div class="flex-1">
                                <div class="text-gray-900 dark:text-white text-sm font-medium">DJ Kira</div>
                                <div class="text-sky-600 dark:text-sky-300 text-[10px]">Tech House &bull; SoundCloud linked</div>
                            </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-blue-100 dark:from-blue-900 dark:to-blue-900 border border-blue-200 dark:border-white/10 p-8">
                    ...
                    <div class="flex justify-center">
                        <div class="relative">
                            <div class="w-28 h-36 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-3 shadow-xl border border-blue-400/30">
                                <div class="text-[8px] text-blue-200 font-bold mb-1">SATURDAY</div>
                                <div class="text-[6px] text-blue-300/70 mb-2">CLUB VORTEX</div>
                                <div class="space-y-1">
                                    <div class="bg-white/20 rounded px-1 py-0.5 text-[6px] text-white font-medium">DJ NOVA</div>
                                    <div class="bg-white/10 rounded px-1 py-0.5 text-[6px] text-blue-200">MAX LUNA</div>
                                    <div class="bg-white/10 rounded px-1 py-0.5 text-[6px] text-blue-200">KIRA B2B ECHO</div>
                                </div>
                                <div class="absolute bottom-2 right-2">
                                    <svg aria-hidden="true" class="w-4 h-4 text-white/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                                    </svg>
                                </div>
                            </div>
                            <div class="absolute -bottom-2 -right-2 w-8 h-8 bg-gradient-to-br from-cyan-500 to-sky-500 rounded-lg flex items-center justify-center shadow-lg">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex-1 bg-rose-200 dark:bg-rose-500/20 rounded-xl border border-rose-400/30 p-3">
                            ...
                            <div class="w-full h-1.5 bg-rose-500/30 rounded-full mt-2 overflow-hidden">
                                <div class="w-[85%] h-full bg-gradient-to-r from-rose-500 to-cyan-500 rounded-full"></div>
                            </div>
    ...
    <section class="bg-gray-50 dark:bg-[#0f0f14] py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <!-- Thursday -->
                <div class="bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900/40 dark:to-blue-900/40 rounded-2xl border border-sky-200 dark:border-sky-500/30 p-6">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 bg-sky-100 dark:bg-sky-500/20 rounded-xl flex items-center justify-center">
                            <span class="text-sky-600 dark:text-sky-400 text-lg font-bold">THU</span>
                        </div>
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white">Industry Night</h3>
                            <p class="text-sky-600 dark:text-sky-300 text-sm">Service industry</p>
                        </div>
                    </div>
                ...
                <!-- Saturday -->
                <div class="bg-gradient-to-br from-cyan-100 to-rose-100 dark:from-cyan-900/40 dark:to-rose-900/40 rounded-2xl border border-cyan-200 dark:border-cyan-500/30 p-6">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 bg-cyan-100 dark:bg-cyan-500/20 rounded-xl flex items-center justify-center">
                            <span class="text-cyan-600 dark:text-cyan-400 text-lg font-bold">SAT</span>
                        </div>
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white">Headliner Night</h3>
                            <p class="text-cyan-600 dark:text-cyan-300 text-sm">Touring DJ, premium</p>
                        </div>
                    </div>
                    <div class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                        <div class="flex items-center gap-2">
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <a href="{{ marketing_url('/features/online-events') }}" class="group block">
                <div class="bg-gradient-to-br from-cyan-100 to-sky-100 dark:from-cyan-900 dark:to-sky-900 rounded-3xl border border-cyan-200 dark:border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1 text-center lg:text-left">
                            ...
                            <h3 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-cyan-300 transition-colors">Stream to the world</h3>
    ...
    <section class="bg-gray-50 dark:bg-[#0f0f14] py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    <div class="w-16 h-16 bg-gradient-to-br from-cyan-500 to-sky-500 text-white text-2xl font-bold rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-cyan-500/25">
                        1
                    </div>
            ...
            <div class="space-y-4" x-data="{ open: null }">
                <div class="bg-gradient-to-br from-cyan-100 to-teal-100 dark:from-cyan-900 dark:to-teal-900 rounded-2xl border border-cyan-200 dark:border-white/10 shadow-sm overflow-hidden">
                    <button @click="open = open === 1 ? null : 1" class="w-full flex items-center justify-between p-6 text-left cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Is Event Schedule free for nightclubs?
                        </h3>
                    ...
                    <div x-show="open === 1" x-collapse>
                        <p class="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Event Schedule is free forever for sharing your lineup, building a following, and syncing with Google Calendar. Ticketing and newsletters are available on the Pro plan, with zero platform fees on ticket sales.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-teal-100 to-emerald-100 dark:from-teal-900 dark:to-emerald-900 rounded-2xl border border-teal-200 dark:border-white/10 shadow-sm overflow-hidden">
                    <button @click="open = open === 2 ? null : 2" class="w-full flex items-center justify-between p-6 text-left cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can I promote DJ lineups and themed nights?
                        </h3>
                    ...
                    <div x-show="open === 2" x-collapse>
                        <p class="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Create events with detailed descriptions, flyer images, and lineup information. Use sub-schedules to organize by night type - EDM Fridays, Latin Saturdays, or themed events. Each event can have its own ticket tiers for VIP, general admission, and bottle service.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-emerald-100 to-cyan-100 dark:from-emerald-900 dark:to-cyan-900 rounded-2xl border border-emerald-200 dark:border-white/10 shadow-sm overflow-hidden">
                    <button @click="open = open === 3 ? null : 3" class="w-full flex items-center justify-between p-6 text-left cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            How do partygoers find out about upcoming events?
                        </h3>
                    ...
                    <div x-show="open === 3" x-collapse>
                        <p class="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Fans can follow your club's schedule and get email notifications when new events are added. Share your schedule link on social media, embed it on your website, or send newsletters directly to followers with upcoming lineups.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 rounded-2xl border border-sky-200 dark:border-white/10 shadow-sm overflow-hidden">
                    <button @click="open = open === 4 ? null : 4" class="w-full flex items-center justify-between p-6 text-left cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can I sell tickets with different tiers like VIP and general admission?
                        </h3>
                    ...
                    <div x-show="open === 4" x-collapse>
                        <p class="px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Create multiple ticket types per event with different prices and quantities. Connect your Stripe account and sell directly - Event Schedule charges zero platform fees. Every ticket includes a QR code for door check-in.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- CTA Section -->
    <section class="relative bg-gradient-to-br from-cyan-600 to-sky-700 py-24 overflow-hidden">
        <div class="absolute inset-0 grid-overlay"></div>

        <!-- Glow effects -->
        <div class="absolute top-0 left-1/4 w-64 h-64 bg-blue-500/20 rounded-full blur-[100px]"></div>
        <div class="absolute bottom-0 right-1/4 w-64 h-64 bg-cyan-500/20 rounded-full blur-[100px]"></div>
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ app_url('/sign_up') }}" class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-cyan-600 bg-white rounded-2xl hover:scale-105 transition-all shadow-xl">
                Get Started Free
                <svg aria-hidden="true" class="ml-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
