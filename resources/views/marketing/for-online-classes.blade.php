                        ...
                        <div class="bg-green-500/20 rounded-xl border border-green-400/30 p-4">
                            <div class="space-y-2 mb-3">
                                <div class="flex items-center justify-between p-2 rounded-lg bg-green-400/20">
                                    ...
                                    <span class="text-green-400 text-xs font-semibold">$15</span>
                                </div>
                                <div class="flex items-center justify-between p-2 rounded-lg bg-emerald-400/20">
                                    ...
                                    <span class="text-emerald-400 text-xs font-semibold">Free</span>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-center">
                            <div class="flex items-center gap-4">
                                <div class="bg-teal-500/20 rounded-xl border border-teal-400/30 p-4 w-36">
                                    <div class="text-teal-300 text-xs text-center mb-2 font-semibold">Your Schedule</div>
                                    ...
                                    <div class="mt-3 p-2 rounded-lg bg-teal-400/20 border border-teal-400/30">
                                        <div class="text-[10px] text-white text-center font-medium">Morning Yoga</div>
                                        <div class="text-[8px] text-teal-300 text-center mt-0.5">Mon 7:00 AM</div>
                                    </div>
                                </div>
                                <div class="flex flex-col items-center gap-1">
                                    ...
                                    <span class="text-teal-400 text-[10px]">class link</span>
                                </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-100 to-emerald-100 dark:from-cyan-900 dark:to-emerald-900 border border-cyan-200 dark:border-white/10 p-8">
                    ...
                    <div class="flex items-center justify-center">
                        <div class="flex -space-x-2">
                            ...
                            <div class="w-8 h-8 rounded-full bg-white/20 border-2 border-gray-200 dark:border-[#0a0a0f] flex items-center justify-center text-white text-xs">+340</div>
                        </div>
                    </div>
                    <div class="text-center mt-3 text-cyan-300 text-xs">343 students following your schedule</div>
                </div>
