    ...
    @php
        ...
        $faqs = [
            ...
            [
                ...
                'a' => 'No. The account is free and asks for no card. What costs money is a schedule you run, once you want more than the free plan: Pro at $5 a month adds ticketing with QR check-in, custom fields and a waitlist, and Enterprise at $15 a month adds multiple team members and custom domains. Event Schedule charges zero platform fees on ticket sales, so past the payment processor the money is yours.',
            ],
            [
    ...
    <section id="ledger" class="scroll-mt-24 py-20 lg:py-28">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <p class="es-key-muted mx-auto mt-6 max-w-3xl text-center text-sm" data-reveal>
                Selling tickets is a Pro feature for the schedule doing the selling. Buying one, with or without an account, is free, and Event Schedule takes no cut of the sale either way.
            </p>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-6 md:grid-cols-2" data-reveal-group="110">
                ...
                <div class="es-key-card flex flex-col p-7" data-reveal="panel">
                    ...
                    <p class="es-key-muted mb-4 text-sm leading-relaxed">Every key on this page is on the free plan, and the account asks for no card at sign-up or afterwards. What the paid plans buy is capability for a schedule you run: Pro at $5 a month adds ticketing with QR check-in, custom fields and a waitlist, and Enterprise at $15 a month adds multiple team members, custom domains and AI agenda scanning.</p>
