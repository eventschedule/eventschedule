    ...
    <section class="relative bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 mb-8">
                ...
                <span class="text-sm text-gray-300">Google Calendar</span>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-900/50 to-indigo-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-6">Connect with one click using Google's secure OAuth. No passwords stored. Automatic token refresh keeps you connected.</p>
                    ...
                    <div class="bg-black/30 rounded-xl p-4 border border-white/10">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1">
                                <div class="text-white text-sm font-medium">Sign in with Google</div>
                                <div class="text-gray-500 text-xs">Secure OAuth connection</div>
                            </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900/50 to-teal-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-6">Changes in Google Calendar appear instantly. Webhook notifications mean no polling delays.</p>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-900/50 to-purple-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-4">Choose your direction: push events to Google, pull events from Google, or sync both ways.</p>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5 border border-white/10">
                            ...
                            <span class="text-gray-300 text-sm">Push to Google</span>
                        </div>
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-white/5 border border-white/10">
                            <svg class="w-4 h-4 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                            </svg>
                            <span class="text-gray-300 text-sm">Pull from Google</span>
                        </div>
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-900/50 to-blue-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <p class="text-gray-400 text-lg">Select which Google Calendar to sync with for each schedule. Perfect if you manage multiple calendars for work, personal, or different projects.</p>
                        </div>
                        <div class="space-y-3">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-900/50 to-orange-900/50 border border-white/10 p-8">
                    ...
                    <p class="text-gray-400 mb-4">Sync jobs run in the background. Your schedule stays fast while events sync reliably behind the scenes.</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    ...
                    <h3 class="text-white font-semibold mb-1">Event name</h3>
                    <p class="text-gray-500 text-sm">Title and summary</p>
                </div>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    ...
                    <p class="text-gray-500 text-sm">Full event details</p>
                </div>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    ...
                    <h3 class="text-white font-semibold mb-1">Date & time</h3>
                    <p class="text-gray-500 text-sm">Start and end times</p>
                </div>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    ...
                    <h3 class="text-white font-semibold mb-1">Timezone</h3>
                    <p class="text-gray-500 text-sm">Automatic conversion</p>
                </div>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
                    ...
                    <h3 class="text-white font-semibold mb-1">Event link</h3>
                    <p class="text-gray-500 text-sm">Back to your schedule</p>
                </div>
            </div>
        </div>
    </section>
