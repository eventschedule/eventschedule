<x-marketing-layout>
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "url": "{{ url()->current() }}",
        "keywords": "food truck schedule, vendor location calendar, food truck tracker, mobile vendor scheduling, free food truck scheduling",
        "provider": {
            "@type": "Organization",
            "name": "Event Schedule"
        }
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                <details name="faq" class="bg-gradient-to-br from-cyan-100 to-teal-100 dark:from-cyan-900 dark:to-teal-900 rounded-2xl border border-cyan-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Is Event Schedule free for food trucks?
                        </h3>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Event Schedule is free forever for sharing your location schedule, building a customer following, and syncing with Google Calendar. Newsletters and advanced features are available on the Pro plan, with zero platform fees.
                        </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-teal-100 to-emerald-100 dark:from-teal-900 dark:to-emerald-900 rounded-2xl border border-teal-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can I show where my truck will be each day?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Create events with location details for each stop on your route. Customers can see your full weekly schedule at a glance and know exactly where to find you. Add venue names, addresses, and hours for every location.
                        </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-emerald-100 to-cyan-100 dark:from-emerald-900 dark:to-cyan-900 rounded-2xl border border-emerald-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            How do customers find out where I'll be?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Customers can follow your schedule and receive email notifications when you add new stops. Share your schedule link on social media, embed it on your website, or send newsletters with your weekly route.
                        </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 rounded-2xl border border-sky-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Does it work for farmers market and festival schedules?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. List all your market appearances, festivals, and pop-up locations in one schedule. Use sub-schedules to organize by type. Customers always see your complete calendar of upcoming appearances.
                        </p>
                </details>
            </div>
        </div>
