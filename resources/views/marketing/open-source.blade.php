    ...
    <section class="relative bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                ...
                <a href="{{ route('sign_up') }}" class="inline-flex items-center px-8 py-4 text-lg font-semibold text-white glass border border-white/10 rounded-2xl hover:bg-white/10 transition-all">
                    Start for free
    ...
    <section class="bg-[#0a0a0f] py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900/50 to-slate-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1">
                            ...
                            <p class="text-gray-400 text-lg mb-6">Every line of code is available on GitHub under the AAL license. Inspect, modify, or contribute. No hidden functionality, no surprises.</p>
                            <div class="flex flex-wrap gap-3">
                                <span class="px-3 py-1 rounded-full bg-white/10 text-gray-300 text-sm">AAL Licensed</span>
                                <span class="px-3 py-1 rounded-full bg-white/10 text-gray-300 text-sm">Laravel + Vue.js</span>
                                <span class="px-3 py-1 rounded-full bg-white/10 text-gray-300 text-sm">MIT-friendly</span>
                            </div>
                        </div>
                        <div class="flex-shrink-0">
                            <div class="relative animate-float">
                                <div class="w-64 h-48 bg-gradient-to-br from-white/5 to-white/10 rounded-2xl border border-white/20 p-4 shadow-2xl">
                                    ...
                                    <div class="code-block text-xs space-y-1">
                                        ...
                                        <div><span class="text-purple-400">git</span> <span class="text-gray-300">clone</span></div>
                                        <div class="text-cyan-400 text-[10px] break-all">github.com/eventschedule</div>
                                        <div class="mt-2"><span class="text-purple-400">composer</span> <span class="text-gray-300">install</span></div>
                                        <div><span class="text-purple-400">npm</span> <span class="text-gray-300">run build</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-900/50 to-teal-900/50 border border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-3">Your server, your data</h3>
                    <p class="text-gray-400 mb-6">Install via Softaculous (one-click) or Docker. Keep full control of your data.</p>

                    <div class="space-y-3">
                        <a href="https://www.softaculous.com/apps/calendars/Event_Schedule" target="_blank" class="flex items-center gap-3 p-3 rounded-xl bg-white/10 border border-white/10 hover:bg-white/15 transition-colors">
                            ...
                            <div class="flex-1">
                                <div class="text-white font-medium text-sm">Softaculous</div>
                                <div class="text-gray-400 text-xs">One-click install</div>
                            </div>
                        </a>
                        <a href="https://github.com/eventschedule/dockerfiles" target="_blank" class="flex items-center gap-3 p-3 rounded-xl bg-white/10 border border-white/10 hover:bg-white/15 transition-colors">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-gray-400 text-xs">Containerized deploy</div>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-900/50 to-indigo-900/50 border border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-3">Build integrations</h3>
                    <p class="text-gray-400 mb-6">Programmatically manage schedules and events. Create custom workflows and automations.</p>

                    <div class="bg-black/30 rounded-xl p-4 code-block text-xs">
                        <div class="text-gray-500 mb-2"># Create an event</div>
                        <div class="text-violet-400">POST <span class="text-gray-300">/api/events/myschedule</span></div>
                ...
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-900/50 to-blue-900/50 border border-white/10 p-8 lg:p-10">
                    <div class="grid md:grid-cols-2 gap-8 items-start">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-white mb-4">Full CRUD operations</h3>
                            <p class="text-gray-400 text-lg">Manage your schedules, events, and ticket sales programmatically. API access requires a Pro subscription.</p>
                        </div>
                        <div class="space-y-3">
                            <div class="flex items-center gap-3 p-3 rounded-xl bg-black/30 border border-white/5">
                                <span class="px-2 py-1 rounded bg-emerald-500/30 text-emerald-300 text-xs font-mono">GET</span>
                                <span class="text-gray-300 text-sm font-mono">/api/schedules</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 rounded-xl bg-black/30 border border-white/5">
                                <span class="px-2 py-1 rounded bg-emerald-500/30 text-emerald-300 text-xs font-mono">GET</span>
                                <span class="text-gray-300 text-sm font-mono">/api/events</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 rounded-xl bg-black/30 border border-white/5">
                                <span class="px-2 py-1 rounded bg-blue-500/30 text-blue-300 text-xs font-mono">POST</span>
                                <span class="text-gray-300 text-sm font-mono">/api/events/{'{subdomain}'}</span>
                            </div>
                            <div class="flex items-center gap-3 p-3 rounded-xl bg-black/30 border border-white/5">
                                <span class="px-2 py-1 rounded bg-blue-500/30 text-blue-300 text-xs font-mono">POST</span>
                                <span class="text-gray-300 text-sm font-mono">/api/sales</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                    ...
                    <h3 class="text-xl font-bold text-white mb-2">Automated Imports</h3>
                    <p class="text-gray-400 text-sm">Pull events from other systems and create them automatically. Sync with your existing tools.</p>
                </div>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                    ...
                    <h3 class="text-xl font-bold text-white mb-2">Website Widgets</h3>
                    <p class="text-gray-400 text-sm">Fetch events and display them on your own website with custom styling and layouts.</p>
                </div>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                    ...
                    <p class="text-gray-400 text-sm">Build custom mobile experiences. The API works with any frontend framework or native app.</p>
                </div>
                ...
                <div class="bg-white/5 rounded-2xl p-6 border border-white/10">
                    ...
                    <h3 class="text-xl font-bold text-white mb-2">Custom Ticket Sales</h3>
                    <p class="text-gray-400 text-sm">Create sales programmatically. Build your own checkout flow while leveraging our ticketing infrastructure.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="relative bg-[#0a0a0f] py-20 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <a href="{{ marketing_url('/ticketing') }}" class="group block">
                <div class="bg-gradient-to-br from-fuchsia-900/50 to-violet-900/50 rounded-3xl border border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <!-- Text content -->
                        <div class="flex-1 text-center lg:text-left">
                            <h3 class="text-2xl lg:text-3xl font-bold text-white mb-3 group-hover:text-fuchsia-300 transition-colors">Ticketing</h3>
                            <p class="text-gray-400 text-lg mb-4">Sell tickets directly from your schedule. QR codes for fast check-ins, Stripe payments built-in.</p>
