    ...
    <section class="relative bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 mb-8">
                ...
                <span class="text-sm text-gray-300">Help Center</span>
            </div>
    ...
    <section class="bg-gray-50 py-24">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-16">
                ...
                <div class="space-y-4">
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">What is Event Schedule?</span>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Do I need technical skills to use it?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Can I embed my schedule on my website?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
            ...
            <div class="mb-16">
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900">Pricing & Billing</h2>
                </div>

                <div class="space-y-4">
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">What's the difference between Free and Pro?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Do you take a percentage of my ticket sales?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">What happens when my free Pro year ends?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-gray-600 leading-relaxed">After your first year, Pro costs $5/month (or $50/year). You'll receive a reminder before the year ends. If you choose not to continue, your account reverts to the Free plan. You keep all your events and data; you just lose access to Pro features like ticketing and custom domains.</p>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-gray-600 leading-relaxed">Yes. There are no contracts or cancellation fees. Cancel your Pro subscription whenever you want, and your account stays active on the Free plan.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-16">
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900">Ticketing & Payments</h2>
                </div>

                <div class="space-y-4">
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">How do I start selling tickets?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Can I create different ticket types for one event?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-gray-600 leading-relaxed">Yes. You can create multiple ticket types per event, such as General Admission, VIP, Early Bird, or Student pricing. Each type can have its own price, quantity limit, and description.</p>
                        </div>
                    </div>

                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">How do QR check-ins work?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-gray-600 leading-relaxed">When someone buys a ticket, they receive an email with a QR code. At your event, open the check-in screen on any smartphone or tablet, scan the QR code, and the system verifies the ticket and marks it as used. No special hardware required.</p>
                        </div>
                    </div>

                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Can I collect additional information from ticket buyers?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Can I offer free tickets alongside paid ones?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-gray-600 leading-relaxed">Yes. You can mix free and paid ticket types on the same event. This is useful for comp tickets, volunteer passes, or free admission with optional paid upgrades.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-16">
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900">Calendar & Sharing</h2>
                </div>

                <div class="space-y-4">
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Does Event Schedule sync with Google Calendar?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Can my audience add events to their personal calendars?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-gray-600 leading-relaxed">Yes. Every event page has "Add to Calendar" buttons that let visitors save the event to Google Calendar, Apple Calendar, Outlook, or download an ICS file. This works for both you and your attendees.</p>
                        </div>
                    </div>

                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">What's the difference between a schedule, a sub-schedule, and an event?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Can I create recurring events?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-gray-600 leading-relaxed">Yes. When creating an event, you can set it to repeat daily, weekly, biweekly, or monthly. You can also specify an end date or number of occurrences. Each occurrence can be edited individually if needed.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-16">
                ...
                <div class="space-y-4">
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Who can see my schedule?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-gray-600 leading-relaxed">By default, your schedule is public so your audience can find it. However, you control what information appears. You can also make individual events private or require a password.</p>
                        </div>
                    </div>

                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Is payment processing secure?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Do you sell my data?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        <div x-show="open" x-collapse class="px-6 pb-5">
                            <p class="text-gray-600 leading-relaxed">No. We don't sell, share, or use your data for advertising. Our built-in analytics are privacy-first and don't use external trackers. If you selfhost, your data stays entirely on your own servers.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-16">
                <div class="flex items-center gap-3 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900">Technical & Selfhosting</h2>
                </div>

                <div class="space-y-4">
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Is Event Schedule open source?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Can I selfhost Event Schedule?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">Is there an API?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div x-data="{ open: false }" class="faq-item bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <button @click="open = !open" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                            <span class="font-semibold text-gray-900">What languages does Event Schedule support?</span>
                            <svg :class="{ 'rotate-180': open }" class="w-5 h-5 text-gray-500 transition-transform duration-200 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
