    ...
    <nav aria-label="Main navigation" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                {{-- Both glyphs are decorative, so without a label the whole link
                     announces as its own star count and nothing else. --}}
                <a href="https://github.com/eventschedule/eventschedule" target="_blank"
                    aria-label="Event Schedule on GitHub, {{ number_format($githubStars) }} stars"
                    ...
                    <svg aria-hidden="true" class="h-3.5 w-3.5 text-yellow-500" viewBox="0 0 24 24" fill="currentColor">
