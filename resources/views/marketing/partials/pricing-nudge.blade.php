    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-6 mt-8 mb-8">
            <div class="flex-1 max-w-xs mx-auto sm:mx-0">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">Scheduling, calendar sync, followers, and newsletters</div>
            </div>
            ...
            <div class="flex-1 max-w-xs mx-auto sm:mx-0">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">Ticketing, QR check-in, event graphics, and no branding</div>
            </div>
        </div>
