    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ marketing_url('/features') }}" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            Features
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ marketing_url('/compare') }}" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            Compare
                        </a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ marketing_url('/docs') }}" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            Docs
                        </a>
                    </li>
                    <li>
                        <a href="{{ marketing_url('/faq') }}" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            FAQ
                        </a>
                    </li>
                    <li>
                        <a href="{{ marketing_url('/docs/developer/api') }}" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            API
                        </a>
                    </li>
                    ...
                    @endif
                    <li>
                        <a href="{{ marketing_url('/whats-new') }}" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            What's New
                        </a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ marketing_url('/about') }}" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            About
                        </a>
                    </li>
                    <li>
                        <a href="{{ marketing_url('/contact') }}" class="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            Contact
                        </a>
                    </li>
                    <li>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200 dark:border-white/10">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="https://www.instagram.com/eventschedule/" target="_blank" rel="noopener noreferrer" class="text-gray-500 dark:text-gray-400 p-2 rounded-lg hover:text-white hover:bg-blue-600 transition-colors" aria-label="Instagram">
                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <a href="https://youtube.com/@EventSchedule" target="_blank" rel="noopener noreferrer" class="text-gray-500 dark:text-gray-400 p-2 rounded-lg hover:text-white hover:bg-blue-600 transition-colors" aria-label="YouTube">
                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clip-rule="evenodd" />
                        </svg>
                    </a>
                    <a href="https://x.com/ScheduleEvent" target="_blank" rel="noopener noreferrer" class="text-gray-500 dark:text-gray-400 p-2 rounded-lg hover:text-white hover:bg-blue-600 transition-colors" aria-label="X (Twitter)">
                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                        </svg>
                    </a>
                    <a href="https://www.linkedin.com/company/eventschedule/" target="_blank" rel="noopener noreferrer" class="text-gray-500 dark:text-gray-400 p-2 rounded-lg hover:text-white hover:bg-blue-600 transition-colors" aria-label="LinkedIn">
                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <a href="https://github.com/eventschedule/eventschedule" target="_blank" rel="noopener noreferrer" class="text-gray-500 dark:text-gray-400 p-2 rounded-lg hover:text-white hover:bg-blue-600 transition-colors" aria-label="GitHub">
                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
