<x-marketing-layout>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-gray-200 dark:border-white/10 mb-8">
                ...
                <span class="text-sm text-gray-600 dark:text-gray-300">Free White-Label Platform</span>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('marketing.docs.saas.setup') }}" class="inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-sky-600 rounded-2xl hover:scale-105 transition-all shadow-lg shadow-blue-500/25">
                    View Setup Guide
                ...
                <a href="https://github.com/eventschedule/eventschedule" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-8 py-4 text-lg font-semibold text-gray-900 dark:text-white glass border border-gray-200 dark:border-white/10 rounded-2xl hover:bg-gray-100 dark:hover:bg-white/10 transition-all">
                    <svg aria-hidden="true" class="mr-2 w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-24 border-t border-gray-200 dark:border-white/5">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">See it in action</h2>
                <p class="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
                    Explore both sides of Event Schedule - the admin portal where you manage everything, and the public calendar your attendees see.
                </p>
            </div>

            <div class="grid md:grid-cols-2 gap-8">
                <!-- Admin Portal -->
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 border border-gray-200 dark:border-white/10 p-8 flex flex-col">
                    ...
                    <p class="text-gray-600 dark:text-white/80 mb-6 flex-grow">
                        Where schedule owners manage events, tickets, settings, and more. Create events, track sales, and customize your calendar.
                    </p>
                    <a href="{{ demo_url() }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-sky-600 hover:from-blue-500 hover:to-sky-500 rounded-xl text-white font-medium transition-colors">
                        Open Admin Demo
                        <svg aria-hidden="true" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 border border-gray-200 dark:border-white/10 p-8 flex flex-col">
                    ...
                    <a href="https://simpsons.eventschedule.com" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-sky-600 hover:from-blue-500 hover:to-sky-500 rounded-xl text-white font-medium transition-colors">
                        Open Client Demo
                        <svg aria-hidden="true" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                        </svg>
    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Run it your way</h2>
                <p class="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 border border-gray-200 dark:border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Set your own prices</h3>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-blue-100 dark:from-blue-900 dark:to-blue-900 border border-gray-200 dark:border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Configurable trials</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-6">
                    ...
                    <div class="bg-gray-200 dark:bg-[#0f0f14] rounded-xl p-4 mb-4">
                        <code class="text-sm text-gray-600 dark:text-gray-300">
                            <span class="text-blue-400">TRIAL_DAYS</span>=<span class="text-green-400">14</span>
                        </code>
                    </div>
                    <ul class="space-y-2 text-gray-600 dark:text-gray-300 text-sm">
                        <li class="flex items-center gap-2">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-100 to-teal-100 dark:from-cyan-900 dark:to-teal-900 border border-gray-200 dark:border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">White-label branding</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-6">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-100 to-green-100 dark:from-emerald-900 dark:to-green-900 border border-gray-200 dark:border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Your revenue</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-6">
    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-24 border-t border-gray-200 dark:border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Why is it free?</h2>
                <p class="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                <div class="bg-gradient-to-br from-blue-50 to-sky-50 dark:from-blue-900/30 dark:to-sky-900/30 rounded-2xl p-6 border border-blue-200 dark:border-blue-500/20">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">AAL License</h3>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-sky-50 dark:from-blue-900/30 dark:to-sky-900/30 rounded-2xl p-6 border border-blue-200 dark:border-blue-500/20">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Small Backlink</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Discreet link in corner of public schedule pages</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">What your customers get</h2>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 dark:text-white">Sell tickets via Stripe Connect</h4>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Let your customers sell tickets and charge their own customers</p>
                            </div>
                        </li>
                        <li class="flex items-start gap-4">
                            <div class="w-8 h-8 rounded-lg bg-amber-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 dark:text-white">Create and manage events</h4>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Full event management with recurring events, groups, and more</p>
                            </div>
                        </li>
                        <li class="flex items-start gap-4">
                            <div class="w-8 h-8 rounded-lg bg-amber-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 dark:text-white">Their own subdomains</h4>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Each customer gets customer.yourdomain.com</p>
                            </div>
                        </li>
                        <li class="flex items-start gap-4">
                            <div class="w-8 h-8 rounded-lg bg-amber-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-900 dark:text-white">Google Calendar sync</h4>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Bidirectional sync with Google Calendar</p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="relative">
                    <div class="animate-float bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900 dark:to-orange-900 border border-gray-200 dark:border-white/10 rounded-2xl p-6 shadow-2xl">
                        <div class="flex items-center justify-between mb-6">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-sky-500 flex items-center justify-center">
                                    <span class="text-white font-bold text-sm">YB</span>
                                </div>
                                <div>
                                    <div class="text-gray-900 dark:text-white font-semibold">Your Brand</div>
                                    <div class="text-gray-500 dark:text-gray-400 text-sm">yourdomain.com</div>
                                </div>
                            </div>
                        </div>
                        <div class="space-y-3">
                            <div class="bg-gray-200 dark:bg-[#0f0f14] rounded-xl p-3 flex items-center gap-3">
                                <div class="w-8 h-8 rounded-lg bg-blue-500/30 flex items-center justify-center">
                                    <svg aria-hidden="true" class="w-4 h-4 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="bg-gray-200 dark:bg-[#0f0f14] rounded-xl p-3 flex items-center gap-3">
                                <div class="w-8 h-8 rounded-lg bg-emerald-500/30 flex items-center justify-center">
                                    <svg aria-hidden="true" class="w-4 h-4 text-emerald-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                </div>
                                <div class="flex-1">
    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-24 border-t border-gray-200 dark:border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Federation</h2>
                <p class="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-100 to-cyan-100 dark:from-sky-900 dark:to-cyan-900 border border-gray-200 dark:border-white/10 p-8">
                    <div class="grid md:grid-cols-2 gap-8">
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Share virtual events</h3>
                            <p class="text-gray-500 dark:text-gray-400 mb-6">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Benefits the community</h3>
                            <p class="text-gray-500 dark:text-gray-400 mb-6">
                            ...
                            <div class="bg-gray-200 dark:bg-[#0f0f14] rounded-xl p-4">
                                <div class="flex items-center gap-3 mb-3">
                                    <div class="w-8 h-8 rounded-lg bg-sky-500/30 flex items-center justify-center">
                                        <svg aria-hidden="true" class="w-4 h-4 text-sky-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </div>
                                    <span class="text-gray-900 dark:text-white font-medium">Global event discovery</span>
                                </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <div class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gray-200 dark:bg-white/10 mb-8">
                    <svg aria-hidden="true" class="w-10 h-10 text-gray-900 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                    </svg>
                </div>
                ...
                <div class="grid sm:grid-cols-3 gap-6 mb-10">
                    <div class="bg-gradient-to-br from-blue-50 to-sky-50 dark:from-blue-900/30 dark:to-sky-900/30 rounded-xl p-6 border border-blue-200 dark:border-blue-500/20">
    ...
    <section class="relative bg-gradient-to-br from-blue-600 to-sky-700 py-24 overflow-hidden">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('marketing.docs.saas.setup') }}" class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-blue-600 bg-white rounded-2xl hover:scale-105 transition-all shadow-xl">
                    Read Setup Guide
                    <svg aria-hidden="true" class="ml-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </a>
                <a href="{{ app_url('/sign_up') }}" class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white border-2 border-white/30 rounded-2xl hover:bg-white/10 transition-all">
