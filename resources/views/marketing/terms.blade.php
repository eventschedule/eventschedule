    ...
    <section class="es-hero relative overflow-hidden bg-white py-20 dark:bg-[#0a0a0f] noise sm:py-24">
        ...
        <div class="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div class="es-fade-up es-d-1 mb-6 inline-flex items-center gap-2 rounded-full glass px-4 py-2">
                ...
                <span class="text-sm font-medium tracking-wide text-gray-600 dark:text-gray-300">Legal</span>
            </div>
            <h1 class="es-balance es-fade-up es-d-2 text-4xl font-black tracking-tight text-gray-900 dark:text-white sm:text-5xl">Terms of <span class="text-gradient-legal">Service</span></h1>
