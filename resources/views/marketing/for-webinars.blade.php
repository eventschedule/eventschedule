<x-marketing-layout>
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <div class="absolute bottom-0 left-[-20%] w-[70%] h-[70%] bg-teal-600/20 rounded-full blur-[120px]"></div>
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="inline-flex items-center gap-3 px-5 py-2.5 rounded-full glass border border-gray-200 dark:border-white/10 mb-8 backdrop-blur-sm">
                ...
                <span class="text-sm text-gray-600 dark:text-gray-300 font-medium tracking-wide">For Webinar Hosts & Organizers</span>
            </div>

            <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-8 leading-tight">
                Host webinars on your terms.<br>
                <span class="webinar-glow-text">No platform lock-in.</span>
            </h1>
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ app_url('/sign_up') }}" class="group inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-teal-600 to-cyan-600 rounded-2xl hover:scale-105 transition-transform duration-150 will-change-transform shadow-lg shadow-teal-500/25">
            ...
            <div class="mt-14 flex flex-wrap justify-center gap-2">
                <span class="inline-flex items-center px-3 py-1.5 rounded-lg bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300 text-xs font-medium border border-teal-200 dark:border-teal-800/50">Product Demos</span>
                <span class="inline-flex items-center px-3 py-1.5 rounded-lg bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300 text-xs font-medium border border-cyan-200 dark:border-cyan-800/50">Training Sessions</span>
                <span class="inline-flex items-center px-3 py-1.5 rounded-lg bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-300 text-xs font-medium border border-sky-200 dark:border-sky-800/50">Workshops</span>
                <span class="inline-flex items-center px-3 py-1.5 rounded-lg bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300 text-xs font-medium border border-blue-200 dark:border-blue-800/50">Panel Discussions</span>
                <span class="inline-flex items-center px-3 py-1.5 rounded-lg bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300 text-xs font-medium border border-teal-200 dark:border-teal-800/50">All-Hands</span>
                <span class="inline-flex items-center px-3 py-1.5 rounded-lg bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300 text-xs font-medium border border-cyan-200 dark:border-cyan-800/50">Lectures</span>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-16 border-t border-gray-200 dark:border-white/5">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-3 gap-6 text-center">
                <div class="p-6">
                    <div class="text-4xl font-bold text-teal-400 mb-2">~40%</div>
                    <div class="text-gray-500 dark:text-gray-400 text-sm">average webinar attendance rate</div>
                </div>
                <div class="p-6 border-x border-gray-200 dark:border-white/5">
                    <div class="text-4xl font-bold text-amber-400 mb-2">3-5x</div>
                    <div class="text-gray-500 dark:text-gray-400 text-sm">higher engagement via email vs. social posts</div>
                </div>
                <div class="p-6">
                    <div class="text-4xl font-bold text-sky-400 mb-2">$0</div>
                    <div class="text-gray-500 dark:text-gray-400 text-sm">platform fees on paid webinars</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white text-center mb-12">
                Everything you need to host webinars
            </h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">

                <!-- Email attendees directly (spans 2 cols) -->
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-teal-100 to-cyan-100 dark:from-teal-900 dark:to-cyan-900 border border-teal-200 dark:border-white/10 p-8 lg:p-10">
                    <div class="absolute top-0 right-0 w-96 h-96 bg-teal-500/5 rounded-full blur-[100px]"></div>
                    ...
                    <div class="relative flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1">
                            ...
                            <h3 class="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4">Email webinar attendees directly</h3>
                            <p class="text-gray-500 dark:text-gray-400 text-lg mb-6">Notify registrants before you go live. Send reminders, share materials, and follow up after sessions. Your audience, your inbox.</p>
                            <div class="flex flex-wrap gap-3">
                                <span class="inline-flex items-center px-3 py-1 rounded-full bg-gray-300 dark:bg-white/10 text-gray-700 dark:text-gray-300 text-sm">Webinar reminders</span>
                                <span class="inline-flex items-center px-3 py-1 rounded-full bg-gray-300 dark:bg-white/10 text-gray-700 dark:text-gray-300 text-sm">Series announcements</span>
                                <span class="inline-flex items-center px-3 py-1 rounded-full bg-gray-300 dark:bg-white/10 text-gray-700 dark:text-gray-300 text-sm">Follow-up emails</span>
                            </div>
                        </div>
                        <div class="flex-shrink-0 w-full lg:w-auto">
                            <div class="relative animate-float">
                                <div class="bg-gradient-to-br from-teal-100 to-cyan-100 dark:from-teal-950 dark:to-cyan-950 rounded-2xl border border-teal-300 dark:border-teal-400/30 p-4 max-w-xs">
                                    <div class="flex items-center gap-3 mb-3">
                                        <div class="w-10 h-10 rounded-full bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center text-white text-sm font-semibold">WH</div>
                                        <div>
                                            <div class="text-gray-900 dark:text-white font-semibold text-sm">Webinar Host</div>
                                            <div class="text-teal-600 dark:text-teal-300 text-xs">Live session reminder</div>
                                        </div>
                                    </div>
                                    <div class="bg-gradient-to-br from-teal-600/30 to-cyan-600/30 rounded-xl p-3 border border-teal-400/20">
                                        <div class="text-center">
                                            <div class="text-gray-900 dark:text-white text-xs font-semibold mb-1">TOMORROW AT 2 PM</div>
                                            <div class="text-teal-700 dark:text-teal-300 text-sm font-bold">Product Deep Dive</div>
                                            <div class="text-gray-500 dark:text-gray-400 text-[10px] mt-1">Join via Zoom - Free</div>
                                        </div>
                                    </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-100 to-green-100 dark:from-emerald-900 dark:to-green-900 border border-emerald-200 dark:border-white/10 p-8">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Zero platform fees on paid webinars</h3>
                        <p class="text-gray-500 dark:text-gray-400 mb-6">Charge for premium content. 100% of Stripe payments go to you. See all <a href="{{ route('marketing.ticketing') }}" class="text-emerald-600 dark:text-emerald-400 underline hover:no-underline">ticketing features</a>.</p>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 border border-sky-200 dark:border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">One link for all your webinars</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-6">Put it on your website, email signature, or social profiles. All your sessions in one place.</p>
                    ...
                    <div class="bg-gray-100 dark:bg-[#0f0f14] rounded-xl p-4 border border-gray-200 dark:border-white/10">
                        <div class="flex items-center gap-2 p-2 rounded-lg bg-sky-500/20 border border-sky-400/30 mb-3">
                            ...
                            <span class="text-gray-900 dark:text-white text-xs font-mono">eventschedule.com/yourwebinars</span>
                        </div>
                ...
                <!-- Works with any platform (spans 2 cols) -->
                <div class="bento-card lg:col-span-2 relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-blue-100 dark:from-blue-900 dark:to-blue-900 border border-blue-200 dark:border-white/10 p-8 lg:p-10">
                    <div class="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Works with Zoom, Meet, Teams, and more</h3>
                            <p class="text-gray-500 dark:text-gray-400 text-lg">Add your streaming link to any webinar. Attendees register on your schedule and join via whatever platform you use. Learn more about <a href="{{ route('marketing.online_events') }}" class="text-blue-600 dark:text-blue-400 underline hover:no-underline">online event features</a>.</p>
                        </div>
                        <div class="flex items-center justify-center">
                            <div class="flex items-center gap-4">
                                <div class="bg-blue-100 dark:bg-blue-500/20 rounded-xl border border-blue-400/30 p-4 w-36">
                                    <div class="text-blue-700 dark:text-blue-300 text-xs text-center mb-2 font-semibold">Your Schedule</div>
                                    <div class="space-y-1.5">
                                        <div class="h-2 bg-gray-300 dark:bg-white/20 rounded"></div>
                                        <div class="h-2 bg-blue-400/40 rounded w-3/4"></div>
                                    </div>
                                    <div class="mt-3 p-2 rounded-lg bg-blue-200 dark:bg-blue-400/20 border border-blue-400/30">
                                        <div class="text-[10px] text-gray-900 dark:text-white text-center font-medium">Product Demo</div>
                                        <div class="text-[8px] text-blue-700 dark:text-blue-300 text-center mt-0.5">Thu 2:00 PM</div>
                                    </div>
                                </div>
                                <div class="flex flex-col items-center gap-1">
                                    <svg aria-hidden="true" class="w-6 h-6 text-blue-400 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                    </svg>
                                    <span class="text-blue-600 dark:text-blue-400 text-[10px]">join link</span>
                                </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900 dark:to-orange-900 border border-amber-200 dark:border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Schedule recurring webinar series</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-6">Weekly or monthly sessions. Set it once and let attendees follow along.</p>
                    ...
                    <div class="bg-amber-500/20 rounded-xl border border-amber-400/30 p-3">
                        <div class="space-y-1.5">
                            <div class="flex items-center gap-2 p-1.5 rounded bg-amber-400/20">
                                ...
                                <span class="text-gray-900 dark:text-white text-[10px] font-medium">Mon - Product Update</span>
                            </div>
                            <div class="flex items-center gap-2 p-1.5 rounded bg-amber-400/10">
                                <div class="w-1.5 h-1.5 rounded-full bg-amber-400"></div>
                                <span class="text-gray-600 dark:text-gray-300 text-[10px]">Mon - Product Update</span>
                            </div>
                            <div class="flex items-center gap-2 p-1.5 rounded bg-amber-400/10">
                                <div class="w-1.5 h-1.5 rounded-full bg-amber-400"></div>
                                <span class="text-gray-600 dark:text-gray-300 text-[10px]">Mon - Product Update</span>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-sky-100 dark:from-blue-900 dark:to-sky-900 border border-blue-200 dark:border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Sync webinars with Google Calendar</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-6">Two-way sync. Webinars, prep sessions, and follow-ups all in one place.</p>
                    ...
                    <div class="flex items-center justify-center gap-3">
                        <div class="bg-blue-500/20 rounded-xl border border-blue-400/30 p-3 w-20">
                            ...
                            <div class="space-y-1">
                                <div class="h-1.5 bg-teal-400/80 dark:bg-teal-400/40 rounded text-[6px] text-white px-1">Webinar</div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-100 to-rose-100 dark:from-cyan-900 dark:to-rose-900 border border-cyan-200 dark:border-white/10 p-8">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Track webinar registrations</h3>
                    <p class="text-gray-500 dark:text-gray-400 mb-6">Track registrations and know your audience before going live.</p>

                    <div class="flex items-center justify-center">
                        <div class="flex -space-x-2">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-teal-500 to-cyan-500 border-2 border-gray-200 dark:border-[#0a0a0f] flex items-center justify-center text-white text-xs">A</div>
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 border-2 border-gray-200 dark:border-[#0a0a0f] flex items-center justify-center text-white text-xs">B</div>
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-sky-500 border-2 border-gray-200 dark:border-[#0a0a0f] flex items-center justify-center text-white text-xs">C</div>
                            <div class="w-8 h-8 rounded-full bg-gray-300 dark:bg-white/20 border-2 border-gray-200 dark:border-[#0a0a0f] flex items-center justify-center text-gray-600 dark:text-white text-xs">+84</div>
                        </div>
                    </div>
                    <div class="text-center mt-3 text-cyan-600 dark:text-cyan-300 text-xs">87 registered for next session</div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-gradient-to-br from-teal-100 to-teal-50 dark:from-[#0f1a1a] dark:to-[#0a0a0f] rounded-2xl p-6 border border-teal-200 dark:border-teal-900/20 hover:border-teal-300 dark:hover:border-teal-800/40 transition-colors">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Single webinars</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Hosting your first webinar. Share a registration link and get attendees signed up.</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-cyan-100 to-cyan-50 dark:from-[#0f1a1c] dark:to-[#0a0a0f] rounded-2xl p-6 border border-cyan-200 dark:border-cyan-900/20 hover:border-cyan-300 dark:hover:border-cyan-800/40 transition-colors">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Webinar series</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Weekly or monthly sessions. Set up recurring schedules and let attendees follow along.</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-100 to-blue-50 dark:from-[#0f1520] dark:to-[#0a0a0f] rounded-2xl p-6 border border-blue-200 dark:border-blue-900/20 hover:border-blue-300 dark:hover:border-blue-800/40 transition-colors">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Multi-track programs</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Different topics, different tracks. Organize webinars into groups so attendees find what matters.</p>
                </div>

                <!-- Paid webinars -->
                <div class="bg-gradient-to-br from-sky-100 to-sky-200 dark:from-[#12101a] dark:to-[#0a0a0f] rounded-2xl p-6 border border-sky-200 dark:border-sky-900/20 hover:border-sky-300 dark:hover:border-sky-800/40 transition-colors">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Paid webinars</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Premium content deserves fair compensation. Sell tickets with zero platform fees.</p>
                </div>

                <!-- Team collaboration -->
                <div class="bg-gradient-to-br from-blue-100 to-blue-200 dark:from-[#15101a] dark:to-[#0a0a0f] rounded-2xl p-6 border border-blue-200 dark:border-blue-900/20 hover:border-blue-300 dark:hover:border-blue-800/40 transition-colors">
                    <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-900/30 mb-4">
                        <svg aria-hidden="true" class="w-6 h-6 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Multiple hosts and presenters. Invite your team so everyone can manage sessions.</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-amber-100 to-amber-50 dark:from-[#1a1510] dark:to-[#0a0a0f] rounded-2xl p-6 border border-amber-200 dark:border-amber-900/20 hover:border-amber-300 dark:hover:border-amber-800/40 transition-colors">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Full webinar library</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">Past and upcoming sessions in one place. A professional schedule your audience can browse.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-50 dark:bg-[#0f0f14] py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                    Perfect for all types of webinars
                </h2>
                <p class="text-xl text-gray-500 dark:text-gray-400">
                    Whether it's a product demo or a company all-hands, Event Schedule works for you. Also see Event Schedule for <a href="{{ route('marketing.for_virtual_conferences') }}" class="text-gray-600 dark:text-gray-300 underline hover:no-underline">Virtual Conferences</a>.
                </p>
            </div>
    ...
    <section class="bg-white dark:bg-[#0a0a0f] py-24 border-t border-gray-200 dark:border-white/5">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                    Three steps to a packed webinar
                </h2>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    <div class="w-14 h-14 bg-gradient-to-br from-teal-600 to-cyan-600 text-white text-xl font-bold rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-lg shadow-teal-600/25">
                        1
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Create your webinar</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Share your registration link</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">
                        Add it to your website, email signature, or social profiles. Attendees register in one click.
                    </p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm">
                        Attendees get notified. You focus on delivering great content. No platform fees, no lock-in.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-6">
                <div class="bg-white dark:bg-[#0a0a0f] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">What video platforms does Event Schedule work with?</h3>
                    <p class="text-gray-500 dark:text-gray-400">Any platform that gives you a meeting or streaming link. Zoom, Google Meet, Microsoft Teams, Webex, YouTube Live, and custom solutions. Event Schedule is platform-agnostic - just paste your link and attendees join from your schedule.</p>
                </div>

                <div class="bg-white dark:bg-[#0a0a0f] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Can I charge for webinars?</h3>
                    <p class="text-gray-500 dark:text-gray-400">Yes. Set up paid registration with Stripe. You keep 100% of the ticket revenue - Event Schedule charges zero platform fees. Stripe charges its standard processing fee (2.9% + $0.30).</p>
                </div>

                <div class="bg-white dark:bg-[#0a0a0f] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">How do attendees get the webinar link?</h3>
                    <p class="text-gray-500 dark:text-gray-400">When attendees register or purchase a ticket, the meeting link appears on their registration confirmation and event page. You can also email all registrants directly from your dashboard before the session starts.</p>
                </div>

                <div class="bg-white dark:bg-[#0a0a0f] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Can I schedule a recurring webinar series?</h3>
                    <p class="text-gray-500 dark:text-gray-400">Yes. Set up weekly, biweekly, or monthly webinar series with a single recurring event. Attendees can follow your schedule and get notified when new sessions are added.</p>
                </div>

                <div class="bg-white dark:bg-[#0a0a0f] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Is Event Schedule free for hosting webinars?</h3>
                    <p class="text-gray-500 dark:text-gray-400">Yes. The free plan includes unlimited events, attendee email notifications, and registration features. There are zero platform fees on ticket sales at any plan level. You only pay Stripe's standard processing fee if you sell tickets.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- CTA Section -->
    <section class="relative bg-white dark:bg-[#0a0a0f] py-24 overflow-hidden border-t border-teal-200 dark:border-teal-900/20">
        <!-- Mesh gradient background -->
        <div class="absolute inset-0">
            <div class="absolute top-0 left-[-10%] w-[50%] h-[60%] bg-teal-600/15 rounded-full blur-[120px]"></div>
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                Your webinars. Your audience. No middleman.
            </h2>
            <p class="text-xl text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
                Stop paying platform fees. Fill your webinars.<br class="hidden md:block">Free forever.
            </p>
            <a href="{{ app_url('/sign_up') }}" class="group inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-teal-600 to-cyan-600 rounded-2xl hover:scale-105 transition-transform duration-150 will-change-transform shadow-xl shadow-teal-500/20">
                Get Started Free
                <svg aria-hidden="true" class="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "mainEntity": [
            ...
            {
                "@type": "Question",
                "name": "How do attendees get the webinar link?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "When attendees register or purchase a ticket, the meeting link appears on their registration confirmation and event page. You can also email all registrants directly from your dashboard before the session starts."
                }
            },
            {
                "@type": "Question",
