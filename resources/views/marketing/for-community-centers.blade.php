<x-marketing-layout>
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "description": "Manage program registration, room booking, and community events. Email your community directly. Free forever.",
        "provider": {
            "@type": "Organization",
            "name": "Event Schedule",
            "url": "{{ config('app.url') }}"
        ...
        "audience": {
            "@type": "Audience",
            "audienceType": "Community Centers"
        }
    }
    </script>
    <script type="application/ld+json" {!! nonce_attr() !!}>
    ...
    <script type="application/ld+json" {!! nonce_attr() !!}>
    {
        ...
        "url": "{{ url()->current() }}",
        "keywords": "community center calendar, community event schedule, community program management, community center software, free community scheduling",
        "provider": {
            "@type": "Organization",
            "name": "Event Schedule"
        }
    ...
    <section class="relative bg-white dark:bg-[#0a0a0f] py-32 overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-gray-200 dark:border-white/10 mb-8 animate-reveal" style="opacity: 0;">
                <svg aria-hidden="true" class="w-4 h-4 text-teal-600 dark:text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-12 flex flex-wrap justify-center gap-2">
                ...
                <span class="inline-flex items-center px-3 py-1 rounded-full bg-sky-100 text-sky-700 dark:bg-sky-500/20 dark:text-sky-300 text-xs font-medium border border-sky-200 dark:border-sky-500/30">Faith-Based Center</span>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
                ...
                <div class="bg-gradient-to-br from-blue-900/40 to-blue-900/40 rounded-xl border border-blue-500/20 p-4 relative overflow-hidden group hover:border-blue-500/40 transition-colors">
                    <div class="text-blue-300 text-xs font-semibold tracking-wider uppercase mb-3">Wed</div>
                    <div class="space-y-2">
                        <div class="flex items-center gap-1.5">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 border border-sky-200 dark:border-white/10 p-8">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-3 p-3 rounded-xl bg-sky-500/20 border border-sky-400/30">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-sky-500 to-blue-500 flex items-center justify-center text-white text-xs font-semibold">PTA</div>
                            <div class="flex-1">
                                <div class="text-gray-900 dark:text-white text-sm font-medium">Lincoln PTA</div>
                                <div class="text-sky-700 dark:text-sky-300 text-xs">Meeting Room &bull; Oct 15</div>
                            </div>
                        ...
                        <div class="flex items-center gap-3 p-3 rounded-xl bg-gray-100 dark:bg-white/5">
                            <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-500 flex items-center justify-center text-white text-xs font-semibold">SC</div>
                            <div class="flex-1">
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-100 to-blue-100 dark:from-blue-900 dark:to-blue-900 border border-blue-200 dark:border-white/10 p-8">
                    ...
                    <div class="flex justify-center">
                        <div class="text-center">
                            ...
                            <div class="text-blue-700 dark:text-blue-300 text-xs font-medium">Scan with any smartphone</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bento-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-100 to-cyan-100 dark:from-rose-900 dark:to-cyan-900 border border-rose-200 dark:border-white/10 p-8">
                    ...
                    <div class="flex justify-center">
                        <div class="relative w-32 h-32 bg-gradient-to-br from-rose-500/30 to-cyan-500/30 rounded-xl border border-rose-400/30 p-2">
                ...
                <div class="bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 rounded-3xl border border-sky-200 dark:border-white/10 p-8 lg:p-10 hover:scale-[1.02] transition-all duration-300">
                    <div class="flex flex-col lg:flex-row gap-8 items-center">
                        <div class="flex-1 text-center lg:text-left">
                            ...
                            <h3 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-sky-600 dark:group-hover:text-sky-300 transition-colors">Reach members who can't come in person</h3>
                        ...
                        <div class="flex-shrink-0">
                            <div class="bg-gray-100 dark:bg-[#0f0f14] rounded-2xl border border-gray-200 dark:border-white/10 p-6 w-52">
                                ...
                                <div class="bg-gradient-to-br from-sky-600/30 to-blue-600/30 rounded-lg p-4 text-center mb-3">
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                <details name="faq" class="bg-gradient-to-br from-cyan-100 to-teal-100 dark:from-cyan-900 dark:to-teal-900 rounded-2xl border border-cyan-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Is Event Schedule free for community centers?
                        </h3>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Event Schedule is free forever for sharing your program calendar, building a community following, and syncing with Google Calendar. Newsletters and advanced features are available on the Pro plan.
                        </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-teal-100 to-emerald-100 dark:from-teal-900 dark:to-emerald-900 rounded-2xl border border-teal-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can I organize classes, meetings, and events by category?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Use sub-schedules to organize programs by type - fitness classes, youth programs, senior activities, community meetings, and special events. Each program can have its own schedule, description, and registration options.
                        </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-emerald-100 to-cyan-100 dark:from-emerald-900 dark:to-cyan-900 rounded-2xl border border-emerald-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            How do community members stay informed about programs?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Members can follow your center's schedule and receive email notifications for new programs. Embed your calendar on your website, share on social media, or send newsletters to keep the community informed.
                        </p>
                </details>
                ...
                <details name="faq" class="bg-gradient-to-br from-sky-100 to-blue-100 dark:from-sky-900 dark:to-blue-900 rounded-2xl border border-sky-200 dark:border-white/10 shadow-sm overflow-hidden group/faq">
                    <summary class="flex items-center justify-between p-6 cursor-pointer">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Can we handle event registration and payments?
                        </h3>
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400 transition-transform duration-300 group-open/faq:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                        ...
                        <p class="faq-answer px-6 pb-6 text-gray-600 dark:text-gray-400">
                            Yes. Enable registration on any program to manage attendance. For paid classes or events, connect Stripe to handle payments with zero platform fees. Attendees receive QR codes for easy check-in.
                        </p>
                </details>
            </div>
        </div>
    ...
    <section class="relative bg-gradient-to-br from-teal-600 to-cyan-700 py-24 overflow-hidden">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ app_url('/sign_up') }}" class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-teal-700 bg-white rounded-2xl hover:scale-105 transition-all shadow-xl">
                Get Started Free
                <svg aria-hidden="true" class="ml-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
