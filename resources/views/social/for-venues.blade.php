<x-social-image-layout>
    <div class="relative w-[1200px] h-[630px] bg-[#0a0a0f] overflow-hidden">
        <!-- Background orbs -->
        <div class="absolute top-20 left-1/4 w-[500px] h-[500px] bg-sky-600/20 rounded-full blur-[120px]"></div>
        <div class="absolute bottom-20 right-1/4 w-[400px] h-[400px] bg-cyan-600/20 rounded-full blur-[120px]"></div>
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center px-16">
            ...
            <h1 class="text-6xl font-bold text-white text-center mb-6 leading-tight">
                <span class="block">Fill your calendar</span>
                <span class="block text-gradient">with great events</span>
            </h1>
