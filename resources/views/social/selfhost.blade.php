<x-social-image-layout>
    <x-slot name="headStyles">
        <style>
            .text-gradient {
                background: linear-gradient(135deg, #34d399 0%, #10b981 50%, #14b8a6 100%) !important;
    ...
    <div class="relative w-[1200px] h-[630px] bg-[#0a0a0f] overflow-hidden">
        ...
        <div class="absolute bottom-20 right-1/4 w-[400px] h-[400px] bg-teal-600/20 rounded-full blur-[120px]"></div>
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center px-16">
            ...
            <h1 class="text-6xl font-bold text-white text-center mb-6 leading-tight">
                <span class="block">Your server,</span>
                <span class="block text-gradient">your rules</span>
            </h1>
