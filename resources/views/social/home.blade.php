<x-social-image-layout>
    <div class="relative w-[1200px] h-[630px] bg-[#0a0a0f] overflow-hidden">
        <!-- Background orbs -->
        <div class="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-gradient-to-r from-blue-600/30 to-blue-500/30 rounded-full blur-[100px]"></div>
        <div class="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-gradient-to-r from-sky-600/20 to-cyan-600/20 rounded-full blur-[100px]"></div>
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center px-16">
            ...
            <h1 class="text-6xl font-bold text-white text-center mb-6 leading-tight">
                <span class="block">Plan, Promote &</span>
