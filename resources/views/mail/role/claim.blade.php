    ...
    <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 8px 8px;">
        ...
        <div style="background-color: white; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <div style="text-align: center;">
                <a href="{{ route('sign_up', ['email' => base64_encode($role->email)]) }}" style="display: inline-block; background-color: #48bb78; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: 600;">
                    {{ __('messages.sign_up') }}
                </a>
            </div>
        </div>
