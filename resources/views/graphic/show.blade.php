    ...
    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg p-4 mb-6">
        <div class="flex items-start gap-3">
            ...
            <div class="text-sm text-amber-800 dark:text-amber-200 flex-1">
                ...
                <a href="{{ route('role.view_admin', ['subdomain' => $role->subdomain, 'tab' => 'schedule']) }}" class="font-medium underline hover:no-underline ms-1">{{ __('messages.review') }}</a>
            </div>
        </div>
    </div>
    @endif
