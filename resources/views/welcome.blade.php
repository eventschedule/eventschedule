            ...
            <div class="relative z-10 pt-14 lg:w-full lg:max-w-2xl">
                ...
                <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                    ...
                    <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                        Join the early beta <a href="#" class="whitespace-nowrap font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Read more <span aria-hidden="true">&rarr;</span></a>
                    </div>
                    </div>
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">*.eventschedule.com</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">Enabling venues, vendors and talent to collaborate with ease</p>
