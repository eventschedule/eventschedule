...
return [
    ...
    'email_settings_failed_warning_title' => 'Custom email delivery is paused',
    'email_settings_failed_warning_body' => 'Your SMTP credentials stopped working on :date (:relative). Custom delivery will be retried automatically on :retry_at, or send a test email below to retry now.',
    ...
    'email_settings_failed_email_subject' => 'Action needed: emails for :schedule are temporarily being sent through EventSchedule',
    'email_settings_failed_email_heading' => 'Email delivery issue',
    'email_settings_failed_email_greeting' => 'Hi :name,',
    'email_settings_failed_email_intro' => 'We were unable to send email through your :schedule SMTP credentials starting on :date. To avoid losing messages, EventSchedule is delivering them on your behalf for the next 24 hours.',
    'email_settings_failed_email_consequence' => 'Until you fix this, recipients will see emails from EventSchedule\'s default address rather than yours.',
