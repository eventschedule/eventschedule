...
return [
    ...
    'import_urls_placeholder' => 'Enter URLs to search for events (one per line)',
    'import_urls_help' => 'Enter URLs of websites that list events. The system will automatically scan these URLs and import any events it finds.',
    'import_cities' => 'Import Cities',
    'import_cities_placeholder' => 'Enter cities to search for events (one per line)',
    'import_cities_help' => 'Enter city names to search for events in those locations.',
    'test_import' => 'Test Import',
    'import_test_help' => 'Test your import configuration to see if events can be found.',
    ...
    'no_events_found' => 'No events found',
    'save_role_first_to_test_import' => 'Please save the role first before testing the import configuration.',
    'role_id_required' => 'Role ID is required for import testing.',
    'url' => 'URL',
    'city' => 'City',
];
