...
return [
    ...
    'invoiceninja_mode_invoice' => 'Invoice - Create an invoice for each checkout',
    'invoiceninja_mode_payment_link' => 'Payment link - Create a payment link for each checkout',
    'invoiceninja_mode_payment_link_v2' => 'Payment link v2 - Create a payment link for each checkout (v2 UI)',
    'invoiceninja_mode_payment_link_v3' => 'Payment link v3 - Create a payment link for each checkout (v3 UI)',
    'api_token' => 'API Token',
