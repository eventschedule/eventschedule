...
return [
    ...
    'claim_your_venue_details' => ':user scheduled an event for :role at :venue, sign up with this email address to claim ownership of the venue.',
    ...
    'claim_your_role' => ':user scheduled an event for :role',
