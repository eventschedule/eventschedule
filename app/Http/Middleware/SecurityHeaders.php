    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if ($isLocal) {
            ...
            $csp = [
                ...
                "connect-src 'self' {$host}:* ws://{$host}:* wss://{$host}:* *.googleapis.com *.google-analytics.com *.googletagmanager.com *.stripe.com *.sentry.io",
            ...
            $csp = [
                ...
                "connect-src 'self' *.googleapis.com *.google-analytics.com *.googletagmanager.com *.stripe.com *.sentry.io",
                "frame-src 'self' *.stripe.com *.youtube.com *.googletagmanager.com",
                "object-src 'none'",
                "base-uri 'self'",
                "form-action 'self'",
