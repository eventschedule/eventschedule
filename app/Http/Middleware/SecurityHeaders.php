    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if ($isLocal) {
            ...
            $csp = [
                ...
                "img-src 'self' data: {$host}:* *.googleapis.com *.gstatic.com *.googletagmanager.com *.stripe.com *.ytimg.com eventschedule.nyc3.cdn.digitaloceanspaces.com eventschedule.nyc3.digitaloceanspaces.com cdn.jsdelivr.net",
            ...
            $csp = [
                ...
                "img-src 'self' data: *.googleapis.com *.gstatic.com *.googletagmanager.com *.stripe.com *.ytimg.com eventschedule.nyc3.cdn.digitaloceanspaces.com eventschedule.nyc3.digitaloceanspaces.com cdn.jsdelivr.net",
