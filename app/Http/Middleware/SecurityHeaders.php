...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if ($isLocal) {
            ...
            $csp = [
                "default-src 'self'",
                "script-src 'self' 'unsafe-inline' 'nonce-{$nonce}' 'strict-dynamic' {$host}:* *.googleapis.com *.gstatic.com *.googletagmanager.com *.stripe.com unpkg.com js.sentry-cdn.com *.sentry.io challenges.cloudflare.com",
            ...
            $csp = [
                "default-src 'self'",
                "script-src 'self' 'unsafe-inline' 'nonce-{$nonce}' 'strict-dynamic' *.googleapis.com *.gstatic.com *.googletagmanager.com *.stripe.com unpkg.com js.sentry-cdn.com browser.sentry-cdn.com *.sentry.io challenges.cloudflare.com",
