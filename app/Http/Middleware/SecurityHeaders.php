...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if ($isLocal) {
            ...
            $csp = [
                "default-src 'self'",
                "script-src 'self' 'unsafe-eval' 'unsafe-inline' *.googleapis.com *.gstatic.com *.googletagmanager.com *.stripe.com unpkg.com js.sentry-cdn.com https://js.sentry-cdn.com browser.sentry-cdn.com *.sentry.io",
