...
class ApiMediaLibraryController extends Controller
{
    ...
    public function destroy(Request $request, MediaAsset $asset)
    {
        $this->ensureCanManage();
    ...
    public function storeVariant(Request $request, MediaAsset $asset)
    {
        $this->ensureCanManage();
    ...
    public function destroyTag(MediaTag $tag)
    {
        $this->ensureCanManage();
    ...
    public function syncTags(Request $request, MediaAsset $asset)
    {
        $this->ensureCanManage();
