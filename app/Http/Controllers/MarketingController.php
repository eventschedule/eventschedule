...
class MarketingController extends Controller
{
    ...
    protected function getDocSearchIndex(): array
    {
        ...
        return [
            ...
            ['page' => 'Installation', 'section' => 'Facebook Login', 'description' => 'Enable optional Continue with Facebook sign-in with a Meta app.', 'url' => $r['selfhost_installation'].'#facebook-login', 'category' => 'Selfhost', 'keywords' => 'facebook login sign in oauth meta app redirect uri FACEBOOK_CLIENT_ID FACEBOOK_CLIENT_SECRET'],
