...
class MarketingController extends Controller
{
    ...
    private function getComparisonData(string $competitor): array
    {
        $competitors = [
            ...
            'humanitix' => [
                ...
                'tagline' => 'Keep 100% of your ticket revenue with flat '.plan_price($this->planPrice()).'/mo pricing and zero platform fees.',
    ...
    protected function getDocSearchIndex(): array
    {
        ...
        return [
            ...
            ['page' => 'Sharing', 'section' => 'Embed URL Parameters', 'description' => 'Force a calendar or list layout, language, theme, category or sub-schedule per embed.', 'url' => $r['sharing'].'#embed-parameters', 'category' => 'User Guide', 'keywords' => 'layout grid list calendar url parameter query string embed dark lang category month year'],
