    ...
    private function getHubComparisonData(): array
    {
        return [
            ...
            'Events & Ticketing' => [
                ...
                ['Recurring events', 'Yes (Free)', 'Yes', 'Via cloning', 'No', 'Yes'],
                ['Event polls', 'Yes (Pro)', 'No', 'No', 'No', 'No'],
                ['Promo/discount codes', 'Yes (Pro)', 'Yes', 'Yes', 'No', 'No'],
            ...
            'Unique Features' => [
                ...
                ['Private/password-protected events', 'Yes (Enterprise)', 'No', 'Unlisted only', 'No', 'No'],
            ...
            'Platform' => [
                ...
                ['Webhooks', 'Yes (Pro)', 'Yes', 'Yes (Plus)', 'No', 'No'],
