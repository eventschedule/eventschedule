...
class MarketingController extends Controller
{
    ...
    private function getComparisonData(string $competitor): array
    {
        $competitors = [
            'eventbrite' => [
                ...
                'description' => 'Compare Event Schedule with Eventbrite and keep 100% of your ticket revenue: zero platform fees instead of 3.7% + $1.79 per ticket, plus open source and AI tools.',
                ...
                'key_advantages' => [
                    ...
                    [
                        ...
                        'icon' => 'import',
                        'gradient' => 'from-rose-50 to-orange-50 dark:from-rose-900/30 dark:to-orange-900/30',
        ...
        $tools = [
            'google-forms' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Calendar Sync', 'description' => 'Two-way Google Calendar sync keeps your events updated everywhere, automatically.', 'icon' => 'calendar', 'gradient' => 'from-rose-50 to-orange-50 dark:from-rose-900/30 dark:to-orange-900/30', 'border' => 'border-rose-200 dark:border-rose-500/20', 'icon_bg' => 'bg-rose-100 dark:bg-rose-500/20', 'icon_color' => 'text-rose-600 dark:text-rose-400'],
            ...
            'mailchimp' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Public Schedule Page', 'description' => 'A shareable page with all your events. Visitors can subscribe to updates and buy tickets in one place.', 'icon' => 'globe', 'gradient' => 'from-rose-50 to-orange-50 dark:from-rose-900/30 dark:to-orange-900/30', 'border' => 'border-rose-200 dark:border-rose-500/20', 'icon_bg' => 'bg-rose-100 dark:bg-rose-500/20', 'icon_color' => 'text-rose-600 dark:text-rose-400'],
            ...
            'calendly' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Audience Building', 'description' => 'Subscribers, newsletters, and fan engagement tools help you build an audience. Calendly focuses on individual scheduling.', 'icon' => 'mail', 'gradient' => 'from-rose-50 to-orange-50 dark:from-rose-900/30 dark:to-orange-900/30', 'border' => 'border-rose-200 dark:border-rose-500/20', 'icon_bg' => 'bg-rose-100 dark:bg-rose-500/20', 'icon_color' => 'text-rose-600 dark:text-rose-400'],
            ...
            'doodle' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'AI Event Import', 'description' => 'Paste event details in any format and AI parses them into structured events. Faster than manual event creation.', 'icon' => 'ai', 'gradient' => 'from-rose-50 to-orange-50 dark:from-rose-900/30 dark:to-orange-900/30', 'border' => 'border-rose-200 dark:border-rose-500/20', 'icon_bg' => 'bg-rose-100 dark:bg-rose-500/20', 'icon_color' => 'text-rose-600 dark:text-rose-400'],
            ...
            'squarespace' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'All-in-one Platform', 'description' => 'Ticketing, newsletters, calendar sync, AI tools, and event graphics in one platform. No plugins or integrations to manage.', 'icon' => 'ai', 'gradient' => 'from-rose-50 to-orange-50 dark:from-rose-900/30 dark:to-orange-900/30', 'border' => 'border-rose-200 dark:border-rose-500/20', 'icon_bg' => 'bg-rose-100 dark:bg-rose-500/20', 'icon_color' => 'text-rose-600 dark:text-rose-400'],
            ...
            'trello' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'AI Event Import', 'description' => 'Paste event details in any format and AI extracts structured event data automatically. Faster than creating Trello cards.', 'icon' => 'ai', 'gradient' => 'from-rose-50 to-orange-50 dark:from-rose-900/30 dark:to-orange-900/30', 'border' => 'border-rose-200 dark:border-rose-500/20', 'icon_bg' => 'bg-rose-100 dark:bg-rose-500/20', 'icon_color' => 'text-rose-600 dark:text-rose-400'],
    ...
    protected function getDocSearchIndex(): array
    {
        ...
        return [
            ...
            ['page' => 'Creating Schedules', 'section' => 'Advanced Settings', 'description' => 'Default to draft, hide videos, default category, first day of week, and other advanced options.', 'url' => $r['creating_schedules'].'#settings-advanced', 'category' => 'User Guide', 'keywords' => 'advanced options draft hide videos default category first day week'],
            ...
            ['page' => 'Creating Events', 'section' => 'Draft Events', 'description' => 'Keep an event private by marking it as a draft - hidden from public schedule, feeds, graphics, newsletters, and calendar sync.', 'url' => $r['creating_events'].'#draft', 'category' => 'User Guide', 'keywords' => 'draft private unpublished hidden publish'],
