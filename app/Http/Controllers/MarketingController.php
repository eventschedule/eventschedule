...
class MarketingController extends Controller
{
    ...
    protected function getDocSearchIndex(): array
    {
        ...
        return [
            ...
            ['page' => 'Getting Started', 'section' => 'Frequently Asked Questions', 'description' => 'Common questions about schedules, URLs, importing, and claiming a page someone created for you.', 'url' => $r['getting_started'].'#faq', 'category' => 'User Guide', 'keywords' => 'faq help questions claim my venue page someone made a page for me'],
            ...
            ['page' => 'Creating Events', 'section' => 'Event Visibility', 'description' => 'Choose who can see an event: Public, Draft, Internal, or Unlisted. Draft, Internal, and Unlisted events are hidden from the public schedule, feeds, graphics, newsletters, and calendar sync.', 'url' => $r['creating_events'].'#draft', 'category' => 'User Guide', 'keywords' => 'visibility draft internal unlisted public private unpublished hidden publish'],
            ...
            ['page' => 'Creating Events', 'section' => 'Pages Created for Others', 'description' => 'Naming a performer or venue who is not on Event Schedule creates a page for them, which they can claim.', 'url' => $r['creating_events'].'#claim', 'category' => 'User Guide', 'keywords' => 'claim unclaimed claim this page is this you not me invitation page created for me remove my page profile someone made a page'],
            ...
            ['page' => 'Newsletters', 'section' => 'Recipients & Segments', 'description' => 'Choose audiences: followers, email subscribers, ticket buyers, or custom lists.', 'url' => $r['newsletters'].'#recipients', 'category' => 'User Guide', 'keywords' => 'recipients segments audience list subscribers'],
            ...
            ['page' => 'Selling Tickets', 'section' => 'Interest List', 'description' => 'Let visitors leave an email to hear when an event\'s tickets go on sale, and if it changes.', 'url' => $r['tickets'].'#interest-list', 'category' => 'User Guide', 'keywords' => 'interest notify me tell me when tickets go on sale remind reminder email capture waiting'],
            ...
            ['page' => 'Analytics', 'section' => 'Web Analytics', 'description' => 'Views, devices, browsers, traffic sources, visitor locations, and social link clicks.', 'url' => $r['analytics'].'#web-analytics', 'category' => 'User Guide', 'keywords' => 'views devices browsers traffic sources geography country visitor locations social clicks'],
            ...
            ['page' => 'AI Setup', 'section' => 'AI Features', 'description' => 'Available AI features: import, scan, translation, image generation.', 'url' => $r['selfhost_ai'].'#features', 'category' => 'Selfhost', 'keywords' => 'features import scan translate images'],
            ...
            ['page' => 'Admin Panel', 'section' => 'Schedules and Plans', 'description' => 'Manage individual schedules: assign plan tiers, edit details, rename or release a subdomain, mark a schedule deleted and restore it (SaaS only).', 'url' => $r['selfhost_admin'].'#manage-plans', 'category' => 'Selfhost', 'keywords' => 'plans tiers subscription manage schedules delete deleted restore rename subdomain release free up squatted taken unclaimed ownerless junk'],
