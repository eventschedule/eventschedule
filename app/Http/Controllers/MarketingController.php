...
class MarketingController extends Controller
{
    ...
    protected function getDocSearchIndex(): array
    {
        ...
        return [
            ...
            ['page' => 'Sharing', 'section' => 'Embed URL Parameters', 'description' => 'Force a calendar or list layout, language, theme or sub-schedule per embed.', 'url' => $r['sharing'].'#embed-parameters', 'category' => 'User Guide', 'keywords' => 'layout grid list calendar url parameter query string embed dark lang'],
