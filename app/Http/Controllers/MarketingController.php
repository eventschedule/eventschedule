        ...
        $tools = [
            'google-forms' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule really free?', 'answer' => 'Yes. The free plan includes unlimited events, Google Calendar sync, newsletters, and fan engagement features. Free registration is unlimited and every ticket scans at the door at no cost; selling paid tickets is on Pro at '.plan_price($this->planPrice()).'/month, which also adds the live check-in dashboard. No payment method is plan-gated: buyers pay through Stripe or PayPal, or by Payfast for rand, Invoice Ninja, a payment link or cash. No credit card required to start.'],
            ...
            'calendly' => [
                ...
                'pricing_note' => 'Calendly charges $10/month per user for its Standard plan. Event Schedule is free for unlimited events, public pages and one appointment type. Free registration is unlimited, and selling paid tickets is on Pro at '.plan_price($this->planPrice()).'/month, and it lifts the one-appointment-type limit too, with no per-user fees.',
