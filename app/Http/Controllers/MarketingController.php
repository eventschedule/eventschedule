    ...
    private function getComparisonData(string $competitor): array
    {
        $competitors = [
            'eventbrite' => [
                ...
                'description' => 'Compare Event Schedule with Eventbrite to keep 100% of your ticket revenue: zero platform fees vs 3.7% + $1.79 per ticket, plus open source and AI tools.',
                ...
                'faq' => [
                    ...
                    ['question' => 'How does Event Schedule pricing compare to Eventbrite?', 'answer' => 'Eventbrite charges 3.7% + $1.79 per ticket on paid events. Event Schedule charges zero platform fees at every plan level. The Pro plan is a flat '.plan_price($this->planPrice()).'/mo regardless of how many tickets you sell.'],
            ...
            'luma' => [
                ...
                'description' => 'Compare Event Schedule with Luma. Get custom domains, zero platform fees, and open source flexibility for '.plan_price($this->planPrice()).'/mo instead of $59/mo.',
                ...
                'key_advantages' => [
                    [
                        ...
                        'description' => 'Event Schedule Pro costs '.plan_price($this->planPrice()).'/mo with a 7-day free trial. Luma Plus costs $59/mo for comparable features.',
                        'icon' => 'dollar',
                        'gradient' => 'from-emerald-50 to-teal-50 dark:from-emerald-900/30 dark:to-teal-900/30',
                        'border' => 'border-emerald-200 dark:border-emerald-500/20',
                        'icon_bg' => 'bg-emerald-100 dark:bg-emerald-500/20',
                ...
                'faq' => [
                    ...
                    ['question' => 'How does Event Schedule pricing compare to Luma?', 'answer' => 'Luma charges $59/mo for its premium plan. Event Schedule Pro is '.plan_price($this->planPrice()).'/mo with zero platform fees. Even the free plan includes unlimited events, two-way calendar sync, 25 paid tickets a month and newsletters.'],
            ...
            'ticket-tailor' => [
                ...
                'description' => 'Compare Event Schedule with Ticket Tailor. Get zero platform fees, open source flexibility, and AI features for a flat '.plan_price($this->planPrice()).'/mo.',
            ...
            'google-calendar' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule free like Google Calendar?', 'answer' => 'Event Schedule has a generous free plan that includes unlimited events, Google Calendar sync, newsletters, and team collaboration. Selling is on the free plan as well, up to 25 paid tickets a month, scanned at the door. The Pro plan at '.plan_price($this->planPrice()).'/mo removes that ceiling and adds the live check-in dashboard and custom branding.'],
            ...
            'brown-paper-tickets' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'How does Event Schedule pricing compare to Brown Paper Tickets?', 'answer' => 'Brown Paper Tickets charges $0.99 + 5% per ticket as a buyer-paid service fee. Event Schedule charges zero platform fees at any plan level. The Pro plan is a flat '.plan_price($this->planPrice()).'/mo for unlimited ticketing with direct Stripe payouts.'],
            ...
            'accelevents' => [
                ...
                'description' => 'Compare Event Schedule with Accelevents. Get zero platform fees, instant setup, and open source flexibility for '.plan_price($this->planPrice()).'/mo instead of $7,500+/year.',
                ...
                'sections' => [
                    'Pricing & Fees' => [
                        ...
                        ['Paid plan price', plan_price($this->planPrice()).'/mo (7-day free trial)', 'From $7,000/year', true],
                ...
                'key_advantages' => [
                    [
                        'title' => plan_price($this->planPrice()).'/mo vs $7,000+/year',
                ...
                'faq' => [
                    ...
                    ['question' => 'How does Event Schedule pricing compare to Accelevents?', 'answer' => 'Accelevents starts at $7,000/year with additional per-ticket fees ($1 + 1%) on paid plans. Event Schedule Pro is a flat '.plan_price($this->planPrice()).'/mo with unlimited events and zero platform fees.'],
            ...
            'tito' => [
                ...
                'key_advantages' => [
                    [
                        'title' => 'Flat-Rate Pricing',
                        'description' => plan_price($this->planPrice()).'/mo flat vs 3% per ticket. Sell 200 x $25 tickets and save $145/mo.',
                        'icon' => 'dollar',
                        'gradient' => 'from-emerald-50 to-teal-50 dark:from-emerald-900/30 dark:to-teal-900/30',
                        'border' => 'border-emerald-200 dark:border-emerald-500/20',
                        'icon_bg' => 'bg-emerald-100 dark:bg-emerald-500/20',
            ...
            'addevent' => [
                ...
                'description' => 'Compare Event Schedule with AddEvent. Get ticketing, public event pages, and a full event platform for '.plan_price($this->planPrice()).'/mo instead of just calendar buttons at $29/mo.',
                ...
                'sections' => [
                    'Pricing & Fees' => [
                        ...
                        ['Paid plan price', plan_price($this->planPrice()).'/mo (7-day free trial)', 'From $36/mo', true],
                ...
                'key_advantages' => [
                    ...
                    [
                        ...
                        'description' => plan_price($this->planPrice()).'/mo vs $36/mo, with far more features included.',
                        'icon' => 'percent',
                        'gradient' => 'from-teal-50 to-emerald-50 dark:from-teal-900/30 dark:to-emerald-900/30',
                        'border' => 'border-teal-200 dark:border-teal-500/20',
                        'icon_bg' => 'bg-teal-100 dark:bg-teal-500/20',
                ...
                'faq' => [
                    ...
                    ['question' => 'How does Event Schedule pricing compare to AddEvent?', 'answer' => 'AddEvent charges $36/mo for its premium plan. Event Schedule Pro is '.plan_price($this->planPrice()).'/mo with zero platform fees. Even the free plan includes unlimited events, two-way calendar sync, 25 paid tickets a month and newsletters.'],
        ...
        $tools = [
            'google-forms' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Calendar Sync', 'description' => 'Two-way sync with Google, Outlook and CalDAV keeps your events updated everywhere, automatically.', 'icon' => 'calendar', 'gradient' => 'from-cyan-50 to-sky-50 dark:from-cyan-900/30 dark:to-sky-900/30', 'border' => 'border-cyan-200 dark:border-cyan-500/20', 'icon_bg' => 'bg-cyan-100 dark:bg-cyan-500/20', 'icon_color' => 'text-cyan-600 dark:text-cyan-400'],
                    ['title' => 'Custom Registration Fields', 'description' => 'Collect any information you need from attendees with custom fields on ticket forms. Data is connected to attendee records automatically.', 'icon' => 'clipboard', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
                ],
                'why_switch' => [
            ...
            'mailchimp' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Automatic Subscriber Growth', 'description' => 'Ticket buyers become subscribers automatically. Your audience list grows with every event, no manual imports needed.', 'icon' => 'chart', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
                ],
                'why_switch' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'How much does Event Schedule cost compared to Mailchimp?', 'answer' => 'Event Schedule is free for newsletters, subscriber management, and unlimited events. Selling tickets is free as well, 25 paid ones a month with zero platform fees, and the Pro plan at '.plan_price($this->planPrice()).'/month removes the ceiling. Mailchimp charges based on subscriber count and can cost $20 or more per month for similar email features alone.'],
            ...
            'canva' => [
                ...
                'description' => 'Replace Canva for event flyers and graphics with Event Schedule. AI-generated graphics and shareable flyers are created automatically from your event details.',
                ...
                'pricing_note' => 'Canva Pro costs $15/month for premium design features. Event Schedule generates event graphics automatically on the Pro plan at '.plan_price($this->planPrice()).'/month, which also removes the free 25-a-month ticket ceiling and raises the newsletter allowance.',
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'AI Style Generation', 'description' => 'Generate custom visual styles for your schedule with AI. Your brand look is applied consistently across all event graphics.', 'icon' => 'ai', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
                ],
                'why_switch' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule free for event graphics?', 'answer' => 'Event graphics generation is included in the Pro plan at '.plan_price($this->planPrice()).'/month, which also removes the free 25-a-month ticket ceiling and adds the live check-in dashboard. The free plan includes unlimited events, public event pages, and Google Calendar sync.'],
            ...
            'linktree' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Custom Branding', 'description' => 'Brand your schedule page with your name, logo, colors, and custom domain. A professional event hub, not just a link list.', 'icon' => 'image', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
                ],
                'why_switch' => [
            ...
            'google-sheets' => [
                ...
                'pricing_note' => 'Google Sheets is free, but tracking events manually costs time. Event Schedule automates attendee tracking, and selling is free up to 25 paid tickets a month, and the Pro plan at '.plan_price($this->planPrice()).'/month removes that ceiling and adds the sales export.',
            ...
            'calendly' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Appointment Booking', 'description' => 'Publish bookable hours and let people pick a slot in their own timezone, free with one appointment type. Nothing can be booked over an event already on your schedule, synced calendar entries included.', 'icon' => 'calendar', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
            ...
            'surveymonkey' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Promo Codes & Discounts', 'description' => 'Create promo codes and discount offers for early birds, groups, or special guests. Built into ticketing with no extra plugins.', 'icon' => 'ticket', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
                ],
                'why_switch' => [
                    ...
                    'points' => [
                        ...
                        'Zero platform fees at '.plan_price($this->planPrice()).'/month vs SurveyMonkey at $25+/month',
            ...
            'doodle' => [
                ...
                'description' => 'Replace Doodle for event scheduling with Event Schedule. Move beyond date polls to a full event platform with public pages, ticketing, and a shareable calendar.',
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'AI Event Import', 'description' => 'Paste event details in any format and AI parses them into structured events. Faster than manual event creation.', 'icon' => 'ai', 'gradient' => 'from-cyan-50 to-sky-50 dark:from-cyan-900/30 dark:to-sky-900/30', 'border' => 'border-cyan-200 dark:border-cyan-500/20', 'icon_bg' => 'bg-cyan-100 dark:bg-cyan-500/20', 'icon_color' => 'text-cyan-600 dark:text-cyan-400'],
                    ['title' => 'Subscriber Signups', 'description' => 'Visitors subscribe to your schedule for updates on new events. Build your audience directly instead of sending new poll links each time.', 'icon' => 'mail', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
                ],
                'why_switch' => [
            ...
            'qr-code-generators' => [
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Sale Notifications', 'description' => 'Get notified instantly when tickets are sold. Real-time alerts keep you updated without checking a dashboard.', 'icon' => 'mail', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
                ],
                'why_switch' => [
            ...
            'squarespace' => [
                ...
                'description' => 'Replace Squarespace for event websites with Event Schedule. Get purpose-built event pages, integrated ticketing, and a shareable schedule, no full site needed.',
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'White-Label Branding', 'description' => 'Remove Event Schedule branding for a fully custom experience. Use your own domain, logo, and colors for a professional look.', 'icon' => 'image', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
                ],
                'why_switch' => [
            ...
            'notion' => [
                ...
                'description' => 'Replace Notion for event planning with Event Schedule. Get public event pages, built-in ticketing, and Google Calendar sync instead of workspace databases.',
            ...
            'trello' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule free like Trello?', 'answer' => 'Yes. The free plan includes unlimited events, public event pages, Google Calendar sync, newsletters, and fan engagement features. Selling is free too, 25 paid tickets a month at zero platform fees. The Pro plan at '.plan_price($this->planPrice()).'/month removes that ceiling and adds event graphics, the live check-in dashboard and more.'],
