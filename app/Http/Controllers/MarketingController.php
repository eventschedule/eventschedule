...
class MarketingController extends Controller
{
    ...
    private function getHubComparisonData(): array
    {
        return [
            ...
            'Events & Ticketing' => [
                ...
                ['Refunds, full or partial', 'Yes (Free)', 'Yes', 'Yes', 'Yes', 'No'],
        ...
        $competitors = [
            'eventbrite' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'Does Event Schedule have an event marketplace like Eventbrite?', 'answer' => 'Event Schedule focuses on giving organizers their own branded schedule pages rather than a shared marketplace. You get a dedicated URL (or your own domain on Enterprise), embeddable calendar widgets, a live calendar feed people can subscribe to, and an interest list on each event that emails people when tickets go on sale.'],
                    ['question' => 'Can I refund a ticket buyer?', 'answer' => 'Yes, from the Sales page, on every plan. A Stripe or PayPal sale can be refunded in full or in part, and the money goes back through the provider before the sale changes status. A partial refund keeps the tickets valid and shows how much has gone back so far; a full refund returns the tickets to sale. A sale paid another way, such as cash, is marked as refunded instead, because no money moves through us.'],
            ...
            'luma' => [
                ...
                'why_choose' => [
                    ...
                    'points' => [
                        ...
                        'Stripe or PayPal checkout, with refunds from the Sales page, on every plan',
                    ],
                ],
                'faq' => [
            ...
            'ticket-tailor' => [
                ...
                'description' => 'Compare Event Schedule with Ticket Tailor: no per-ticket fee, Stripe or PayPal checkout, refunds and a multi-event cart, with 25 paid tickets a month free.',
                ...
                'why_choose' => [
                    ...
                    'points' => [
                        ...
                        'Stripe or PayPal checkout, one cart across several events, and refunds from the Sales page, free on every plan',
            ...
            'google-calendar' => [
                ...
                'why_choose' => [
                    ...
                    'points' => [
                        'Ticketing through your own Stripe or PayPal account from the free plan, with QR check-in at the door and refunds from the Sales page',
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule free like Google Calendar?', 'answer' => 'Event Schedule has a free plan that includes unlimited events, two-way Google Calendar sync, newsletters and a live calendar feed your audience can subscribe to. Selling is on the free plan as well, up to 25 paid tickets a month, scanned at the door. The Pro plan at '.plan_price($this->planPrice()).'/mo removes that ceiling and adds the live check-in dashboard and branding removal.'],
                    ['question' => 'Can Event Schedule handle ticketing that Google Calendar cannot?', 'answer' => 'Yes. Google Calendar has no ticketing features. Event Schedule sells tickets through your own Stripe or PayPal account on every plan, 25 paid tickets a month on the free plan, each scanned at the door, with refunds from the Sales page. Pro removes the cap and adds the live check-in dashboard, ticket waitlists, sale notifications and sales CSV export, all with zero platform fees.'],
            ...
            'brown-paper-tickets' => [
                ...
                'description' => 'Brown Paper Tickets is being retired. Compare Event Schedule: zero platform fees, Stripe or PayPal payouts, and 25 paid tickets a month free.',
                ...
                'faq' => [
                    ...
                    ['question' => 'How does Event Schedule pricing compare to Brown Paper Tickets?', 'answer' => 'Brown Paper Tickets charges $0.99 + 5% per ticket as a buyer-paid service fee. Event Schedule charges zero platform fees at any plan level, and the free plan sells 25 paid tickets a month. The Pro plan is a flat '.plan_price($this->planPrice()).'/mo for unlimited ticketing, with payouts straight into your own Stripe or PayPal account.'],
    ...
    private function getReplacementData(string $tool): array
    {
        $tools = [
            'google-forms' => [
                ...
                'pricing_note' => 'Google Forms is free, but payments and tickets have to come from other tools. Event Schedule does registration, payments, confirmation emails and door check-in on its free plan, 25 paid tickets a month included at zero platform fees; Pro at '.plan_price($this->planPrice()).'/month removes that ceiling.',
                ...
                'es_solutions' => [
                    ['title' => 'Built-in Ticketing', 'description' => 'Sell tickets through Stripe or PayPal, or take a payment link or cash, with automatic confirmations and zero platform fees. The free plan sells 25 paid tickets a month.', 'icon' => 'ticket', 'gradient' => 'from-emerald-50 to-teal-50 dark:from-emerald-900/30 dark:to-teal-900/30', 'border' => 'border-emerald-200 dark:border-emerald-500/20', 'icon_bg' => 'bg-emerald-100 dark:bg-emerald-500/20', 'icon_color' => 'text-emerald-600 dark:text-emerald-400'],
                    ...
                    ['title' => 'Tell Me When Tickets Go on Sale', 'description' => 'The notify-me form, built into the event page. Visitors leave just an email address and hear when tickets go on sale, if the event is cancelled, and shortly before it starts. Free on every plan.', 'icon' => 'mail', 'gradient' => 'from-cyan-50 to-sky-50 dark:from-cyan-900/30 dark:to-sky-900/30', 'border' => 'border-cyan-200 dark:border-cyan-500/20', 'icon_bg' => 'bg-cyan-100 dark:bg-cyan-500/20', 'icon_color' => 'text-cyan-600 dark:text-cyan-400'],
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule really free?', 'answer' => 'Yes. The free plan includes unlimited events, Google Calendar sync, newsletters, and fan engagement features. Selling tickets is free too, up to 25 paid ones a month with zero platform fees and the QR on each scanned at the door; Pro at '.plan_price($this->planPrice()).'/month removes the cap and adds the live check-in dashboard. Buyers pay through Stripe or PayPal, or by Payfast for rand, Invoice Ninja, a payment link or cash, on every plan. No credit card required to start.'],
            ...
            'mailchimp' => [
                ...
                'pricing_note' => 'Mailchimp starts at $13/month for 500 contacts and goes up from there. Event Schedule does not cap subscribers on any plan; what the plan sets is the newsletter allowance, counted in recipients: 10 a month free, 100 on Pro at '.plan_price($this->planPrice()).'/month, 1,000 on Enterprise. The automatic digest of new events is outside it, and selling is free to 25 paid tickets a month.',
                ...
                'es_solutions' => [
                    ...
                    ['title' => 'Zero Platform Fees', 'description' => 'Sell tickets through Stripe or PayPal with zero platform fees; you pay only what the processor charges. The free plan sells 25 paid tickets a month.', 'icon' => 'dollar', 'gradient' => 'from-sky-50 to-cyan-50 dark:from-sky-900/30 dark:to-cyan-900/30', 'border' => 'border-sky-200 dark:border-sky-500/20', 'icon_bg' => 'bg-sky-100 dark:bg-sky-500/20', 'icon_color' => 'text-sky-600 dark:text-sky-400'],
                ...
                'faq' => [
                    ...
                    ['question' => 'How much does Event Schedule cost compared to Mailchimp?', 'answer' => 'The newsletter tools and your subscriber list are free, with no cap on how many subscribers you keep. What the plan sets is the monthly newsletter allowance, counted in recipients: 10 on the free plan, 100 on Pro at '.plan_price($this->planPrice()).'/month and 1,000 on Enterprise, so one newsletter to 40 people uses 40 of it. The automatic digest of new events does not count against it. Selling tickets is free as well, 25 paid ones a month with zero platform fees. Mailchimp charges based on contact count and can cost $20 or more per month for similar email features alone.'],
            ...
            'canva' => [
                ...
                'pricing_note' => 'Canva Pro costs $15/month for premium design features. Event Schedule generates event graphics automatically on every plan, the free one included; Pro at '.plan_price($this->planPrice()).'/month removes the free 25-a-month ticket ceiling and raises the newsletter allowance, and AI flyers are on Enterprise.',
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule free for event graphics?', 'answer' => 'Yes. Event graphics are generated from your event details on every plan, the free one included. AI flyer generation, AI style generation and AI-written graphic text are on the Enterprise plan. Pro at '.plan_price($this->planPrice()).'/month is about selling: it removes the free 25-a-month ticket ceiling and adds the live check-in dashboard.'],
            ...
            'linktree' => [
                ...
                'pricing_note' => 'Linktree Pro costs $9/month for analytics and customization on what is still a list of links. On Event Schedule the schedule page, subscriber sign-ups, newsletters, link click counts and 25 paid tickets a month are all on the free plan; Pro at '.plan_price($this->planPrice()).'/month removes the ticket ceiling.',
                ...
                'faq' => [
                    ...
                    ['question' => 'Does Event Schedule have a free plan?', 'answer' => 'Yes. The free plan includes unlimited events, a public schedule page, Google Calendar sync, newsletters, and embeddable widgets. Selling tickets is free too, up to 25 paid ones a month with zero platform fees and the QR on each scanned at the door; Pro at '.plan_price($this->planPrice()).'/month removes the cap and adds the live check-in dashboard.'],
            ...
            'google-sheets' => [
                ...
                'pricing_note' => 'Google Sheets is free, but tracking events by hand costs time. Event Schedule records sales, attendees and refunds as they happen, selling is free up to 25 paid tickets a month, and the Pro plan at '.plan_price($this->planPrice()).'/month removes that ceiling and adds the sales export.',
            ...
            'calendly' => [
                ...
                'description' => 'Replace Calendly for bookings and events: one appointment type free, paid by Stripe, a payment link or cash, plus public events with tickets.',
                ...
                'pricing_note' => 'Calendly charges $10/month per user for its Standard plan. Event Schedule is free for unlimited events, public pages and one appointment type, and selling is free to 25 paid tickets a month; Pro at '.plan_price($this->planPrice()).'/month lifts that ceiling and the one-type limit, with no per-user fees.',
                ...
                'switch_steps' => [
                    ...
                    ['title' => 'Set your bookable hours', 'description' => 'Add one appointment type free: weekly hours, slot length, buffers and an optional approval step, with payment by Stripe, a payment link or cash.'],
                ...
                'faq' => [
                    ...
                    ['question' => 'Does Event Schedule have a free plan?', 'answer' => 'Yes. The free plan includes unlimited events, public event pages, one bookable appointment type, Google Calendar sync, newsletters, and fan engagement features. Selling tickets is free too, up to 25 paid ones a month with zero platform fees and the QR on each scanned at the door; Pro at '.plan_price($this->planPrice()).'/month removes the cap and adds the live check-in dashboard.'],
                ...
                'related_features' => [
                    ...
                    ['name' => 'Appointments', 'route' => 'marketing.appointments', 'description' => 'One bookable appointment type free, unlimited on Pro.'],
                    ['name' => 'Ticketing', 'route' => 'marketing.ticketing', 'description' => 'Sell tickets with QR codes and zero platform fees.'],
                ],
            ],
            'surveymonkey' => [
                ...
                'pricing_note' => 'SurveyMonkey charges $25+/month for features like payment collection and custom branding. Event Schedule registration is free, 25 paid tickets a month included at zero platform fees; Pro at '.plan_price($this->planPrice()).'/month removes that ceiling and adds feedback, polls and custom fields.',
                ...
                'why_switch' => [
                    ...
                    'points' => [
                        ...
                        'Free registration with 25 paid tickets a month, against SurveyMonkey at $25+/month',
                ...
                'faq' => [
                    ...
                    ['question' => 'How much does Event Schedule cost compared to SurveyMonkey?', 'answer' => 'Event Schedule is free for unlimited events, newsletters, and Google Calendar sync. Selling is free too, 25 paid tickets a month at zero platform fees, and the Pro plan at '.plan_price($this->planPrice()).'/month removes the ceiling. SurveyMonkey charges $25 or more per month for features like payment collection and custom branding.'],
                    ...
                    ['question' => 'Does Event Schedule support attendee limits and waitlists?', 'answer' => 'Yes. Set capacity limits per ticket type, and when an event sells out, people can join a waitlist and get notified if spots open up. The RSVP waitlist is free; the ticket waitlist is on the Pro plan. For an event that is not on sale yet, the free interest list takes just an email address and says when tickets go on sale.'],
            ...
            'doodle' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule free to use?', 'answer' => 'Yes. The free plan includes unlimited events, public event pages, Google Calendar sync, newsletters, and fan engagement features. Selling tickets is free too, up to 25 paid ones a month with zero platform fees and the QR on each scanned at the door; Pro at '.plan_price($this->planPrice()).'/month removes the cap and adds the live check-in dashboard.'],
            ...
            'qr-code-generators' => [
                ...
                'pricing_note' => 'Many QR generators charge $5 to $15/month for dynamic QR codes. Event Schedule puts a QR code on every ticket and free registration, and scanning them at the door is free on every plan, including the 25 paid tickets a month the free plan sells. Pro at '.plan_price($this->planPrice()).'/month removes that ceiling and adds the live check-in dashboard.',
                ...
                'faq' => [
                    ...
                    ['question' => 'How much does QR code ticketing cost?', 'answer' => 'Nothing, to start. The free plan sells up to 25 paid tickets a month per schedule, each with its own QR code, and scanning them at the door is not gated at all. Pro at '.plan_price($this->planPrice()).'/month removes that ceiling and adds the live check-in dashboard. There are zero platform fees on either, so you only pay the processor: standard Stripe processing is typically 2.9% + $0.30 per transaction, and PayPal charges its own rate.'],
            ...
            'squarespace' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'How does Event Schedule pricing compare to Squarespace?', 'answer' => 'Event Schedule is free for unlimited events and a public schedule page. Selling is free too, 25 paid tickets a month at zero platform fees, and the Pro plan at '.plan_price($this->planPrice()).'/month removes the ceiling. Squarespace costs $16 or more per month for a basic website, plus additional fees for third-party ticketing integrations.'],
                    ...
                    ['question' => 'How do payments and refunds work?', 'answer' => 'Buyers pay through Stripe or PayPal, or by Payfast for rand, Invoice Ninja, a payment link or cash, on every plan, and can buy tickets to several of your events in one checkout. A Stripe or PayPal sale can be refunded from the Sales page in full or in part, with the money going back through the provider. A CSV export of your sales is on Pro.'],
                ],
                'cross_links' => [
                    ['name' => 'Linktree', 'route' => 'marketing.replace_linktree', 'description' => 'A schedule page that sells tickets.'],
                    ['name' => 'Canva', 'route' => 'marketing.replace_canva', 'description' => 'Auto-generate event graphics and flyers.'],
            ...
            'notion' => [
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule free like Notion?', 'answer' => 'Yes. The free plan includes unlimited events, public event pages, Google Calendar sync, newsletters and event graphics, and selling is free too, 25 paid tickets a month at zero platform fees. The Pro plan at '.plan_price($this->planPrice()).'/month removes that ceiling and adds the live check-in dashboard. One difference worth knowing before you move a team off Notion: a free schedule is a single account, and multiple team members, up to five, are an Enterprise feature.'],
            ...
            'trello' => [
                ...
                'pricing_note' => 'Trello Standard costs $5 per user a month billed annually ($6 monthly). Event Schedule is free for unlimited events and public pages, and selling starts free too, at 25 paid tickets a month. '.plan_price($this->planPrice()).'/month lifts that ceiling and nothing here is charged per user; a team of five is the Enterprise plan rather than five subscriptions.',
                ...
                'faq' => [
                    ...
                    ['question' => 'Is Event Schedule free like Trello?', 'answer' => 'Yes. The free plan includes unlimited events, public event pages, Google Calendar sync, newsletters, event graphics and fan engagement features. Selling is free too, 25 paid tickets a month at zero platform fees. The Pro plan at '.plan_price($this->planPrice()).'/month removes that ceiling and adds the live check-in dashboard, webhooks and more.'],
    ...
    protected function getDocSearchIndex(): array
    {
        ...
        return [
            ...
            ['page' => 'Managing Schedules', 'section' => 'Appointments', 'description' => 'The Appointments tab: set up bookable types, see your bookings, and share your booking page. One type is free; Pro removes the limit.', 'url' => $r['managing_schedules'].'#appointments', 'category' => 'User Guide', 'keywords' => 'appointments tab bookings booking page tab free calendly'],
            ...
            ['page' => 'Selling Tickets', 'section' => 'Interest List', 'description' => 'Let visitors leave an email to hear when an event\'s tickets go on sale, if it is cancelled, and shortly before it starts.', 'url' => $r['tickets'].'#interest-list', 'category' => 'User Guide', 'keywords' => 'interest notify me tell me when tickets go on sale tell me if anything changes remind reminder cancelled change notice email capture waiting'],
            ...
            ['page' => 'Appointments', 'section' => 'Appointment Types', 'description' => 'Create appointment types with a name, any duration, a start-time interval, and free or paid pricing; toggle them active or inactive.', 'url' => $r['appointments'].'#appointment-types', 'category' => 'User Guide', 'keywords' => 'appointment type duration create toggle active inactive intro call session start times interval slot'],
