...
class EventController extends Controller
{
    ...
    public function scanAgenda(Request $request, $subdomain)
    {
        ...
        $eventsData = $events->map(function ($e) use ($subdomain) {
            return [
                ...
                'view_url' => route('event.view_guest_with_id', ['subdomain' => $subdomain, 'slug' => Event::guestUrlSlug($e->slug), 'id' => UrlUtils::encodeId($e->id)]),
            ];
        });
    ...
    public function saveEventParts(EventPartsSaveRequest $request, $subdomain)
    {
        ...
        return response()->json([
            ...
            'edit_url' => route('event.edit', ['subdomain' => $subdomain, 'hash' => UrlUtils::encodeId($event->id)]),
            'view_url' => route('event.view_guest_with_id', ['subdomain' => $subdomain, 'slug' => Event::guestUrlSlug($event->slug), 'id' => UrlUtils::encodeId($event->id)]),
        ]);
    }
