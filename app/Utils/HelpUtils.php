...
class HelpUtils
{
    private static array $mappings = [
        ...
        '{subdomain}/schedule' => '/docs/creating-schedules',
        '{subdomain}/availability' => '/docs/availability',
        '{subdomain}/requests' => '/docs/creating-schedules#settings-requests',
        '{subdomain}/profile' => '/docs/creating-schedules',
        '{subdomain}/followers' => '/docs/sharing#followers',
        '{subdomain}/team' => '/docs/creating-schedules',
        '{subdomain}/plan' => '/docs/creating-schedules',
        '{subdomain}/videos' => '/docs/creating-events#fan-content',
