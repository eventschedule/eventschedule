...
class ColorUtils
{
    private const STATIC_BACKGROUND_IMAGES = [
        ...
        'Abstract_Sunset' => 'Abstract Sunset',
        'Autumn' => 'Autumn',
        'Barn_Wall' => 'Barn Wall',
        'Bloomless' => 'Bloomless',
        ...
        'Desert_Retreat' => 'Desert Retreat',
        'Fall_Pastel' => 'Fall Pastel',
        'Flower_Experience' => 'Flower Experience',
        'Flower_Field' => 'Flower Field',
        'Flowers_of_Fire' => 'Flowers of Fire',
        'Gallery' => 'Gallery',
        'Garden' => 'Garden',
        'Go_Green' => 'Go Green',
        'Green_Splash' => 'Green Splash',
        'Greyscale' => 'Greyscale',
        'Leafy_Blues' => 'Leafy Blues',
        'Nature_Layers' => 'Nature Layers',
        'Not_Orange' => 'Not Orange',
        'Oil_Pallet' => 'Oil Pallet',
        'Painted_Fence' => 'Painted Fence',
        'Picnic' => 'Picnic',
        'Purple_Lillies' => 'Purple Lillies',
        'Rainbow' => 'Rainbow',
        'Rainbow_Splash' => 'Rainbow Splash',
        'RGBIV' => 'RGBIV',
