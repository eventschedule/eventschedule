    ...
    private function generate(array $pages, bool $force, string $outputDir): int
    {
        ...
        try {
            ...
            foreach ($pages as $slug => $urlPath) {
                ...
                // Drop the es-anim gate so the redesigned hero's scroll-in animations
                // (masked headline lines, fade-up copy) fall back to their fully-visible
