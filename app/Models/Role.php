...
class Role extends Model implements MustVerifyEmail
{
    ...
    public const RESERVED_SUBDOMAINS = [
        ...
        // /new/{slug}, and /feedback/{event_id}/{secret} every event of a schedule called
        // "feedback". Hosted serves schedules by host and never meets them, but this is one list:
        // a schedule moves between installs by backup, and a restore rebuilds a reserved name.
        // ReservedSubdomainRoutesTest reads the route tables and fails on a word missing here.
