...
class GiftCardRecipient extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: __('messages.gift_card_recipient_subject', [
                'name' => $this->giftCard->purchaser_name,
                'amount' => MoneyUtils::format($this->giftCard->amount, $this->giftCard->currency_code),
                'schedule' => $this->role->name,
            ]),
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'emails.gift_card_recipient',
            text: 'emails.gift_card_recipient_text',
            with: [
