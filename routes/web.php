...
if (config('app.is_nexus')) {
    if (config('app.is_testing')) {
        ...
        Route::domain('www.eventschedule.com')->group(function () {
            ...
            Route::get('/replace', fn () => redirect('https://eventschedule.com/replace', 301));
            Route::get('/google-forms-replacement', fn () => redirect('https://eventschedule.com/google-forms-replacement', 301));
            Route::get('/mailchimp-replacement', fn () => redirect('https://eventschedule.com/mailchimp-replacement', 301));
            Route::get('/canva-replacement', fn () => redirect('https://eventschedule.com/canva-replacement', 301));
            Route::get('/linktree-replacement', fn () => redirect('https://eventschedule.com/linktree-replacement', 301));
            Route::get('/google-sheets-replacement', fn () => redirect('https://eventschedule.com/google-sheets-replacement', 301));
            Route::get('/calendly-replacement', fn () => redirect('https://eventschedule.com/calendly-replacement', 301));
            Route::get('/surveymonkey-replacement', fn () => redirect('https://eventschedule.com/surveymonkey-replacement', 301));
            Route::get('/doodle-replacement', fn () => redirect('https://eventschedule.com/doodle-replacement', 301));
            Route::get('/qr-code-generator-replacement', fn () => redirect('https://eventschedule.com/qr-code-generator-replacement', 301));
            Route::get('/squarespace-replacement', fn () => redirect('https://eventschedule.com/squarespace-replacement', 301));
            Route::get('/notion-replacement', fn () => redirect('https://eventschedule.com/notion-replacement', 301));
            Route::get('/trello-replacement', fn () => redirect('https://eventschedule.com/trello-replacement', 301));
            Route::get('/convertkit-replacement', fn () => redirect('https://eventschedule.com/mailchimp-replacement', 301));
            Route::get('/excel-replacement', fn () => redirect('https://eventschedule.com/google-sheets-replacement', 301));
            Route::get('/wix-replacement', fn () => redirect('https://eventschedule.com/squarespace-replacement', 301));
            Route::get('/asana-replacement', fn () => redirect('https://eventschedule.com/trello-replacement', 301));
            Route::get('/airtable-replacement', fn () => redirect('https://eventschedule.com/google-sheets-replacement', 301));
            Route::get('/wordpress-replacement', fn () => redirect('https://eventschedule.com/squarespace-replacement', 301));
            Route::get('/google-forms-alternative', fn () => redirect('https://eventschedule.com/google-forms-replacement', 301));
            Route::get('/mailchimp-alternative', fn () => redirect('https://eventschedule.com/mailchimp-replacement', 301));
            Route::get('/canva-alternative', fn () => redirect('https://eventschedule.com/canva-replacement', 301));
            Route::get('/linktree-alternative', fn () => redirect('https://eventschedule.com/linktree-replacement', 301));
            Route::get('/google-sheets-alternative', fn () => redirect('https://eventschedule.com/google-sheets-replacement', 301));
            Route::get('/calendly-alternative', fn () => redirect('https://eventschedule.com/calendly-replacement', 301));
            Route::get('/surveymonkey-alternative', fn () => redirect('https://eventschedule.com/surveymonkey-replacement', 301));
            Route::get('/doodle-alternative', fn () => redirect('https://eventschedule.com/doodle-replacement', 301));
            Route::get('/qr-code-generator-alternative', fn () => redirect('https://eventschedule.com/qr-code-generator-replacement', 301));
            Route::get('/squarespace-alternative', fn () => redirect('https://eventschedule.com/squarespace-replacement', 301));
            Route::get('/notion-alternative', fn () => redirect('https://eventschedule.com/notion-replacement', 301));
            Route::get('/trello-alternative', fn () => redirect('https://eventschedule.com/trello-replacement', 301));
