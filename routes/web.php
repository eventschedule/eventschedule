...
Route::middleware(['auth', 'verified'])->group(function () 
{
    ...
    Route::get('/venues', [RoleController::class, 'venues'])->name('role.venues');
    Route::get('/curators', [RoleController::class, 'curators'])->name('role.curators');
    Route::get('/talent', [RoleController::class, 'talent'])->name('role.talent');
