...
if (config('app.is_nexus')) {
    if (config('app.is_testing')) {
        ...
        Route::get('/features/passes', [MarketingController::class, 'passes'])->name('marketing.passes');
        ...
        Route::get('/paypal', [MarketingController::class, 'paypal'])->name('marketing.paypal');
        ...
        Route::get('/for-churches', [MarketingController::class, 'forChurches'])->name('marketing.for_churches');
        Route::get('/for-schools', [MarketingController::class, 'forSchools'])->name('marketing.for_schools');
        Route::get('/for-nonprofits', [MarketingController::class, 'forNonprofits'])->name('marketing.for_nonprofits');
        Route::get('/for-festivals', [MarketingController::class, 'forFestivals'])->name('marketing.for_festivals');
        ...
        Route::get('/timely-alternative', [MarketingController::class, 'compareTimely'])->name('marketing.compare_timely');
        Route::get('/the-events-calendar-alternative', [MarketingController::class, 'compareTheEventsCalendar'])->name('marketing.compare_the_events_calendar');
        Route::get('/bandsintown-alternative', [MarketingController::class, 'compareBandsintown'])->name('marketing.compare_bandsintown');
        Route::get('/posh-alternative', [MarketingController::class, 'comparePosh'])->name('marketing.compare_posh');
        Route::get('/partiful-alternative', [MarketingController::class, 'comparePartiful'])->name('marketing.compare_partiful');
        Route::get('/facebook-events-alternative', [MarketingController::class, 'compareFacebookEvents'])->name('marketing.compare_facebook_events');
        Route::get('/zeffy-alternative', [MarketingController::class, 'compareZeffy'])->name('marketing.compare_zeffy');
        Route::get('/tockify-alternative', [MarketingController::class, 'compareTockify'])->name('marketing.compare_tockify');
        Route::get('/hi-events-alternative', [MarketingController::class, 'compareHiEvents'])->name('marketing.compare_hi_events');
        Route::get('/mobilizon-alternative', [MarketingController::class, 'compareMobilizon'])->name('marketing.compare_mobilizon');
        ...
        Route::get('/wordpress-replacement', fn () => redirect()->route('marketing.compare_the_events_calendar', [], 301));
        ...
        Route::domain('www.'._base_domain())->group(function () {
            ...
            Route::get('/for-churches', fn () => redirect('https://'._base_domain().'/for-churches', 301));
            Route::get('/for-schools', fn () => redirect('https://'._base_domain().'/for-schools', 301));
            Route::get('/for-nonprofits', fn () => redirect('https://'._base_domain().'/for-nonprofits', 301));
            Route::get('/for-festivals', fn () => redirect('https://'._base_domain().'/for-festivals', 301));
            ...
            Route::get('/wordpress-replacement', fn () => redirect('https://'._base_domain().'/the-events-calendar-alternative', 301));
    ...
    Route::get('/for-churches', fn () => redirect()->route('home'));
    Route::get('/for-schools', fn () => redirect()->route('home'));
    Route::get('/for-nonprofits', fn () => redirect()->route('home'));
    Route::get('/for-festivals', fn () => redirect()->route('home'));
