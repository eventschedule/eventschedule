...
return [
    ...
    // Organisations and communities: the audiences whose calendar belongs to a group rather than
    // a room or a performer. Listed on /use-cases in their own section, eight cells to a full grid.
    'communities' => [
        [
            'url' => '/for-churches',
            'name' => 'Churches',
        ...
        // Not a for-* page, but the same kind of calendar: one that belongs to a whole town or
        // neighbourhood rather than to one organizer. It takes the eighth cell on /use-cases,
        // where a "Something else?" sign-up tile used to close the grid.
        [
            'url' => '/community-event-calendar',
            'name' => 'Community Calendars',
            'blurb' => 'One shared calendar for a town or neighbourhood, fed by every organizer in it.',
            'tags' => ['Towns & Councils', 'Neighbourhood Groups', 'Local News Sites', 'Tourism Boards'],
