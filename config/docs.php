 ...
 *   feature   - optional route NAME of the marketing page for this page's feature.
 *               The hero links it (DocsUtils::featureFor()) and that page's
 *               related strip links back (DocsUtils::guideForPath()), so the guide
 *               and the pitch can each be reached from the other. Several guides
 *               may name one page; the first in this file is the one it links.
    ...
    */
    ...
    'pages' => [
        ...
        'appointments' => [
            ...
            'feature' => 'marketing.appointments',
            'title' => 'Appointments',
        ...
        'sharing' => [
            ...
            'path' => '/docs/sharing',
            'feature' => 'marketing.embed_calendar',
        ...
        'event-graphics' => [
            ...
            'feature' => 'marketing.event_graphics',
        ...
        'managing-schedules' => [
            ...
            'feature' => 'marketing.team_scheduling',
        ...
        'selfhost/google-calendar' => [
            ...
            'feature' => 'marketing.google_calendar',
        ...
        'selfhost/microsoft-calendar' => [
            ...
            'feature' => 'marketing.outlook_calendar',
        ...
        'developer/api' => [
            ...
            'feature' => 'marketing.for_ai_agents',
            'title' => 'API Reference',
